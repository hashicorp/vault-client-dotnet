...
------------ | ------------- | ------------- | -------------
**AccessTokenTtl** | **string** | The time-to-live for access tokens obtained by the client. | [optional] [default to "24h"]
...
**IdTokenTtl** | **string** | The time-to-live for ID tokens obtained by the client. | [optional] [default to "24h"]
