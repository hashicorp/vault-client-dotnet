# Vault.Model.AWSWriteAuthRoleTagRequest
...
**InstanceId** | **string** | Instance ID for which this tag is intended for. If set, the created tag can only be used by the instance with the given ID. | [optional] **MaxTtl** | **int** | If set, specifies the maximum allowed token lifetime. | [optional] [default to 0]
