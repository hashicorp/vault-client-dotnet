...
**AllowRotation** | **bool** | True if the imported key may be rotated within Vault; false otherwise. | [optional] 
...
**PublicKey** | **string** | The plaintext PEM public key to be imported. If \&quot;ciphertext\&quot; is set, this field is ignored. | [optional] 
