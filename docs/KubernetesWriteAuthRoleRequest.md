...
**BoundServiceAccountNames** | **List&lt;string&gt;** | List of service account names able to access this role. If set to \&quot;*\&quot; all names are allowed. | [optional] 
**BoundServiceAccountNamespaces** | **List&lt;string&gt;** | List of namespaces allowed to access this role. If set to \&quot;*\&quot; all namespaces are allowed. | [optional] 
