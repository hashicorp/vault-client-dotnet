# Vault.Model.AliCloudWriteRoleRequest
...
**MaxTtl** | **string** | The maximum allowed lifetime of tokens issued using this role. | [optional] 
...
**Ttl** | **string** | Duration in seconds after which the issued token should expire. Defaults to 0, in which case the value will fallback to the system/mount defaults. | [optional] 
