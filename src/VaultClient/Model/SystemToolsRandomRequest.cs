...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemToolsRandomRequest")]
    public partial class SystemToolsRandomRequest : IEquatable<SystemToolsRandomRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemToolsRandomRequest" /> class.
        /// </summary>
        ...
        public SystemToolsRandomRequest(int bytes = 32, string format = "base64", string source = "platform", string urlbytes = default(string))
        {
            this.Bytes = bytes;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemToolsRandomRequest {\n");
        ...
        {
            return this.Equals(input as SystemToolsRandomRequest);
        }

        /// <summary>
        /// Returns true if SystemToolsRandomRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemToolsRandomRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemToolsRandomRequest input)
        {
            if (input == null)
            {
                return false;
