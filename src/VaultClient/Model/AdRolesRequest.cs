...
namespace VaultClient.Model
{
    ...
    /// AdRolesRequest
    /// </summary>
    [DataContract(Name = "AdRolesRequest")]
    public partial class AdRolesRequest : IEquatable<AdRolesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdRolesRequest" /> class.
        /// </summary>
        ...
        public AdRolesRequest(string serviceAccountName = default(string), int ttl = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdRolesRequest {\n");
        ...
        {
            return this.Equals(input as AdRolesRequest);
        }

        /// <summary>
        /// Returns true if AdRolesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AdRolesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdRolesRequest input)
        {
            if (input == null)
            {
                return false;
