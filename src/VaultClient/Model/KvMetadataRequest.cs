...
namespace VaultClient.Model
{
    ...
    /// KvMetadataRequest
    /// </summary>
    [DataContract(Name = "KvMetadataRequest")]
    public partial class KvMetadataRequest : IEquatable<KvMetadataRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KvMetadataRequest" /> class.
        /// </summary>
        ...
        public KvMetadataRequest(bool casRequired = default(bool), Object customMetadata = default(Object), int deleteVersionAfter = default(int), int maxVersions = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KvMetadataRequest {\n");
        ...
        {
            return this.Equals(input as KvMetadataRequest);
        }

        /// <summary>
        /// Returns true if KvMetadataRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KvMetadataRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KvMetadataRequest input)
        {
            if (input == null)
            {
                return false;
