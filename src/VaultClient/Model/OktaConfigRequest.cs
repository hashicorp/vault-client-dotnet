...
namespace VaultClient.Model
{
    ...
    /// OktaConfigRequest
    /// </summary>
    [DataContract(Name = "OktaConfigRequest")]
    public partial class OktaConfigRequest : IEquatable<OktaConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OktaConfigRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OktaConfigRequest {\n");
        ...
        {
            return this.Equals(input as OktaConfigRequest);
        }

        /// <summary>
        /// Returns true if OktaConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OktaConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OktaConfigRequest input)
        {
            if (input == null)
            {
                return false;
