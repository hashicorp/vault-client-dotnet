...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GcpStaticAccountRequest")]
    public partial class GcpStaticAccountRequest : IEquatable<GcpStaticAccountRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GcpStaticAccountRequest" /> class.
        /// </summary>
        ...
        public GcpStaticAccountRequest(string bindings = default(string), string secretType = "access_token", string serviceAccountEmail = default(string), List<string> tokenScopes = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GcpStaticAccountRequest {\n");
        ...
        {
            return this.Equals(input as GcpStaticAccountRequest);
        }

        /// <summary>
        /// Returns true if GcpStaticAccountRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GcpStaticAccountRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GcpStaticAccountRequest input)
        {
            if (input == null)
            {
                return false;
