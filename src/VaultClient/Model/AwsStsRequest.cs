...
namespace VaultClient.Model
{
    ...
    /// AwsStsRequest
    /// </summary>
    [DataContract(Name = "AwsStsRequest")]
    public partial class AwsStsRequest : IEquatable<AwsStsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AwsStsRequest" /> class.
        /// </summary>
        ...
        public AwsStsRequest(string roleArn = default(string), string roleSessionName = default(string), int ttl = 3600)
        {
        ...
        {
            return this.Equals(input as AwsStsRequest);
        }

        /// <summary>
        /// Returns true if AwsStsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsStsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsStsRequest input)
        {
            if (input == null)
            {
                return false;
