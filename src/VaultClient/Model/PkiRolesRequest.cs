...
namespace VaultClient.Model
{
    ...
    /// PkiRolesRequest
    /// </summary>
    [DataContract(Name = "PkiRolesRequest")]
    public partial class PkiRolesRequest : IEquatable<PkiRolesRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiRolesRequest" /> class.
        /// </summary>
        ...
        /// <param name="policyIdentifiers">A comma-separated string or list of policy OIDs..</param>
        ...
        public PkiRolesRequest(bool allowAnyName = default(bool), bool allowBareDomains = default(bool), bool allowGlobDomains = default(bool), bool allowIpSans = true, bool allowLocalhost = true, bool allowSubdomains = default(bool), bool allowWildcardCertificates = true, List<string> allowedDomains = default(List<string>), bool allowedDomainsTemplate = false, List<string> allowedOtherSans = default(List<string>), List<string> allowedSerialNumbers = default(List<string>), List<string> allowedUriSans = default(List<string>), bool allowedUriSansTemplate = false, string backend = default(string), bool basicConstraintsValidForNonCa = default(bool), bool clientFlag = true, bool codeSigningFlag = default(bool), List<string> country = default(List<string>), bool emailProtectionFlag = default(bool), bool enforceHostnames = true, List<string> extKeyUsage = default(List<string>), List<string> extKeyUsageOids = default(List<string>), bool generateLease = default(bool), string issuerRef = "default", int keyBits = 0, KeyTypeEnum? keyType = KeyTypeEnum.Rsa, List<string> keyUsage = default(List<string>), List<string> locality = default(List<string>), int maxTtl = default(int), bool noStore = default(bool), string notAfter = default(string), int notBeforeDuration = 30, List<string> organization = default(List<string>), List<string> ou = default(List<string>), List<string> policyIdentifiers = default(List<string>), List<string> postalCode = default(List<string>), List<string> province = default(List<string>), bool requireCn = true, bool serverFlag = true, int signatureBits = 0, List<string> streetAddress = default(List<string>), int ttl = default(int), bool useCsrCommonName = true, bool useCsrSans = true)
        {
        ...
        /// </summary>
        /// <value>A comma-separated string or list of policy OIDs.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiRolesRequest {\n");
        ...
        {
            return this.Equals(input as PkiRolesRequest);
        }

        /// <summary>
        /// Returns true if PkiRolesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiRolesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiRolesRequest input)
        {
            if (input == null)
            {
                return false;
