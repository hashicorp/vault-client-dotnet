...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransitRandomRequest")]
    public partial class TransitRandomRequest : IEquatable<TransitRandomRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransitRandomRequest" /> class.
        /// </summary>
        ...
        public TransitRandomRequest(int bytes = 32, string format = "base64", string source = "platform", string urlbytes = default(string))
        {
            this.Bytes = bytes;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitRandomRequest {\n");
        ...
        {
            return this.Equals(input as TransitRandomRequest);
        }

        /// <summary>
        /// Returns true if TransitRandomRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitRandomRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitRandomRequest input)
        {
            if (input == null)
            {
                return false;
