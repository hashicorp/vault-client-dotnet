...
namespace VaultClient.Model
{
    ...
    public partial class SystemAuthRequest : IEquatable<SystemAuthRequest>, IValidatableObject
    {
        ...
        public SystemAuthRequest(Object config = default(Object), string description = default(string), bool externalEntropyAccess = false, bool local = false, Object options = default(Object), string pluginName = default(string), bool sealWrap = false, string type = default(string))
        {
            this.Config = config;
