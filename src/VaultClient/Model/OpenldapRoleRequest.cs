...
namespace VaultClient.Model
{
    ...
    /// OpenldapRoleRequest
    /// </summary>
    [DataContract(Name = "OpenldapRoleRequest")]
    public partial class OpenldapRoleRequest : IEquatable<OpenldapRoleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenldapRoleRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OpenldapRoleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenldapRoleRequest" /> class.
        /// </summary>
        /// <param name="creationLdif">LDIF string used to create new entities within OpenLDAP. This LDIF can be templated. (required).</param>
        /// <param name="defaultTtl">Default TTL for dynamic credentials.</param>
        /// <param name="deletionLdif">LDIF string used to delete entities created within OpenLDAP. This LDIF can be templated. (required).</param>
        ...
        public OpenldapRoleRequest(string creationLdif = default(string), int defaultTtl = default(int), string deletionLdif = default(string), int maxTtl = default(int), string rollbackLdif = default(string), string usernameTemplate = default(string))
        {
            // to ensure "creationLdif" is required (not null)
            if (creationLdif == null) {
                throw new ArgumentNullException("creationLdif is a required property for OpenldapRoleRequest and cannot be null");
            }
            this.CreationLdif = creationLdif;
            // to ensure "deletionLdif" is required (not null)
            if (deletionLdif == null) {
                throw new ArgumentNullException("deletionLdif is a required property for OpenldapRoleRequest and cannot be null");
            }
        ...
        /// </summary>
        /// <value>LDIF string used to create new entities within OpenLDAP. This LDIF can be templated.</value>
        ...
        /// </summary>
        /// <value>LDIF string used to delete entities created within OpenLDAP. This LDIF can be templated.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpenldapRoleRequest {\n");
        ...
        {
            return this.Equals(input as OpenldapRoleRequest);
        }

        /// <summary>
        /// Returns true if OpenldapRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OpenldapRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpenldapRoleRequest input)
        {
            if (input == null)
            {
                return false;
