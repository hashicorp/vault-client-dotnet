...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityMfaMethodOktaRequest")]
    public partial class IdentityMfaMethodOktaRequest : IEquatable<IdentityMfaMethodOktaRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityMfaMethodOktaRequest" /> class.
        /// </summary>
        ...
        public IdentityMfaMethodOktaRequest(string apiToken = default(string), string baseUrl = default(string), string methodId = default(string), string orgName = default(string), bool primaryEmail = default(bool), bool production = default(bool), string usernameFormat = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityMfaMethodOktaRequest {\n");
        ...
        {
            return this.Equals(input as IdentityMfaMethodOktaRequest);
        }

        /// <summary>
        /// Returns true if IdentityMfaMethodOktaRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityMfaMethodOktaRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityMfaMethodOktaRequest input)
        {
            if (input == null)
            {
                return false;
