...
namespace VaultClient.Model
{
    ...
    /// ApproleRoleRequest
    /// </summary>
    [DataContract(Name = "ApproleRoleRequest")]
    public partial class ApproleRoleRequest : IEquatable<ApproleRoleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproleRoleRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApproleRoleRequest {\n");
        ...
        {
            return this.Equals(input as ApproleRoleRequest);
        }

        /// <summary>
        /// Returns true if ApproleRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproleRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproleRoleRequest input)
        {
            if (input == null)
            {
                return false;
