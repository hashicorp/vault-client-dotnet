...
namespace VaultClient.Model
{
    ...
    /// AlicloudRoleRequest
    /// </summary>
    [DataContract(Name = "AlicloudRoleRequest")]
    public partial class AlicloudRoleRequest : IEquatable<AlicloudRoleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlicloudRoleRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlicloudRoleRequest {\n");
        ...
        {
            return this.Equals(input as AlicloudRoleRequest);
        }

        /// <summary>
        /// Returns true if AlicloudRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AlicloudRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlicloudRoleRequest input)
        {
            if (input == null)
            {
                return false;
