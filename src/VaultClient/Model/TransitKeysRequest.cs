...
namespace VaultClient.Model
{
    ...
    public partial class TransitKeysRequest : IEquatable<TransitKeysRequest>, IValidatableObject
    {
        ...
        public TransitKeysRequest(bool allowPlaintextBackup = default(bool), int autoRotatePeriod = 0, string context = default(string), bool convergentEncryption = default(bool), bool derived = default(bool), bool exportable = default(bool), string type = "aes256-gcm96")
        {
