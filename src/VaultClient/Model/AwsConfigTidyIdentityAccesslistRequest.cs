...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsConfigTidyIdentityAccesslistRequest")]
    public partial class AwsConfigTidyIdentityAccesslistRequest : IEquatable<AwsConfigTidyIdentityAccesslistRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AwsConfigTidyIdentityAccesslistRequest" /> class.
        /// </summary>
        ...
        public AwsConfigTidyIdentityAccesslistRequest(bool disablePeriodicTidy = false, int safetyBuffer = 259200)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsConfigTidyIdentityAccesslistRequest {\n");
        ...
        {
            return this.Equals(input as AwsConfigTidyIdentityAccesslistRequest);
        }

        /// <summary>
        /// Returns true if AwsConfigTidyIdentityAccesslistRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsConfigTidyIdentityAccesslistRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsConfigTidyIdentityAccesslistRequest input)
        {
            if (input == null)
            {
                return false;
