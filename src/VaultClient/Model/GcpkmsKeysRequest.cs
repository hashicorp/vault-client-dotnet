...
namespace VaultClient.Model
{
    ...
    /// GcpkmsKeysRequest
    /// </summary>
    [DataContract(Name = "GcpkmsKeysRequest")]
    public partial class GcpkmsKeysRequest : IEquatable<GcpkmsKeysRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GcpkmsKeysRequest" /> class.
        /// </summary>
        ...
        public GcpkmsKeysRequest(string algorithm = default(string), string cryptoKey = default(string), string keyRing = default(string), Object labels = default(Object), string protectionLevel = default(string), string purpose = default(string), int rotationPeriod = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GcpkmsKeysRequest {\n");
        ...
        {
            return this.Equals(input as GcpkmsKeysRequest);
        }

        /// <summary>
        /// Returns true if GcpkmsKeysRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GcpkmsKeysRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GcpkmsKeysRequest input)
        {
            if (input == null)
            {
                return false;
