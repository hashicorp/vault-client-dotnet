...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityMfaLoginEnforcementRequest")]
    public partial class IdentityMfaLoginEnforcementRequest : IEquatable<IdentityMfaLoginEnforcementRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityMfaLoginEnforcementRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IdentityMfaLoginEnforcementRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityMfaLoginEnforcementRequest" /> class.
        /// </summary>
        ...
        public IdentityMfaLoginEnforcementRequest(List<string> authMethodAccessors = default(List<string>), List<string> authMethodTypes = default(List<string>), List<string> identityEntityIds = default(List<string>), List<string> identityGroupIds = default(List<string>), List<string> mfaMethodIds = default(List<string>))
        {
            // to ensure "mfaMethodIds" is required (not null)
            if (mfaMethodIds == null) {
                throw new ArgumentNullException("mfaMethodIds is a required property for IdentityMfaLoginEnforcementRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityMfaLoginEnforcementRequest {\n");
        ...
        {
            return this.Equals(input as IdentityMfaLoginEnforcementRequest);
        }

        /// <summary>
        /// Returns true if IdentityMfaLoginEnforcementRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityMfaLoginEnforcementRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityMfaLoginEnforcementRequest input)
        {
            if (input == null)
            {
                return false;
