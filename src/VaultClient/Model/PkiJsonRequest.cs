...
namespace VaultClient.Model
{
    ...
    /// PkiJsonRequest
    /// </summary>
    [DataContract(Name = "PkiJsonRequest")]
    public partial class PkiJsonRequest : IEquatable<PkiJsonRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public PkiJsonRequest(string issuerName = default(string), string issuerRef = "default", string leafNotAfterBehavior = "err", List<string> manualChain = default(List<string>), List<string> usage = default(List<string>))
        {
        ...
        {
            return this.Equals(input as PkiJsonRequest);
        }

        /// <summary>
        /// Returns true if PkiJsonRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiJsonRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiJsonRequest input)
        {
            if (input == null)
            {
                return false;
