...
namespace VaultClient.Model
{
    ...
    /// AwsConfigStsRequest
    /// </summary>
    [DataContract(Name = "AwsConfigStsRequest")]
    public partial class AwsConfigStsRequest : IEquatable<AwsConfigStsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AwsConfigStsRequest" /> class.
        /// </summary>
        ...
        public AwsConfigStsRequest(string stsRole = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsConfigStsRequest {\n");
        ...
        {
            return this.Equals(input as AwsConfigStsRequest);
        }

        /// <summary>
        /// Returns true if AwsConfigStsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsConfigStsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsConfigStsRequest input)
        {
            if (input == null)
            {
                return false;
