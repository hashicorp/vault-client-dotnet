...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityGroupRequest")]
    public partial class IdentityGroupRequest : IEquatable<IdentityGroupRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityGroupRequest" /> class.
        /// </summary>
        ...
        public IdentityGroupRequest(string id = default(string), List<string> memberEntityIds = default(List<string>), List<string> memberGroupIds = default(List<string>), Object metadata = default(Object), string name = default(string), List<string> policies = default(List<string>), string type = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityGroupRequest {\n");
        ...
        {
            return this.Equals(input as IdentityGroupRequest);
        }

        /// <summary>
        /// Returns true if IdentityGroupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityGroupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityGroupRequest input)
        {
            if (input == null)
            {
                return false;
