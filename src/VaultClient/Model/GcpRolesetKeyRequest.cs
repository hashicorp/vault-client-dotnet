...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GcpRolesetKeyRequest")]
    public partial class GcpRolesetKeyRequest : IEquatable<GcpRolesetKeyRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GcpRolesetKeyRequest" /> class.
        /// </summary>
        ...
        public GcpRolesetKeyRequest(string keyAlgorithm = "KEY_ALG_RSA_2048", string keyType = "TYPE_GOOGLE_CREDENTIALS_FILE", int ttl = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GcpRolesetKeyRequest {\n");
        ...
        {
            return this.Equals(input as GcpRolesetKeyRequest);
        }

        /// <summary>
        /// Returns true if GcpRolesetKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GcpRolesetKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GcpRolesetKeyRequest input)
        {
            if (input == null)
            {
                return false;
