...
namespace VaultClient.Model
{
    ...
    /// GcpRoleRequest
    /// </summary>
    [DataContract(Name = "GcpRoleRequest")]
    public partial class GcpRoleRequest : IEquatable<GcpRoleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GcpRoleRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GcpRoleRequest {\n");
        ...
        {
            return this.Equals(input as GcpRoleRequest);
        }

        /// <summary>
        /// Returns true if GcpRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GcpRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GcpRoleRequest input)
        {
            if (input == null)
            {
                return false;
