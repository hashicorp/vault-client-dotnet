...
namespace VaultClient.Model
{
    ...
    /// AzureRoleRequest
    /// </summary>
    [DataContract(Name = "AzureRoleRequest")]
    public partial class AzureRoleRequest : IEquatable<AzureRoleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureRoleRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AzureRoleRequest {\n");
        ...
        {
            return this.Equals(input as AzureRoleRequest);
        }

        /// <summary>
        /// Returns true if AzureRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AzureRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AzureRoleRequest input)
        {
            if (input == null)
            {
                return false;
