...
namespace VaultClient.Model
{
    ...
    public partial class ApproleRoleCustomSecretIdRequest : IEquatable<ApproleRoleCustomSecretIdRequest>, IValidatableObject
    {
        ...
        public ApproleRoleCustomSecretIdRequest(List<string> cidrList = default(List<string>), string metadata = default(string), string secretId = default(string), List<string> tokenBoundCidrs = default(List<string>))
        {
