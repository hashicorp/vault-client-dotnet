...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OpenldapConfigRequest")]
    public partial class OpenldapConfigRequest : IEquatable<OpenldapConfigRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenldapConfigRequest" /> class.
        /// </summary>
        ...
        /// <param name="schema">The desired OpenLDAP schema used when modifying user account passwords. (default to &quot;openldap&quot;).</param>
        ...
        /// </summary>
        /// <value>The desired OpenLDAP schema used when modifying user account passwords.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpenldapConfigRequest {\n");
        ...
        {
            return this.Equals(input as OpenldapConfigRequest);
        }

        /// <summary>
        /// Returns true if OpenldapConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OpenldapConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpenldapConfigRequest input)
        {
            if (input == null)
            {
                return false;
