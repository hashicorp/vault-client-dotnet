...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "KubernetesCredsRequest")]
    public partial class KubernetesCredsRequest : IEquatable<KubernetesCredsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KubernetesCredsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected KubernetesCredsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="KubernetesCredsRequest" /> class.
        /// </summary>
        ...
        /// <param name="kubernetesNamespace">The name of the Kubernetes namespace in which to generate the service account (required).</param>
        /// <param name="ttl">The TTL of the generated credentials.</param>
        public KubernetesCredsRequest(bool clusterRoleBinding = default(bool), string kubernetesNamespace = default(string), int ttl = default(int))
        {
            // to ensure "kubernetesNamespace" is required (not null)
            if (kubernetesNamespace == null) {
                throw new ArgumentNullException("kubernetesNamespace is a required property for KubernetesCredsRequest and cannot be null");
            }
        ...
        /// <summary>
        /// The name of the Kubernetes namespace in which to generate the service account
        /// </summary>
        /// <value>The name of the Kubernetes namespace in which to generate the service account</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KubernetesCredsRequest {\n");
        ...
        {
            return this.Equals(input as KubernetesCredsRequest);
        }

        /// <summary>
        /// Returns true if KubernetesCredsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KubernetesCredsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KubernetesCredsRequest input)
        {
            if (input == null)
            {
                return false;
