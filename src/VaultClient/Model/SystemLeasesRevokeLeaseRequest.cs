...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemLeasesRevokeLeaseRequest")]
    public partial class SystemLeasesRevokeLeaseRequest : IEquatable<SystemLeasesRevokeLeaseRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemLeasesRevokeLeaseRequest" /> class.
        /// </summary>
        ...
        public SystemLeasesRevokeLeaseRequest(string leaseId = default(string), bool sync = true)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemLeasesRevokeLeaseRequest {\n");
        ...
        {
            return this.Equals(input as SystemLeasesRevokeLeaseRequest);
        }

        /// <summary>
        /// Returns true if SystemLeasesRevokeLeaseRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemLeasesRevokeLeaseRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemLeasesRevokeLeaseRequest input)
        {
            if (input == null)
            {
                return false;
