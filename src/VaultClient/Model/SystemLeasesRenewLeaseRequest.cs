...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemLeasesRenewLeaseRequest")]
    public partial class SystemLeasesRenewLeaseRequest : IEquatable<SystemLeasesRenewLeaseRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemLeasesRenewLeaseRequest" /> class.
        /// </summary>
        ...
        public SystemLeasesRenewLeaseRequest(int increment = default(int), string leaseId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemLeasesRenewLeaseRequest {\n");
        ...
        {
            return this.Equals(input as SystemLeasesRenewLeaseRequest);
        }

        /// <summary>
        /// Returns true if SystemLeasesRenewLeaseRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemLeasesRenewLeaseRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemLeasesRenewLeaseRequest input)
        {
            if (input == null)
            {
                return false;
