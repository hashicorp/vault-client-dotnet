...
namespace VaultClient.Model
{
    ...
    /// PkiKmsRequest
    /// </summary>
    [DataContract(Name = "PkiKmsRequest")]
    public partial class PkiKmsRequest : IEquatable<PkiKmsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiKmsRequest" /> class.
        /// </summary>
        ...
        public PkiKmsRequest(int keyBits = 0, string keyName = default(string), KeyTypeEnum? keyType = KeyTypeEnum.Rsa, string managedKeyId = default(string), string managedKeyName = default(string))
        {
        ...
        {
            return this.Equals(input as PkiKmsRequest);
        }

        /// <summary>
        /// Returns true if PkiKmsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiKmsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiKmsRequest input)
        {
            if (input == null)
            {
                return false;
