...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemAuthTuneRequest")]
    public partial class SystemAuthTuneRequest : IEquatable<SystemAuthTuneRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemAuthTuneRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemAuthTuneRequest {\n");
        ...
        {
            return this.Equals(input as SystemAuthTuneRequest);
        }

        /// <summary>
        /// Returns true if SystemAuthTuneRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemAuthTuneRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemAuthTuneRequest input)
        {
            if (input == null)
            {
                return false;
