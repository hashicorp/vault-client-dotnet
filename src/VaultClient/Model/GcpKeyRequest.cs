...
namespace VaultClient.Model
{
    ...
    /// GcpKeyRequest
    /// </summary>
    [DataContract(Name = "GcpKeyRequest")]
    public partial class GcpKeyRequest : IEquatable<GcpKeyRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GcpKeyRequest" /> class.
        /// </summary>
        ...
        public GcpKeyRequest(string keyAlgorithm = "KEY_ALG_RSA_2048", string keyType = "TYPE_GOOGLE_CREDENTIALS_FILE", int ttl = default(int))
        {
        ...
        {
            return this.Equals(input as GcpKeyRequest);
        }

        /// <summary>
        /// Returns true if GcpKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GcpKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GcpKeyRequest input)
        {
            if (input == null)
            {
                return false;
