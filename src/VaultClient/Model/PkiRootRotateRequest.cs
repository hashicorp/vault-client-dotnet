...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiRootRotateRequest")]
    public partial class PkiRootRotateRequest : IEquatable<PkiRootRotateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiRootRotateRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiRootRotateRequest {\n");
        ...
        {
            return this.Equals(input as PkiRootRotateRequest);
        }

        /// <summary>
        /// Returns true if PkiRootRotateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiRootRotateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiRootRotateRequest input)
        {
            if (input == null)
            {
                return false;
