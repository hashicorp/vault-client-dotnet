...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemCapabilitiesAccessorRequest")]
    public partial class SystemCapabilitiesAccessorRequest : IEquatable<SystemCapabilitiesAccessorRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemCapabilitiesAccessorRequest" /> class.
        /// </summary>
        ...
        public SystemCapabilitiesAccessorRequest(string accessor = default(string), List<string> path = default(List<string>), List<string> paths = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemCapabilitiesAccessorRequest {\n");
        ...
        {
            return this.Equals(input as SystemCapabilitiesAccessorRequest);
        }

        /// <summary>
        /// Returns true if SystemCapabilitiesAccessorRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemCapabilitiesAccessorRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemCapabilitiesAccessorRequest input)
        {
            if (input == null)
            {
                return false;
