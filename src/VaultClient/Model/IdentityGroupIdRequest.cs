...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityGroupIdRequest")]
    public partial class IdentityGroupIdRequest : IEquatable<IdentityGroupIdRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityGroupIdRequest" /> class.
        /// </summary>
        ...
        public IdentityGroupIdRequest(List<string> memberEntityIds = default(List<string>), List<string> memberGroupIds = default(List<string>), Object metadata = default(Object), string name = default(string), List<string> policies = default(List<string>), string type = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityGroupIdRequest {\n");
        ...
        {
            return this.Equals(input as IdentityGroupIdRequest);
        }

        /// <summary>
        /// Returns true if IdentityGroupIdRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityGroupIdRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityGroupIdRequest input)
        {
            if (input == null)
            {
                return false;
