...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiIntermediateGenerateRequest")]
    public partial class PkiIntermediateGenerateRequest : IEquatable<PkiIntermediateGenerateRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiIntermediateGenerateRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiIntermediateGenerateRequest {\n");
        ...
        {
            return this.Equals(input as PkiIntermediateGenerateRequest);
        }

        /// <summary>
        /// Returns true if PkiIntermediateGenerateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiIntermediateGenerateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiIntermediateGenerateRequest input)
        {
            if (input == null)
            {
                return false;
