...
namespace VaultClient.Model
{
    ...
    /// AdLibraryRequest
    /// </summary>
    [DataContract(Name = "AdLibraryRequest")]
    public partial class AdLibraryRequest : IEquatable<AdLibraryRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdLibraryRequest" /> class.
        /// </summary>
        ...
        public AdLibraryRequest(bool disableCheckInEnforcement = false, int maxTtl = 86400, List<string> serviceAccountNames = default(List<string>), int ttl = 86400)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdLibraryRequest {\n");
        ...
        {
            return this.Equals(input as AdLibraryRequest);
        }

        /// <summary>
        /// Returns true if AdLibraryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AdLibraryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdLibraryRequest input)
        {
            if (input == null)
            {
                return false;
