...
namespace VaultClient.Model
{
    ...
    /// LdapConfigRequest
    /// </summary>
    [DataContract(Name = "LdapConfigRequest")]
    public partial class LdapConfigRequest : IEquatable<LdapConfigRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LdapConfigRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LdapConfigRequest {\n");
        ...
        {
            return this.Equals(input as LdapConfigRequest);
        }

        /// <summary>
        /// Returns true if LdapConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LdapConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LdapConfigRequest input)
        {
            if (input == null)
            {
                return false;
