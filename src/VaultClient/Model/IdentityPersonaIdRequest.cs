...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityPersonaIdRequest")]
    public partial class IdentityPersonaIdRequest : IEquatable<IdentityPersonaIdRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityPersonaIdRequest" /> class.
        /// </summary>
        ...
        public IdentityPersonaIdRequest(string entityId = default(string), Object metadata = default(Object), string mountAccessor = default(string), string name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityPersonaIdRequest {\n");
        ...
        {
            return this.Equals(input as IdentityPersonaIdRequest);
        }

        /// <summary>
        /// Returns true if IdentityPersonaIdRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityPersonaIdRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityPersonaIdRequest input)
        {
            if (input == null)
            {
                return false;
