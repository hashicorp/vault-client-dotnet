...
namespace VaultClient.Model
{
    ...
    /// TokenRolesRequest
    /// </summary>
    [DataContract(Name = "TokenRolesRequest")]
    public partial class TokenRolesRequest : IEquatable<TokenRolesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenRolesRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenRolesRequest {\n");
        ...
        {
            return this.Equals(input as TokenRolesRequest);
        }

        /// <summary>
        /// Returns true if TokenRolesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenRolesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenRolesRequest input)
        {
            if (input == null)
            {
                return false;
