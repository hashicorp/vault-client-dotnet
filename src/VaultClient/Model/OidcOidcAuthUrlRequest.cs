...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OidcOidcAuthUrlRequest")]
    public partial class OidcOidcAuthUrlRequest : IEquatable<OidcOidcAuthUrlRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OidcOidcAuthUrlRequest" /> class.
        /// </summary>
        ...
        public OidcOidcAuthUrlRequest(string clientNonce = default(string), string redirectUri = default(string), string role = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OidcOidcAuthUrlRequest {\n");
        ...
        {
            return this.Equals(input as OidcOidcAuthUrlRequest);
        }

        /// <summary>
        /// Returns true if OidcOidcAuthUrlRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OidcOidcAuthUrlRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OidcOidcAuthUrlRequest input)
        {
            if (input == null)
            {
                return false;
