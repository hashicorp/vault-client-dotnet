...
namespace VaultClient.Model
{
    ...
    /// AdConfigRequest
    /// </summary>
    [DataContract(Name = "AdConfigRequest")]
    public partial class AdConfigRequest : IEquatable<AdConfigRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AdConfigRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdConfigRequest {\n");
        ...
        {
            return this.Equals(input as AdConfigRequest);
        }

        /// <summary>
        /// Returns true if AdConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AdConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdConfigRequest input)
        {
            if (input == null)
            {
                return false;
