...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "NomadConfigAccessRequest")]
    public partial class NomadConfigAccessRequest : IEquatable<NomadConfigAccessRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NomadConfigAccessRequest" /> class.
        /// </summary>
        ...
        public NomadConfigAccessRequest(string address = default(string), string caCert = default(string), string clientCert = default(string), string clientKey = default(string), int maxTokenNameLength = default(int), string token = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NomadConfigAccessRequest {\n");
        ...
        {
            return this.Equals(input as NomadConfigAccessRequest);
        }

        /// <summary>
        /// Returns true if NomadConfigAccessRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NomadConfigAccessRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NomadConfigAccessRequest input)
        {
            if (input == null)
            {
                return false;
