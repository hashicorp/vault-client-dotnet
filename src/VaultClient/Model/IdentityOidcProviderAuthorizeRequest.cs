...
namespace VaultClient.Model
{
    ...
    public partial class IdentityOidcProviderAuthorizeRequest : IEquatable<IdentityOidcProviderAuthorizeRequest>, IValidatableObject
    {
        ...
        /// <param name="state">The value used to maintain state between the authentication request and client. (required).</param>
        public IdentityOidcProviderAuthorizeRequest(string clientId = default(string), string codeChallenge = default(string), string codeChallengeMethod = "plain", int maxAge = default(int), string nonce = default(string), string redirectUri = default(string), string responseType = default(string), string scope = default(string), string state = default(string))
        {
            ...
            if (state == null) {
                throw new ArgumentNullException("state is a required property for IdentityOidcProviderAuthorizeRequest and cannot be null");
            }
            this.State = state;
