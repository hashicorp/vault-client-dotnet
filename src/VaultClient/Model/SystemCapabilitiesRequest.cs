...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemCapabilitiesRequest")]
    public partial class SystemCapabilitiesRequest : IEquatable<SystemCapabilitiesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemCapabilitiesRequest" /> class.
        /// </summary>
        ...
        public SystemCapabilitiesRequest(List<string> path = default(List<string>), List<string> paths = default(List<string>), string token = default(string))
        {
            this.Path = path;
            this.Paths = paths;
            this.Token = token;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemCapabilitiesRequest {\n");
        ...
        {
            return this.Equals(input as SystemCapabilitiesRequest);
        }

        /// <summary>
        /// Returns true if SystemCapabilitiesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemCapabilitiesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemCapabilitiesRequest input)
        {
            if (input == null)
            {
                return false;
