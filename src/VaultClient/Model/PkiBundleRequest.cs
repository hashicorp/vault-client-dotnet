...
namespace VaultClient.Model
{
    ...
    /// PkiBundleRequest
    /// </summary>
    [DataContract(Name = "PkiBundleRequest")]
    public partial class PkiBundleRequest : IEquatable<PkiBundleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiBundleRequest" /> class.
        /// </summary>
        /// <param name="pemBundle">PEM-format, concatenated unencrypted secret-key (optional) and certificates..</param>
        public PkiBundleRequest(string pemBundle = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiBundleRequest {\n");
        ...
        {
            return this.Equals(input as PkiBundleRequest);
        }

        /// <summary>
        /// Returns true if PkiBundleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiBundleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiBundleRequest input)
        {
            if (input == null)
            {
                return false;
