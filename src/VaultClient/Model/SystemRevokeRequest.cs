...
namespace VaultClient.Model
{
    ...
    /// SystemRevokeRequest
    /// </summary>
    [DataContract(Name = "SystemRevokeRequest")]
    public partial class SystemRevokeRequest : IEquatable<SystemRevokeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemRevokeRequest" /> class.
        /// </summary>
        ...
        public SystemRevokeRequest(string leaseId = default(string), bool sync = true, string urlLeaseId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemRevokeRequest {\n");
        ...
        {
            return this.Equals(input as SystemRevokeRequest);
        }

        /// <summary>
        /// Returns true if SystemRevokeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemRevokeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemRevokeRequest input)
        {
            if (input == null)
            {
                return false;
