...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApproleRoleTokenBoundCidrsRequest")]
    public partial class ApproleRoleTokenBoundCidrsRequest : IEquatable<ApproleRoleTokenBoundCidrsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproleRoleTokenBoundCidrsRequest" /> class.
        /// </summary>
        ...
        public ApproleRoleTokenBoundCidrsRequest(List<string> tokenBoundCidrs = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApproleRoleTokenBoundCidrsRequest {\n");
        ...
        {
            return this.Equals(input as ApproleRoleTokenBoundCidrsRequest);
        }

        /// <summary>
        /// Returns true if ApproleRoleTokenBoundCidrsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproleRoleTokenBoundCidrsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproleRoleTokenBoundCidrsRequest input)
        {
            if (input == null)
            {
                return false;
