...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RabbitmqRolesRequest")]
    public partial class RabbitmqRolesRequest : IEquatable<RabbitmqRolesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RabbitmqRolesRequest" /> class.
        /// </summary>
        ...
        public RabbitmqRolesRequest(string tags = default(string), string vhostTopics = default(string), string vhosts = default(string))
        {
            this.Tags = tags;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RabbitmqRolesRequest {\n");
        ...
        {
            return this.Equals(input as RabbitmqRolesRequest);
        }

        /// <summary>
        /// Returns true if RabbitmqRolesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RabbitmqRolesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RabbitmqRolesRequest input)
        {
            if (input == null)
            {
                return false;
