...
namespace VaultClient.Model
{
    ...
    public partial class TransitSignRequest : IEquatable<TransitSignRequest>, IValidatableObject
    {
        ...
        public TransitSignRequest(string algorithm = "sha2-256", string context = default(string), string hashAlgorithm = "sha2-256", string input = default(string), int keyVersion = default(int), string marshalingAlgorithm = "asn1", bool prehashed = default(bool), string signatureAlgorithm = default(string), string urlalgorithm = default(string))
        {
