...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityGroupAliasRequest")]
    public partial class IdentityGroupAliasRequest : IEquatable<IdentityGroupAliasRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityGroupAliasRequest" /> class.
        /// </summary>
        ...
        public IdentityGroupAliasRequest(string canonicalId = default(string), string id = default(string), string mountAccessor = default(string), string name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityGroupAliasRequest {\n");
        ...
        {
            return this.Equals(input as IdentityGroupAliasRequest);
        }

        /// <summary>
        /// Returns true if IdentityGroupAliasRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityGroupAliasRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityGroupAliasRequest input)
        {
            if (input == null)
            {
                return false;
