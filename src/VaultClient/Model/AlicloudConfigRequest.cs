...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AlicloudConfigRequest")]
    public partial class AlicloudConfigRequest : IEquatable<AlicloudConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AlicloudConfigRequest" /> class.
        /// </summary>
        ...
        public AlicloudConfigRequest(string accessKey = default(string), string secretKey = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AlicloudConfigRequest {\n");
        ...
        {
            return this.Equals(input as AlicloudConfigRequest);
        }

        /// <summary>
        /// Returns true if AlicloudConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AlicloudConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AlicloudConfigRequest input)
        {
            if (input == null)
            {
                return false;
