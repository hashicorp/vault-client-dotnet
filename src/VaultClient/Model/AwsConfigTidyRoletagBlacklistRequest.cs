...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsConfigTidyRoletagBlacklistRequest")]
    public partial class AwsConfigTidyRoletagBlacklistRequest : IEquatable<AwsConfigTidyRoletagBlacklistRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AwsConfigTidyRoletagBlacklistRequest" /> class.
        /// </summary>
        ...
        public AwsConfigTidyRoletagBlacklistRequest(bool disablePeriodicTidy = false, int safetyBuffer = 15552000)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsConfigTidyRoletagBlacklistRequest {\n");
        ...
        {
            return this.Equals(input as AwsConfigTidyRoletagBlacklistRequest);
        }

        /// <summary>
        /// Returns true if AwsConfigTidyRoletagBlacklistRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsConfigTidyRoletagBlacklistRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsConfigTidyRoletagBlacklistRequest input)
        {
            if (input == null)
            {
                return false;
