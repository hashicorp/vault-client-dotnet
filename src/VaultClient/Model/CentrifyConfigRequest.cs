...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CentrifyConfigRequest")]
    public partial class CentrifyConfigRequest : IEquatable<CentrifyConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CentrifyConfigRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CentrifyConfigRequest {\n");
        ...
        {
            return this.Equals(input as CentrifyConfigRequest);
        }

        /// <summary>
        /// Returns true if CentrifyConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CentrifyConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CentrifyConfigRequest input)
        {
            if (input == null)
            {
                return false;
