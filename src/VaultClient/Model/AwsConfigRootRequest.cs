...
namespace VaultClient.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsConfigRootRequest")]
    public partial class AwsConfigRootRequest : IEquatable<AwsConfigRootRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AwsConfigRootRequest" /> class.
        /// </summary>
        ...
        public AwsConfigRootRequest(string accessKey = default(string), string iamEndpoint = default(string), int maxRetries = -1, string region = default(string), string secretKey = default(string), string stsEndpoint = default(string), string usernameTemplate = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsConfigRootRequest {\n");
        ...
        {
            return this.Equals(input as AwsConfigRootRequest);
        }

        /// <summary>
        /// Returns true if AwsConfigRootRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsConfigRootRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsConfigRootRequest input)
        {
            if (input == null)
            {
                return false;
