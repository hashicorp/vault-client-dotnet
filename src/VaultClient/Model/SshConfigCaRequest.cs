...
namespace VaultClient.Model
{
    ...
    /// SshConfigCaRequest
    /// </summary>
    [DataContract(Name = "SshConfigCaRequest")]
    public partial class SshConfigCaRequest : IEquatable<SshConfigCaRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SshConfigCaRequest" /> class.
        /// </summary>
        ...
        public SshConfigCaRequest(bool generateSigningKey = true, int keyBits = 0, string keyType = "ssh-rsa", string privateKey = default(string), string publicKey = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SshConfigCaRequest {\n");
        ...
        {
            return this.Equals(input as SshConfigCaRequest);
        }

        /// <summary>
        /// Returns true if SshConfigCaRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SshConfigCaRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SshConfigCaRequest input)
        {
            if (input == null)
            {
                return false;
