...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RekeyAttemptInitializeResponse")]
    public partial class RekeyAttemptInitializeResponse : IEquatable<RekeyAttemptInitializeResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="RekeyAttemptInitializeResponse" /> class.
        /// </summary>
        ...
        public RekeyAttemptInitializeResponse(bool Backup = default(bool), int N = default(int), string Nounce = default(string), List<string> PgpFingerprints = default(List<string>), int Progress = default(int), int Required = default(int), string Started = default(string), int T = default(int), string VerificationNonce = default(string), bool VerificationRequired = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RekeyAttemptInitializeResponse {\n");
        ...
        {
            return this.Equals(input as RekeyAttemptInitializeResponse);
        }

        /// <summary>
        /// Returns true if RekeyAttemptInitializeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RekeyAttemptInitializeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RekeyAttemptInitializeResponse input)
        {
            if (input == null)
            {
                return false;
