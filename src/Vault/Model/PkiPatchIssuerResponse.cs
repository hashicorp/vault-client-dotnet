...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiPatchIssuerResponse")]
    public partial class PkiPatchIssuerResponse : IEquatable<PkiPatchIssuerResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiPatchIssuerResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiPatchIssuerResponse {\n");
        ...
        {
            return this.Equals(input as PkiPatchIssuerResponse);
        }

        /// <summary>
        /// Returns true if PkiPatchIssuerResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiPatchIssuerResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiPatchIssuerResponse input)
        {
            if (input == null)
            {
                return false;
