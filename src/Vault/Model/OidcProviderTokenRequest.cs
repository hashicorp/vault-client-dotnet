...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OidcProviderTokenRequest")]
    public partial class OidcProviderTokenRequest : IEquatable<OidcProviderTokenRequest>, IValidatableObject
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="OidcProviderTokenRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OidcProviderTokenRequest() { }
        ...
        public OidcProviderTokenRequest(string ClientId = default(string), string ClientSecret = default(string), string Code = default(string), string CodeVerifier = default(string), string GrantType = default(string), string RedirectUri = default(string))
        {

            // to ensure "Code" is required (not null)
            if (Code == null)
            {
                throw new ArgumentNullException("Code is a required property for OidcProviderTokenRequest and cannot be null");
            }
            this.Code = Code;
            ...
            if (GrantType == null)
            {
                throw new ArgumentNullException("GrantType is a required property for OidcProviderTokenRequest and cannot be null");
            }
            ...
            if (RedirectUri == null)
            {
                throw new ArgumentNullException("RedirectUri is a required property for OidcProviderTokenRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OidcProviderTokenRequest {\n");
        ...
        {
            return this.Equals(input as OidcProviderTokenRequest);
        }

        /// <summary>
        /// Returns true if OidcProviderTokenRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OidcProviderTokenRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OidcProviderTokenRequest input)
        {
            if (input == null)
            {
                return false;
