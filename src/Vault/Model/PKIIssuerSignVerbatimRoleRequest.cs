...
namespace Vault.Model
{
    ...
    public partial class PKIIssuerSignVerbatimRoleRequest : IEquatable<PKIIssuerSignVerbatimRoleRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PKIIssuerSignVerbatimRoleRequest {\n");
        ...
        {
            return this.Equals(input as PKIIssuerSignVerbatimRoleRequest);
        }

        /// <summary>
        /// Returns true if PKIIssuerSignVerbatimRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PKIIssuerSignVerbatimRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PKIIssuerSignVerbatimRoleRequest input)
        {
            if (input == null)
            {
                return false;
