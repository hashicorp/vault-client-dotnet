...
namespace Vault.Model
{
    ...
    public partial class TransitWriteRandomUrlbytesRequest : IEquatable<TransitWriteRandomUrlbytesRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransitWriteRandomUrlbytesRequest" /> class.
        /// </summary>
        ...
        public TransitWriteRandomUrlbytesRequest(int Bytes = 32, string Format = "base64", string Source = "platform")
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitWriteRandomUrlbytesRequest {\n");
        ...
        {
            return this.Equals(input as TransitWriteRandomUrlbytesRequest);
        }

        /// <summary>
        /// Returns true if TransitWriteRandomUrlbytesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitWriteRandomUrlbytesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitWriteRandomUrlbytesRequest input)
        {
            if (input == null)
            {
                return false;
