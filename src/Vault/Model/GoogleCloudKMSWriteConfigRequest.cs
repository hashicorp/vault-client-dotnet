...
namespace Vault.Model
{
    ...
    public partial class GoogleCloudKMSWriteConfigRequest : IEquatable<GoogleCloudKMSWriteConfigRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GoogleCloudKMSWriteConfigRequest {\n");
        ...
        {
            return this.Equals(input as GoogleCloudKMSWriteConfigRequest);
        }

        /// <summary>
        /// Returns true if GoogleCloudKMSWriteConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GoogleCloudKMSWriteConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoogleCloudKMSWriteConfigRequest input)
        {
            if (input == null)
            {
                return false;
