...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityEntityAliasRequest")]
    public partial class IdentityEntityAliasRequest : IEquatable<IdentityEntityAliasRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityEntityAliasRequest" /> class.
        /// </summary>
        ...
        public IdentityEntityAliasRequest(string canonicalId = default(string), Object customMetadata = default(Object), string entityId = default(string), string id = default(string), string mountAccessor = default(string), string name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityEntityAliasRequest {\n");
        ...
        {
            return this.Equals(input as IdentityEntityAliasRequest);
        }

        /// <summary>
        /// Returns true if IdentityEntityAliasRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityEntityAliasRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityEntityAliasRequest input)
        {
            if (input == null)
            {
                return false;
