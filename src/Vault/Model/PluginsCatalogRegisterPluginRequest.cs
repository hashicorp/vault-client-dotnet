...
namespace Vault.Model
{
    ...
    public partial class PluginsCatalogRegisterPluginRequest : IEquatable<PluginsCatalogRegisterPluginRequest>, IValidatableObject
    {
        ...
        public PluginsCatalogRegisterPluginRequest(List<string> Args = default(List<string>), string Command = default(string), List<string> Env = default(List<string>), string OciImage = default(string), string Sha256 = default(string), string _Version = default(string))
        {
