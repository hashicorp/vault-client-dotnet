...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "KvV2ConfigureRequest")]
    public partial class KvV2ConfigureRequest : IEquatable<KvV2ConfigureRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="KvV2ConfigureRequest" /> class.
        /// </summary>
        ...
        public KvV2ConfigureRequest(bool CasRequired = default(bool), string DeleteVersionAfter = default(string), int MaxVersions = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KvV2ConfigureRequest {\n");
        ...
        {
            return this.Equals(input as KvV2ConfigureRequest);
        }

        /// <summary>
        /// Returns true if KvV2ConfigureRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KvV2ConfigureRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KvV2ConfigureRequest input)
        {
            if (input == null)
            {
                return false;
