...
namespace Vault.Model
{
    ...
    /// GithubConfigRequest
    /// </summary>
    [DataContract(Name = "GithubConfigRequest")]
    public partial class GithubConfigRequest : IEquatable<GithubConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GithubConfigRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GithubConfigRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GithubConfigRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GithubConfigRequest {\n");
        ...
        {
            return this.Equals(input as GithubConfigRequest);
        }

        /// <summary>
        /// Returns true if GithubConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GithubConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GithubConfigRequest input)
        {
            if (input == null)
            {
                return false;
