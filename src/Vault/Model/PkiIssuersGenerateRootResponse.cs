...
namespace Vault.Model
{
    ...
    public partial class PkiIssuersGenerateRootResponse : IEquatable<PkiIssuersGenerateRootResponse>, IValidatableObject
    {
        ...
        public PkiIssuersGenerateRootResponse(string Certificate = default(string), long Expiration = default(long), string IssuerId = default(string), string IssuerName = default(string), string IssuingCa = default(string), string KeyId = default(string), string KeyName = default(string), string PrivateKey = default(string), string SerialNumber = default(string))
        {
