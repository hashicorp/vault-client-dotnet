...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiIssuersGenerateRootResponse")]
    public partial class PkiIssuersGenerateRootResponse : IEquatable<PkiIssuersGenerateRootResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiIssuersGenerateRootResponse" /> class.
        /// </summary>
        ...
        public PkiIssuersGenerateRootResponse(string Certificate = default(string), string Expiration = default(string), string IssuerId = default(string), string IssuerName = default(string), string IssuingCa = default(string), string KeyId = default(string), string KeyName = default(string), string PrivateKey = default(string), string SerialNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiIssuersGenerateRootResponse {\n");
        ...
        {
            return this.Equals(input as PkiIssuersGenerateRootResponse);
        }

        /// <summary>
        /// Returns true if PkiIssuersGenerateRootResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiIssuersGenerateRootResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiIssuersGenerateRootResponse input)
        {
            if (input == null)
            {
                return false;
