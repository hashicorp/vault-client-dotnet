...
namespace Vault.Model
{
    ...
    public partial class RenewRequest : IEquatable<RenewRequest>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as RenewRequest);
        }

        /// <summary>
        /// Returns true if RenewRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RenewRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RenewRequest input)
        {
            if (input == null)
            {
                return false;
