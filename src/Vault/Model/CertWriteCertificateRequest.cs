...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CertWriteCertificateRequest")]
    public partial class CertWriteCertificateRequest : IEquatable<CertWriteCertificateRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="CertWriteCertificateRequest" /> class.
        /// </summary>
        ...
        public CertWriteCertificateRequest(List<string> AllowedCommonNames = default(List<string>), List<string> AllowedDnsSans = default(List<string>), List<string> AllowedEmailSans = default(List<string>), List<string> AllowedMetadataExtensions = default(List<string>), List<string> AllowedNames = default(List<string>), List<string> AllowedOrganizationalUnits = default(List<string>), List<string> AllowedUriSans = default(List<string>), List<string> BoundCidrs = default(List<string>), string Certificate = default(string), string DisplayName = default(string), int Lease = default(int), string MaxTtl = default(string), string OcspCaCertificates = default(string), bool OcspEnabled = default(bool), bool OcspFailOpen = false, bool OcspQueryAllServers = false, List<string> OcspServersOverride = default(List<string>), string Period = default(string), List<string> Policies = default(List<string>), List<string> RequiredExtensions = default(List<string>), List<string> TokenBoundCidrs = default(List<string>), string TokenExplicitMaxTtl = default(string), string TokenMaxTtl = default(string), bool TokenNoDefaultPolicy = default(bool), int TokenNumUses = default(int), string TokenPeriod = default(string), List<string> TokenPolicies = default(List<string>), string TokenTtl = default(string), string TokenType = "default-service", string Ttl = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CertWriteCertificateRequest {\n");
        ...
        {
            return this.Equals(input as CertWriteCertificateRequest);
        }

        /// <summary>
        /// Returns true if CertWriteCertificateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CertWriteCertificateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CertWriteCertificateRequest input)
        {
            if (input == null)
            {
                return false;
