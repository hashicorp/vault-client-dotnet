...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TokenCreateAgainstRoleRequest")]
    public partial class TokenCreateAgainstRoleRequest : IEquatable<TokenCreateAgainstRoleRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="TokenCreateAgainstRoleRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenCreateAgainstRoleRequest {\n");
        ...
        {
            return this.Equals(input as TokenCreateAgainstRoleRequest);
        }

        /// <summary>
        /// Returns true if TokenCreateAgainstRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenCreateAgainstRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenCreateAgainstRoleRequest input)
        {
            if (input == null)
            {
                return false;
