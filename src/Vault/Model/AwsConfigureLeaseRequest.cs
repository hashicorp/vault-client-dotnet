...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsConfigureLeaseRequest")]
    public partial class AwsConfigureLeaseRequest : IEquatable<AwsConfigureLeaseRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AwsConfigureLeaseRequest" /> class.
        /// </summary>
        ...
        public AwsConfigureLeaseRequest(string Lease = default(string), string LeaseMax = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsConfigureLeaseRequest {\n");
        ...
        {
            return this.Equals(input as AwsConfigureLeaseRequest);
        }

        /// <summary>
        /// Returns true if AwsConfigureLeaseRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsConfigureLeaseRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsConfigureLeaseRequest input)
        {
            if (input == null)
            {
                return false;
