...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiConfigureIssuersRequest")]
    public partial class PkiConfigureIssuersRequest : IEquatable<PkiConfigureIssuersRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiConfigureIssuersRequest" /> class.
        /// </summary>
        ...
        public PkiConfigureIssuersRequest(string Default = default(string), bool DefaultFollowsLatestIssuer = false)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiConfigureIssuersRequest {\n");
        ...
        {
            return this.Equals(input as PkiConfigureIssuersRequest);
        }

        /// <summary>
        /// Returns true if PkiConfigureIssuersRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiConfigureIssuersRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiConfigureIssuersRequest input)
        {
            if (input == null)
            {
                return false;
