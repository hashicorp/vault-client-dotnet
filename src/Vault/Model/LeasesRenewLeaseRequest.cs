...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LeasesRenewLeaseRequest")]
    public partial class LeasesRenewLeaseRequest : IEquatable<LeasesRenewLeaseRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="LeasesRenewLeaseRequest" /> class.
        /// </summary>
        ...
        public LeasesRenewLeaseRequest(int Increment = default(int), string LeaseId = default(string), string UrlLeaseId = default(string))
        {
        ...
        {
            return this.Equals(input as LeasesRenewLeaseRequest);
        }

        /// <summary>
        /// Returns true if LeasesRenewLeaseRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LeasesRenewLeaseRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LeasesRenewLeaseRequest input)
        {
            if (input == null)
            {
                return false;
