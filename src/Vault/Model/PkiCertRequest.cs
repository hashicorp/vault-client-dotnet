...
namespace Vault.Model
{
    ...
    /// PkiCertRequest
    /// </summary>
    [DataContract(Name = "PkiCertRequest")]
    public partial class PkiCertRequest : IEquatable<PkiCertRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiCertRequest" /> class.
        /// </summary>
        /// <param name="pemBundle">PEM-format, concatenated unencrypted secret-key (optional) and certificates..</param>
        public PkiCertRequest(string pemBundle = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiCertRequest {\n");
        ...
        {
            return this.Equals(input as PkiCertRequest);
        }

        /// <summary>
        /// Returns true if PkiCertRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiCertRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiCertRequest input)
        {
            if (input == null)
            {
                return false;
