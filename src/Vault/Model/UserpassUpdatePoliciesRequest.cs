...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserpassUpdatePoliciesRequest")]
    public partial class UserpassUpdatePoliciesRequest : IEquatable<UserpassUpdatePoliciesRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="UserpassUpdatePoliciesRequest" /> class.
        /// </summary>
        ...
        public UserpassUpdatePoliciesRequest(List<string> Policies = default(List<string>), List<string> TokenPolicies = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserpassUpdatePoliciesRequest {\n");
        ...
        {
            return this.Equals(input as UserpassUpdatePoliciesRequest);
        }

        /// <summary>
        /// Returns true if UserpassUpdatePoliciesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UserpassUpdatePoliciesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserpassUpdatePoliciesRequest input)
        {
            if (input == null)
            {
                return false;
