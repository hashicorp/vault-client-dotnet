...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GenerateHashWithAlgorithmRequest")]
    public partial class GenerateHashWithAlgorithmRequest : IEquatable<GenerateHashWithAlgorithmRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateHashWithAlgorithmRequest" /> class.
        /// </summary>
        ...
        public GenerateHashWithAlgorithmRequest(string Algorithm = "sha2-256", string Format = "hex", string Input = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenerateHashWithAlgorithmRequest {\n");
        ...
        {
            return this.Equals(input as GenerateHashWithAlgorithmRequest);
        }

        /// <summary>
        /// Returns true if GenerateHashWithAlgorithmRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateHashWithAlgorithmRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateHashWithAlgorithmRequest input)
        {
            if (input == null)
            {
                return false;
