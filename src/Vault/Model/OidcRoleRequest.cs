...
namespace Vault.Model
{
    ...
    /// OidcRoleRequest
    /// </summary>
    [DataContract(Name = "OidcRoleRequest")]
    public partial class OidcRoleRequest : IEquatable<OidcRoleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OidcRoleRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OidcRoleRequest {\n");
        ...
        {
            return this.Equals(input as OidcRoleRequest);
        }

        /// <summary>
        /// Returns true if OidcRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OidcRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OidcRoleRequest input)
        {
            if (input == null)
            {
                return false;
