...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransitSignWithAlgorithmRequest")]
    public partial class TransitSignWithAlgorithmRequest : IEquatable<TransitSignWithAlgorithmRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="TransitSignWithAlgorithmRequest" /> class.
        /// </summary>
        ...
        public TransitSignWithAlgorithmRequest(string Algorithm = "sha2-256", List<Object> BatchInput = default(List<Object>), string Context = default(string), string HashAlgorithm = "sha2-256", string Input = default(string), int KeyVersion = default(int), string MarshalingAlgorithm = "asn1", bool Prehashed = default(bool), string SaltLength = "auto", string SignatureAlgorithm = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitSignWithAlgorithmRequest {\n");
        ...
        {
            return this.Equals(input as TransitSignWithAlgorithmRequest);
        }

        /// <summary>
        /// Returns true if TransitSignWithAlgorithmRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitSignWithAlgorithmRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitSignWithAlgorithmRequest input)
        {
            if (input == null)
            {
                return false;
