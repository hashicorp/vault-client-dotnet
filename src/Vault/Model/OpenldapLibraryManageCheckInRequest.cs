...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OpenldapLibraryManageCheckInRequest")]
    public partial class OpenldapLibraryManageCheckInRequest : IEquatable<OpenldapLibraryManageCheckInRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenldapLibraryManageCheckInRequest" /> class.
        /// </summary>
        /// <param name="serviceAccountNames">The username/logon name for the service accounts to check in..</param>
        public OpenldapLibraryManageCheckInRequest(List<string> serviceAccountNames = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpenldapLibraryManageCheckInRequest {\n");
        ...
        {
            return this.Equals(input as OpenldapLibraryManageCheckInRequest);
        }

        /// <summary>
        /// Returns true if OpenldapLibraryManageCheckInRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OpenldapLibraryManageCheckInRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpenldapLibraryManageCheckInRequest input)
        {
            if (input == null)
            {
                return false;
