...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApproleRolePeriodRequest")]
    public partial class ApproleRolePeriodRequest : IEquatable<ApproleRolePeriodRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproleRolePeriodRequest" /> class.
        /// </summary>
        ...
        public ApproleRolePeriodRequest(int period = default(int), int tokenPeriod = default(int))
        {
            this.Period = period;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApproleRolePeriodRequest {\n");
        ...
        {
            return this.Equals(input as ApproleRolePeriodRequest);
        }

        /// <summary>
        /// Returns true if ApproleRolePeriodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproleRolePeriodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproleRolePeriodRequest input)
        {
            if (input == null)
            {
                return false;
