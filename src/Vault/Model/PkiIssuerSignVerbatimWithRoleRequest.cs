...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiIssuerSignVerbatimWithRoleRequest")]
    public partial class PkiIssuerSignVerbatimWithRoleRequest : IEquatable<PkiIssuerSignVerbatimWithRoleRequest>, IValidatableObject
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiIssuerSignVerbatimWithRoleRequest" /> class.
        /// </summary>
        ...
        public PkiIssuerSignVerbatimWithRoleRequest(string AltNames = default(string), string CommonName = default(string), string Csr = "", bool ExcludeCnFromSans = false, List<string> ExtKeyUsage = default(List<string>), List<string> ExtKeyUsageOids = default(List<string>), FormatEnum? Format = FormatEnum.Pem, List<string> IpSans = default(List<string>), List<string> KeyUsage = default(List<string>), string NotAfter = default(string), List<string> OtherSans = default(List<string>), PrivateKeyFormatEnum? PrivateKeyFormat = PrivateKeyFormatEnum.Der, bool RemoveRootsFromChain = false, string SerialNumber = default(string), int SignatureBits = 0, int Ttl = default(int), List<string> UriSans = default(List<string>), bool UsePss = false, List<string> UserIds = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiIssuerSignVerbatimWithRoleRequest {\n");
        ...
        {
            return this.Equals(input as PkiIssuerSignVerbatimWithRoleRequest);
        }

        /// <summary>
        /// Returns true if PkiIssuerSignVerbatimWithRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiIssuerSignVerbatimWithRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiIssuerSignVerbatimWithRoleRequest input)
        {
            if (input == null)
            {
                return false;
