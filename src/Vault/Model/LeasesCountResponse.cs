...
namespace Vault.Model
{
    ...
    /// LeasesCountResponse
    /// </summary>
    [DataContract(Name = "LeasesCountResponse")]
    public partial class LeasesCountResponse : IEquatable<LeasesCountResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="LeasesCountResponse" /> class.
        /// </summary>
        ...
        public LeasesCountResponse(int Counts = default(int), int LeaseCount = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LeasesCountResponse {\n");
        ...
        {
            return this.Equals(input as LeasesCountResponse);
        }

        /// <summary>
        /// Returns true if LeasesCountResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of LeasesCountResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LeasesCountResponse input)
        {
            if (input == null)
            {
                return false;
