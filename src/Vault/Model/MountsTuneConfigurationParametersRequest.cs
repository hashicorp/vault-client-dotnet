...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MountsTuneConfigurationParametersRequest")]
    public partial class MountsTuneConfigurationParametersRequest : IEquatable<MountsTuneConfigurationParametersRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="MountsTuneConfigurationParametersRequest" /> class.
        /// </summary>
        ...
        public MountsTuneConfigurationParametersRequest(List<string> AllowedManagedKeys = default(List<string>), List<string> AllowedResponseHeaders = default(List<string>), List<string> AuditNonHmacRequestKeys = default(List<string>), List<string> AuditNonHmacResponseKeys = default(List<string>), string DefaultLeaseTtl = default(string), string Description = default(string), string ListingVisibility = default(string), string MaxLeaseTtl = default(string), Object Options = default(Object), List<string> PassthroughRequestHeaders = default(List<string>), string PluginVersion = default(string), string TokenType = default(string), Object UserLockoutConfig = default(Object))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MountsTuneConfigurationParametersRequest {\n");
        ...
        {
            return this.Equals(input as MountsTuneConfigurationParametersRequest);
        }

        /// <summary>
        /// Returns true if MountsTuneConfigurationParametersRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MountsTuneConfigurationParametersRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MountsTuneConfigurationParametersRequest input)
        {
            if (input == null)
            {
                return false;
