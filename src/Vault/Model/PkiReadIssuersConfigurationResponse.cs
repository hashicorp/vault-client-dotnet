...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadIssuersConfigurationResponse")]
    public partial class PkiReadIssuersConfigurationResponse : IEquatable<PkiReadIssuersConfigurationResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadIssuersConfigurationResponse" /> class.
        /// </summary>

        /// <param name="Default">Reference (name or identifier) to the default issuer..</param>

        /// <param name="DefaultFollowsLatestIssuer">Whether the default issuer should automatically follow the latest generated or imported issuer. Defaults to false..</param>


        public PkiReadIssuersConfigurationResponse(string Default = default(string), bool DefaultFollowsLatestIssuer = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadIssuersConfigurationResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadIssuersConfigurationResponse);
        }

        /// <summary>
        /// Returns true if PkiReadIssuersConfigurationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadIssuersConfigurationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadIssuersConfigurationResponse input)
        {
            if (input == null)
            {
                return false;
