...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "KubernetesConfigureRequest")]
    public partial class KubernetesConfigureRequest : IEquatable<KubernetesConfigureRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="KubernetesConfigureRequest" /> class.
        /// </summary>
        ...
        public KubernetesConfigureRequest(bool DisableLocalCaJwt = false, string KubernetesCaCert = default(string), string KubernetesHost = default(string), string ServiceAccountJwt = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KubernetesConfigureRequest {\n");
        ...
        {
            return this.Equals(input as KubernetesConfigureRequest);
        }

        /// <summary>
        /// Returns true if KubernetesConfigureRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KubernetesConfigureRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KubernetesConfigureRequest input)
        {
            if (input == null)
            {
                return false;
