...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiRevokeWithKeyResponse")]
    public partial class PkiRevokeWithKeyResponse : IEquatable<PkiRevokeWithKeyResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiRevokeWithKeyResponse" /> class.
        /// </summary>
        ...
        public PkiRevokeWithKeyResponse(long RevocationTime = default(long), DateTime RevocationTimeRfc3339 = default(DateTime), string State = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiRevokeWithKeyResponse {\n");
        ...
        {
            return this.Equals(input as PkiRevokeWithKeyResponse);
        }

        /// <summary>
        /// Returns true if PkiRevokeWithKeyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiRevokeWithKeyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiRevokeWithKeyResponse input)
        {
            if (input == null)
            {
                return false;
