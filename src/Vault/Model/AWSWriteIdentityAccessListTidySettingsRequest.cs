...
namespace Vault.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AWSWriteIdentityAccessListTidySettingsRequest" /> class.
        /// </summary>
        ...
        public AWSWriteIdentityAccessListTidySettingsRequest(int safetyBuffer = 259200)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AWSWriteIdentityAccessListTidySettingsRequest {\n");
        ...
        {
            return this.Equals(input as AWSWriteIdentityAccessListTidySettingsRequest);
        }

        /// <summary>
        /// Returns true if AWSWriteIdentityAccessListTidySettingsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AWSWriteIdentityAccessListTidySettingsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AWSWriteIdentityAccessListTidySettingsRequest input)
        {
            if (input == null)
            {
                return false;
