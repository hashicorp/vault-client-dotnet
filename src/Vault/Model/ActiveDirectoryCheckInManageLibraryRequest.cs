...
namespace Vault.Model
{
    ...
    public partial class ActiveDirectoryCheckInManageLibraryRequest : IEquatable<ActiveDirectoryCheckInManageLibraryRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ActiveDirectoryCheckInManageLibraryRequest" /> class.
        /// </summary>

        /// <param name="ServiceAccountNames">The username/logon name for the service accounts to check in..</param>


        public ActiveDirectoryCheckInManageLibraryRequest(List<string> ServiceAccountNames = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActiveDirectoryCheckInManageLibraryRequest {\n");
        ...
        {
            return this.Equals(input as ActiveDirectoryCheckInManageLibraryRequest);
        }

        /// <summary>
        /// Returns true if ActiveDirectoryCheckInManageLibraryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ActiveDirectoryCheckInManageLibraryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActiveDirectoryCheckInManageLibraryRequest input)
        {
            if (input == null)
            {
                return false;
