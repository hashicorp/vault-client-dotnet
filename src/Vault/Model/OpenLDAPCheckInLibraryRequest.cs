...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OpenLDAPCheckInLibraryRequest")]
    public partial class OpenLDAPCheckInLibraryRequest : IEquatable<OpenLDAPCheckInLibraryRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenLDAPCheckInLibraryRequest" /> class.
        /// </summary>
        /// <param name="serviceAccountNames">The username/logon name for the service accounts to check in..</param>
        public OpenLDAPCheckInLibraryRequest(List<string> serviceAccountNames = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpenLDAPCheckInLibraryRequest {\n");
        ...
        {
            return this.Equals(input as OpenLDAPCheckInLibraryRequest);
        }

        /// <summary>
        /// Returns true if OpenLDAPCheckInLibraryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OpenLDAPCheckInLibraryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpenLDAPCheckInLibraryRequest input)
        {
            if (input == null)
            {
                return false;
