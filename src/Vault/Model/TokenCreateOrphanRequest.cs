...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TokenCreateOrphanRequest")]
    public partial class TokenCreateOrphanRequest : IEquatable<TokenCreateOrphanRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="TokenCreateOrphanRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenCreateOrphanRequest {\n");
        ...
        {
            return this.Equals(input as TokenCreateOrphanRequest);
        }

        /// <summary>
        /// Returns true if TokenCreateOrphanRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenCreateOrphanRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenCreateOrphanRequest input)
        {
            if (input == null)
            {
                return false;
