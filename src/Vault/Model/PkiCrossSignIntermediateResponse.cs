...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiCrossSignIntermediateResponse")]
    public partial class PkiCrossSignIntermediateResponse : IEquatable<PkiCrossSignIntermediateResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiCrossSignIntermediateResponse" /> class.
        /// </summary>
        ...
        public PkiCrossSignIntermediateResponse(string Csr = default(string), string KeyId = default(string), string PrivateKey = default(string), string PrivateKeyType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiCrossSignIntermediateResponse {\n");
        ...
        {
            return this.Equals(input as PkiCrossSignIntermediateResponse);
        }

        /// <summary>
        /// Returns true if PkiCrossSignIntermediateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiCrossSignIntermediateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiCrossSignIntermediateResponse input)
        {
            if (input == null)
            {
                return false;
