...
namespace Vault.Model
{
    ...
    public partial class WritePluginsCatalogByTypeByNameRequest : IEquatable<WritePluginsCatalogByTypeByNameRequest>, IValidatableObject
    {
        ...
        public WritePluginsCatalogByTypeByNameRequest(List<string> args = default(List<string>), string command = default(string), List<string> env = default(List<string>), string sha256 = default(string), string version = default(string))
        {
            this.Args = args;
