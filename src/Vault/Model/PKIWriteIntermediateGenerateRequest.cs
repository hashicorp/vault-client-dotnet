...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PKIWriteIntermediateGenerateRequest")]

    public partial class PKIWriteIntermediateGenerateRequest : IEquatable<PKIWriteIntermediateGenerateRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PKIWriteIntermediateGenerateRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PKIWriteIntermediateGenerateRequest {\n");
        ...
        {
            return this.Equals(input as PKIWriteIntermediateGenerateRequest);
        }

        /// <summary>
        /// Returns true if PKIWriteIntermediateGenerateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PKIWriteIntermediateGenerateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PKIWriteIntermediateGenerateRequest input)
        {
            if (input == null)
            {
                return false;
