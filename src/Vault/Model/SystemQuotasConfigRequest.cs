...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemQuotasConfigRequest")]
    public partial class SystemQuotasConfigRequest : IEquatable<SystemQuotasConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemQuotasConfigRequest" /> class.
        /// </summary>
        ...
        public SystemQuotasConfigRequest(bool enableRateLimitAuditLogging = default(bool), bool enableRateLimitResponseHeaders = default(bool), List<string> rateLimitExemptPaths = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemQuotasConfigRequest {\n");
        ...
        {
            return this.Equals(input as SystemQuotasConfigRequest);
        }

        /// <summary>
        /// Returns true if SystemQuotasConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemQuotasConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemQuotasConfigRequest input)
        {
            if (input == null)
            {
                return false;
