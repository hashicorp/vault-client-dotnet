...
{
    /// <summary>
    /// ApproleRoleBoundCidrListResponse
    /// </summary>
    [DataContract(Name = "ApproleRoleBoundCidrListResponse")]
    public partial class ApproleRoleBoundCidrListResponse : IEquatable<ApproleRoleBoundCidrListResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproleRoleBoundCidrListResponse" /> class.
        /// </summary>
        ...
        public ApproleRoleBoundCidrListResponse(List<string> boundCidrList = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApproleRoleBoundCidrListResponse {\n");
        ...
        {
            return this.Equals(input as ApproleRoleBoundCidrListResponse);
        }

        /// <summary>
        /// Returns true if ApproleRoleBoundCidrListResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproleRoleBoundCidrListResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproleRoleBoundCidrListResponse input)
        {
            if (input == null)
            {
                return false;
