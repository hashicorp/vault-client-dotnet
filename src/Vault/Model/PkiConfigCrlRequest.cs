...
namespace Vault.Model
{
    ...
    public partial class PkiConfigCrlRequest : IEquatable<PkiConfigCrlRequest>, IValidatableObject
    {
        ...
        public PkiConfigCrlRequest(bool autoRebuild = default(bool), string autoRebuildGracePeriod = "12h", string deltaRebuildInterval = "15m", bool disable = default(bool), bool enableDelta = default(bool), string expiry = "72h", bool ocspDisable = default(bool), string ocspExpiry = "1h")
        {
