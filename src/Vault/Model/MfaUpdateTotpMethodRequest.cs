...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MfaUpdateTotpMethodRequest")]
    public partial class MfaUpdateTotpMethodRequest : IEquatable<MfaUpdateTotpMethodRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="MfaUpdateTotpMethodRequest" /> class.
        /// </summary>
        ...
        public MfaUpdateTotpMethodRequest(string Algorithm = "SHA1", int Digits = 6, string Issuer = default(string), int KeySize = 20, int MaxValidationAttempts = default(int), string MethodName = default(string), string Period = "30", int QrSize = 200, int Skew = 1)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfaUpdateTotpMethodRequest {\n");
        ...
        {
            return this.Equals(input as MfaUpdateTotpMethodRequest);
        }

        /// <summary>
        /// Returns true if MfaUpdateTotpMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MfaUpdateTotpMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MfaUpdateTotpMethodRequest input)
        {
            if (input == null)
            {
                return false;
