...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiWriteIssuerRequest")]
    public partial class PkiWriteIssuerRequest : IEquatable<PkiWriteIssuerRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiWriteIssuerRequest" /> class.
        /// </summary>
        ...
        /// <param name="EnableAiaUrlTemplating">Whether or not to enabling templating of the above AIA fields. When templating is enabled the special values &#x27;{{issuer_id}}&#x27;, &#x27;{{cluster_path}}&#x27;, &#x27;{{cluster_aia_path}}&#x27; are available, but the addresses are not checked for URL validity until issuance time. Using &#x27;{{cluster_path}}&#x27; requires /config/cluster&#x27;s &#x27;path&#x27; member to be set on all PR Secondary clusters and using &#x27;{{cluster_aia_path}}&#x27; requires /config/cluster&#x27;s &#x27;aia_path&#x27; member to be set on all PR secondary clusters. (default to false).</param>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiWriteIssuerRequest {\n");
        ...
        {
            return this.Equals(input as PkiWriteIssuerRequest);
        }

        /// <summary>
        /// Returns true if PkiWriteIssuerRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiWriteIssuerRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiWriteIssuerRequest input)
        {
            if (input == null)
            {
                return false;
