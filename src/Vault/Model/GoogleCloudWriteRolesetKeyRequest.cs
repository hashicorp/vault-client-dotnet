...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GoogleCloudWriteRolesetKeyRequest")]
    public partial class GoogleCloudWriteRolesetKeyRequest : IEquatable<GoogleCloudWriteRolesetKeyRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GoogleCloudWriteRolesetKeyRequest" /> class.
        /// </summary>
        ...
        public GoogleCloudWriteRolesetKeyRequest(string keyAlgorithm = "KEY_ALG_RSA_2048", string keyType = "TYPE_GOOGLE_CREDENTIALS_FILE", int ttl = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GoogleCloudWriteRolesetKeyRequest {\n");
        ...
        {
            return this.Equals(input as GoogleCloudWriteRolesetKeyRequest);
        }

        /// <summary>
        /// Returns true if GoogleCloudWriteRolesetKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GoogleCloudWriteRolesetKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoogleCloudWriteRolesetKeyRequest input)
        {
            if (input == null)
            {
                return false;
