...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LdapConfigureAuthRequest")]
    public partial class LdapConfigureAuthRequest : IEquatable<LdapConfigureAuthRequest>, IValidatableObject
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LdapConfigureAuthRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LdapConfigureAuthRequest {\n");
        ...
        {
            return this.Equals(input as LdapConfigureAuthRequest);
        }

        /// <summary>
        /// Returns true if LdapConfigureAuthRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LdapConfigureAuthRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LdapConfigureAuthRequest input)
        {
            if (input == null)
            {
                return false;
