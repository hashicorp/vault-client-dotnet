...
namespace Vault.Model
{
    ...
    /// RawWriteRequest
    /// </summary>
    [DataContract(Name = "RawWriteRequest")]
    public partial class RawWriteRequest : IEquatable<RawWriteRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="RawWriteRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RawWriteRequest {\n");
        ...
        {
            return this.Equals(input as RawWriteRequest);
        }

        /// <summary>
        /// Returns true if RawWriteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RawWriteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RawWriteRequest input)
        {
            if (input == null)
            {
                return false;
