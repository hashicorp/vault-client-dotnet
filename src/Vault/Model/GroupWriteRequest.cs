...
namespace Vault.Model
{
    ...
    public partial class GroupWriteRequest : IEquatable<GroupWriteRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupWriteRequest {\n");
        ...
        {
            return this.Equals(input as GroupWriteRequest);
        }

        /// <summary>
        /// Returns true if GroupWriteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupWriteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupWriteRequest input)
        {
            if (input == null)
            {
                return false;
