...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiGenerateEabKeyForRoleResponse")]
    public partial class PkiGenerateEabKeyForRoleResponse : IEquatable<PkiGenerateEabKeyForRoleResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiGenerateEabKeyForRoleResponse" /> class.
        /// </summary>
        ...
        public PkiGenerateEabKeyForRoleResponse(string AcmeDirectory = default(string), DateTime CreatedOn = default(DateTime), string Id = default(string), string Key = default(string), string KeyType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiGenerateEabKeyForRoleResponse {\n");
        ...
        {
            return this.Equals(input as PkiGenerateEabKeyForRoleResponse);
        }

        /// <summary>
        /// Returns true if PkiGenerateEabKeyForRoleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiGenerateEabKeyForRoleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiGenerateEabKeyForRoleResponse input)
        {
            if (input == null)
            {
                return false;
