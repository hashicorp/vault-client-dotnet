...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiGenerateInternalKeyResponse")]
    public partial class PkiGenerateInternalKeyResponse : IEquatable<PkiGenerateInternalKeyResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiGenerateInternalKeyResponse" /> class.
        /// </summary>
        ...
        public PkiGenerateInternalKeyResponse(string KeyId = default(string), string KeyName = default(string), string KeyType = default(string), string PrivateKey = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiGenerateInternalKeyResponse {\n");
        ...
        {
            return this.Equals(input as PkiGenerateInternalKeyResponse);
        }

        /// <summary>
        /// Returns true if PkiGenerateInternalKeyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiGenerateInternalKeyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiGenerateInternalKeyResponse input)
        {
            if (input == null)
            {
                return false;
