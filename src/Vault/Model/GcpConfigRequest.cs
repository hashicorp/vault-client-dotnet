...
namespace Vault.Model
{
    ...
    /// GcpConfigRequest
    /// </summary>
    [DataContract(Name = "GcpConfigRequest")]
    public partial class GcpConfigRequest : IEquatable<GcpConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GcpConfigRequest" /> class.
        /// </summary>
        ...
        public GcpConfigRequest(string credentials = default(string), Object customEndpoint = default(Object), string gceAlias = "role_id", List<string> gceMetadata = default(List<string>), string googleCertsEndpoint = default(string), string iamAlias = "role_id", List<string> iamMetadata = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GcpConfigRequest {\n");
        ...
        {
            return this.Equals(input as GcpConfigRequest);
        }

        /// <summary>
        /// Returns true if GcpConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GcpConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GcpConfigRequest input)
        {
            if (input == null)
            {
                return false;
