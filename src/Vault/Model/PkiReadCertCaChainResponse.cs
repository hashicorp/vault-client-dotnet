...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadCertCaChainResponse")]
    public partial class PkiReadCertCaChainResponse : IEquatable<PkiReadCertCaChainResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadCertCaChainResponse" /> class.
        /// </summary>
        ...
        public PkiReadCertCaChainResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string RevocationTime = default(string), string RevocationTimeRfc3339 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadCertCaChainResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadCertCaChainResponse);
        }

        /// <summary>
        /// Returns true if PkiReadCertCaChainResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadCertCaChainResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadCertCaChainResponse input)
        {
            if (input == null)
            {
                return false;
