...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PKIRotateRootRequest")]
    public partial class PKIRotateRootRequest : IEquatable<PKIRotateRootRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PKIRotateRootRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PKIRotateRootRequest {\n");
        ...
        {
            return this.Equals(input as PKIRotateRootRequest);
        }

        /// <summary>
        /// Returns true if PKIRotateRootRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PKIRotateRootRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PKIRotateRootRequest input)
        {
            if (input == null)
            {
                return false;
