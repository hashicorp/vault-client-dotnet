...
namespace Vault.Model
{
    ...
    public partial class PersonaIDWriteByIDRequest : IEquatable<PersonaIDWriteByIDRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PersonaIDWriteByIDRequest {\n");
        ...
        {
            return this.Equals(input as PersonaIDWriteByIDRequest);
        }

        /// <summary>
        /// Returns true if PersonaIDWriteByIDRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonaIDWriteByIDRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonaIDWriteByIDRequest input)
        {
            if (input == null)
            {
                return false;
