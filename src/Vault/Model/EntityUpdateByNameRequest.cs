...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EntityUpdateByNameRequest")]
    public partial class EntityUpdateByNameRequest : IEquatable<EntityUpdateByNameRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="EntityUpdateByNameRequest" /> class.
        /// </summary>
        ...
        public EntityUpdateByNameRequest(bool Disabled = default(bool), string Id = default(string), Object Metadata = default(Object), List<string> Policies = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EntityUpdateByNameRequest {\n");
        ...
        {
            return this.Equals(input as EntityUpdateByNameRequest);
        }

        /// <summary>
        /// Returns true if EntityUpdateByNameRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityUpdateByNameRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityUpdateByNameRequest input)
        {
            if (input == null)
            {
                return false;
