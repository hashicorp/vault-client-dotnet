...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MfaConfigureOktaMethodRequest")]
    public partial class MfaConfigureOktaMethodRequest : IEquatable<MfaConfigureOktaMethodRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="MfaConfigureOktaMethodRequest" /> class.
        /// </summary>
        ...
        public MfaConfigureOktaMethodRequest(string ApiToken = default(string), string BaseUrl = default(string), string MethodName = default(string), string OrgName = default(string), bool PrimaryEmail = default(bool), bool Production = default(bool), string UsernameFormat = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfaConfigureOktaMethodRequest {\n");
        ...
        {
            return this.Equals(input as MfaConfigureOktaMethodRequest);
        }

        /// <summary>
        /// Returns true if MfaConfigureOktaMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MfaConfigureOktaMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MfaConfigureOktaMethodRequest input)
        {
            if (input == null)
            {
                return false;
