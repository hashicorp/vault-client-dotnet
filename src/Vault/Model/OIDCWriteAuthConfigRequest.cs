...
namespace Vault.Model
{
    ...
    public partial class OIDCWriteAuthConfigRequest : IEquatable<OIDCWriteAuthConfigRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OIDCWriteAuthConfigRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OIDCWriteAuthConfigRequest {\n");
        ...
        {
            return this.Equals(input as OIDCWriteAuthConfigRequest);
        }

        /// <summary>
        /// Returns true if OIDCWriteAuthConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OIDCWriteAuthConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OIDCWriteAuthConfigRequest input)
        {
            if (input == null)
            {
                return false;
