...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TerraformCloudWriteRoleRequest")]
    public partial class TerraformCloudWriteRoleRequest : IEquatable<TerraformCloudWriteRoleRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="TerraformCloudWriteRoleRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TerraformCloudWriteRoleRequest {\n");
        ...
        {
            return this.Equals(input as TerraformCloudWriteRoleRequest);
        }

        /// <summary>
        /// Returns true if TerraformCloudWriteRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TerraformCloudWriteRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TerraformCloudWriteRoleRequest input)
        {
            if (input == null)
            {
                return false;
