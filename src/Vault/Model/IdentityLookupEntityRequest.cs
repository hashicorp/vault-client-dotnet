...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityLookupEntityRequest")]
    public partial class IdentityLookupEntityRequest : IEquatable<IdentityLookupEntityRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityLookupEntityRequest" /> class.
        /// </summary>
        ...
        public IdentityLookupEntityRequest(string aliasId = default(string), string aliasMountAccessor = default(string), string aliasName = default(string), string id = default(string), string name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityLookupEntityRequest {\n");
        ...
        {
            return this.Equals(input as IdentityLookupEntityRequest);
        }

        /// <summary>
        /// Returns true if IdentityLookupEntityRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityLookupEntityRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityLookupEntityRequest input)
        {
            if (input == null)
            {
                return false;
