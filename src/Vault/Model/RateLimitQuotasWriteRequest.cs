...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RateLimitQuotasWriteRequest")]
    public partial class RateLimitQuotasWriteRequest : IEquatable<RateLimitQuotasWriteRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="RateLimitQuotasWriteRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as RateLimitQuotasWriteRequest);
        }

        /// <summary>
        /// Returns true if RateLimitQuotasWriteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RateLimitQuotasWriteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RateLimitQuotasWriteRequest input)
        {
            if (input == null)
            {
                return false;
