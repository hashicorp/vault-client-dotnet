...
namespace Vault.Model
{
    ...
    /// KvV2PatchResponse
    /// </summary>
    [DataContract(Name = "KvV2PatchResponse")]
    public partial class KvV2PatchResponse : IEquatable<KvV2PatchResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="KvV2PatchResponse" /> class.
        /// </summary>
        ...
        public KvV2PatchResponse(DateTime CreatedTime = default(DateTime), Object CustomMetadata = default(Object), string DeletionTime = default(string), bool Destroyed = default(bool), long _Version = default(long))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KvV2PatchResponse {\n");
        ...
        {
            return this.Equals(input as KvV2PatchResponse);
        }

        /// <summary>
        /// Returns true if KvV2PatchResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of KvV2PatchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KvV2PatchResponse input)
        {
            if (input == null)
            {
                return false;
