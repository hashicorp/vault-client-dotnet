...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadUrlsConfigurationResponse")]
    public partial class PkiReadUrlsConfigurationResponse : IEquatable<PkiReadUrlsConfigurationResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadUrlsConfigurationResponse" /> class.
        /// </summary>
        ...
        /// <param name="EnableTemplating">Whether or not to enable templating of the above AIA fields. When templating is enabled the special values &#x27;{{issuer_id}}&#x27; and &#x27;{{cluster_path}}&#x27; are available, but the addresses are not checked for URI validity until issuance time. This requires /config/cluster&#x27;s path to be set on all PR Secondary clusters..</param>
        ...
        public PkiReadUrlsConfigurationResponse(List<string> CrlDistributionPoints = default(List<string>), bool EnableTemplating = default(bool), List<string> IssuingCertificates = default(List<string>), List<string> OcspServers = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>Whether or not to enable templating of the above AIA fields. When templating is enabled the special values &#x27;{{issuer_id}}&#x27; and &#x27;{{cluster_path}}&#x27; are available, but the addresses are not checked for URI validity until issuance time. This requires /config/cluster&#x27;s path to be set on all PR Secondary clusters.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadUrlsConfigurationResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadUrlsConfigurationResponse);
        }

        /// <summary>
        /// Returns true if PkiReadUrlsConfigurationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadUrlsConfigurationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadUrlsConfigurationResponse input)
        {
            if (input == null)
            {
                return false;
