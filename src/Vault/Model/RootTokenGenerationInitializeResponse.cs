...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RootTokenGenerationInitializeResponse")]
    public partial class RootTokenGenerationInitializeResponse : IEquatable<RootTokenGenerationInitializeResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="RootTokenGenerationInitializeResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RootTokenGenerationInitializeResponse {\n");
        ...
        {
            return this.Equals(input as RootTokenGenerationInitializeResponse);
        }

        /// <summary>
        /// Returns true if RootTokenGenerationInitializeResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RootTokenGenerationInitializeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RootTokenGenerationInitializeResponse input)
        {
            if (input == null)
            {
                return false;
