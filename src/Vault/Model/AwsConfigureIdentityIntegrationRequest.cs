...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsConfigureIdentityIntegrationRequest")]
    public partial class AwsConfigureIdentityIntegrationRequest : IEquatable<AwsConfigureIdentityIntegrationRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AwsConfigureIdentityIntegrationRequest" /> class.
        /// </summary>
        ...
        public AwsConfigureIdentityIntegrationRequest(string Ec2Alias = "instance_id", List<string> Ec2Metadata = default(List<string>), string IamAlias = "unique_id", List<string> IamMetadata = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsConfigureIdentityIntegrationRequest {\n");
        ...
        {
            return this.Equals(input as AwsConfigureIdentityIntegrationRequest);
        }

        /// <summary>
        /// Returns true if AwsConfigureIdentityIntegrationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsConfigureIdentityIntegrationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsConfigureIdentityIntegrationRequest input)
        {
            if (input == null)
            {
                return false;
