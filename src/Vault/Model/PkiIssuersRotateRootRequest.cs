...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiIssuersRotateRootRequest")]
    public partial class PkiIssuersRotateRootRequest : IEquatable<PkiIssuersRotateRootRequest>, IValidatableObject
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiIssuersRotateRootRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiIssuersRotateRootRequest {\n");
        ...
        {
            return this.Equals(input as PkiIssuersRotateRootRequest);
        }

        /// <summary>
        /// Returns true if PkiIssuersRotateRootRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiIssuersRotateRootRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiIssuersRotateRootRequest input)
        {
            if (input == null)
            {
                return false;
