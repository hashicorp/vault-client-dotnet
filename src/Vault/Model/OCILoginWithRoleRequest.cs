...
namespace Vault.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OCILoginWithRoleRequest" /> class.
        /// </summary>
        /// <param name="requestHeaders">The signed headers of the client.</param>
        public OCILoginWithRoleRequest(string requestHeaders = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OCILoginWithRoleRequest {\n");
        ...
        {
            return this.Equals(input as OCILoginWithRoleRequest);
        }

        /// <summary>
        /// Returns true if OCILoginWithRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OCILoginWithRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OCILoginWithRoleRequest input)
        {
            if (input == null)
            {
                return false;
