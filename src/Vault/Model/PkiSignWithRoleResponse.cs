...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiSignWithRoleResponse")]
    public partial class PkiSignWithRoleResponse : IEquatable<PkiSignWithRoleResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiSignWithRoleResponse" /> class.
        /// </summary>
        ...
        public PkiSignWithRoleResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string Expiration = default(string), string IssuingCa = default(string), string PrivateKey = default(string), string PrivateKeyType = default(string), string SerialNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiSignWithRoleResponse {\n");
        ...
        {
            return this.Equals(input as PkiSignWithRoleResponse);
        }

        /// <summary>
        /// Returns true if PkiSignWithRoleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiSignWithRoleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiSignWithRoleResponse input)
        {
            if (input == null)
            {
                return false;
