...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RekeyAttemptInitializeRequest")]
    public partial class RekeyAttemptInitializeRequest : IEquatable<RekeyAttemptInitializeRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="RekeyAttemptInitializeRequest" /> class.
        /// </summary>
        ...
        public RekeyAttemptInitializeRequest(bool Backup = default(bool), List<string> PgpKeys = default(List<string>), bool RequireVerification = default(bool), int SecretShares = default(int), int SecretThreshold = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RekeyAttemptInitializeRequest {\n");
        ...
        {
            return this.Equals(input as RekeyAttemptInitializeRequest);
        }

        /// <summary>
        /// Returns true if RekeyAttemptInitializeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RekeyAttemptInitializeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RekeyAttemptInitializeRequest input)
        {
            if (input == null)
            {
                return false;
