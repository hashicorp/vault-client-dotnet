...
namespace Vault.Model
{
    ...
    public partial class EntityWriteRequest : IEquatable<EntityWriteRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityWriteRequest" /> class.
        /// </summary>
        ...
        public EntityWriteRequest(bool Disabled = default(bool), string Id = default(string), Object Metadata = default(Object), string Name = default(string), List<string> Policies = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EntityWriteRequest {\n");
        ...
        {
            return this.Equals(input as EntityWriteRequest);
        }

        /// <summary>
        /// Returns true if EntityWriteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityWriteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityWriteRequest input)
        {
            if (input == null)
            {
                return false;
