...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsConfigureRootIamCredentialsRequest")]
    public partial class AwsConfigureRootIamCredentialsRequest : IEquatable<AwsConfigureRootIamCredentialsRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AwsConfigureRootIamCredentialsRequest" /> class.
        /// </summary>
        ...
        public AwsConfigureRootIamCredentialsRequest(string AccessKey = default(string), string IamEndpoint = default(string), int MaxRetries = -1, string Region = default(string), string SecretKey = default(string), string StsEndpoint = default(string), string UsernameTemplate = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsConfigureRootIamCredentialsRequest {\n");
        ...
        {
            return this.Equals(input as AwsConfigureRootIamCredentialsRequest);
        }

        /// <summary>
        /// Returns true if AwsConfigureRootIamCredentialsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsConfigureRootIamCredentialsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsConfigureRootIamCredentialsRequest input)
        {
            if (input == null)
            {
                return false;
