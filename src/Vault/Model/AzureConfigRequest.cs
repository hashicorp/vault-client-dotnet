...
namespace Vault.Model
{
    ...
    /// AzureConfigRequest
    /// </summary>
    [DataContract(Name = "AzureConfigRequest")]
    public partial class AzureConfigRequest : IEquatable<AzureConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AzureConfigRequest" /> class.
        /// </summary>
        ...
        public AzureConfigRequest(string clientId = default(string), string clientSecret = default(string), string environment = default(string), string resource = default(string), string tenantId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AzureConfigRequest {\n");
        ...
        {
            return this.Equals(input as AzureConfigRequest);
        }

        /// <summary>
        /// Returns true if AzureConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AzureConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AzureConfigRequest input)
        {
            if (input == null)
            {
                return false;
