...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransitConfigureKeysRequest")]
    public partial class TransitConfigureKeysRequest : IEquatable<TransitConfigureKeysRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="TransitConfigureKeysRequest" /> class.
        /// </summary>

        /// <param name="DisableUpsert">Whether to allow automatic upserting (creation) of keys on the encrypt endpoint..</param>


        public TransitConfigureKeysRequest(bool DisableUpsert = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitConfigureKeysRequest {\n");
        ...
        {
            return this.Equals(input as TransitConfigureKeysRequest);
        }

        /// <summary>
        /// Returns true if TransitConfigureKeysRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitConfigureKeysRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitConfigureKeysRequest input)
        {
            if (input == null)
            {
                return false;
