...
namespace Vault.Model
{
    ...
    /// SystemInitRequest
    /// </summary>
    [DataContract(Name = "SystemInitRequest")]
    public partial class SystemInitRequest : IEquatable<SystemInitRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemInitRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemInitRequest {\n");
        ...
        {
            return this.Equals(input as SystemInitRequest);
        }

        /// <summary>
        /// Returns true if SystemInitRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemInitRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemInitRequest input)
        {
            if (input == null)
            {
                return false;
