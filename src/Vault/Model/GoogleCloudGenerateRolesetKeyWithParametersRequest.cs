...
namespace Vault.Model
{
    ...
    public partial class GoogleCloudGenerateRolesetKeyWithParametersRequest : IEquatable<GoogleCloudGenerateRolesetKeyWithParametersRequest>, IValidatableObject
    {
        ...
        public GoogleCloudGenerateRolesetKeyWithParametersRequest(string KeyAlgorithm = "KEY_ALG_RSA_2048", string KeyType = "TYPE_GOOGLE_CREDENTIALS_FILE", int Ttl = default(int))
        {
