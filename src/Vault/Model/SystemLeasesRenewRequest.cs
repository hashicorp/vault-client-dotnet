...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemLeasesRenewRequest")]
    public partial class SystemLeasesRenewRequest : IEquatable<SystemLeasesRenewRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemLeasesRenewRequest" /> class.
        /// </summary>
        ...
        public SystemLeasesRenewRequest(int increment = default(int), string leaseId = default(string), string urlLeaseId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemLeasesRenewRequest {\n");
        ...
        {
            return this.Equals(input as SystemLeasesRenewRequest);
        }

        /// <summary>
        /// Returns true if SystemLeasesRenewRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemLeasesRenewRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemLeasesRenewRequest input)
        {
            if (input == null)
            {
                return false;
