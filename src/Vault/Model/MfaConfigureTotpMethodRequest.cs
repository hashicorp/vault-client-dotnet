...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MfaConfigureTotpMethodRequest")]
    public partial class MfaConfigureTotpMethodRequest : IEquatable<MfaConfigureTotpMethodRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="MfaConfigureTotpMethodRequest" /> class.
        /// </summary>
        ...
        public MfaConfigureTotpMethodRequest(string Algorithm = "SHA1", int Digits = 6, string Issuer = default(string), int KeySize = 20, int MaxValidationAttempts = default(int), string MethodName = default(string), int Period = 30, int QrSize = 200, int Skew = 1)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfaConfigureTotpMethodRequest {\n");
        ...
        {
            return this.Equals(input as MfaConfigureTotpMethodRequest);
        }

        /// <summary>
        /// Returns true if MfaConfigureTotpMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MfaConfigureTotpMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MfaConfigureTotpMethodRequest input)
        {
            if (input == null)
            {
                return false;
