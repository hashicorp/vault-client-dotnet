...
namespace Vault.Model
{
    ...
    public partial class WriteGenerateRootRequest : IEquatable<WriteGenerateRootRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WriteGenerateRootRequest {\n");
        ...
        {
            return this.Equals(input as WriteGenerateRootRequest);
        }

        /// <summary>
        /// Returns true if WriteGenerateRootRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of WriteGenerateRootRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteGenerateRootRequest input)
        {
            if (input == null)
            {
                return false;
