...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsGenerateStsCredentialsWithParametersRequest")]
    public partial class AwsGenerateStsCredentialsWithParametersRequest : IEquatable<AwsGenerateStsCredentialsWithParametersRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AwsGenerateStsCredentialsWithParametersRequest" /> class.
        /// </summary>
        ...
        public AwsGenerateStsCredentialsWithParametersRequest(string RoleArn = default(string), string RoleSessionName = default(string), string Ttl = "3600")
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsGenerateStsCredentialsWithParametersRequest {\n");
        ...
        {
            return this.Equals(input as AwsGenerateStsCredentialsWithParametersRequest);
        }

        /// <summary>
        /// Returns true if AwsGenerateStsCredentialsWithParametersRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsGenerateStsCredentialsWithParametersRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsGenerateStsCredentialsWithParametersRequest input)
        {
            if (input == null)
            {
                return false;
