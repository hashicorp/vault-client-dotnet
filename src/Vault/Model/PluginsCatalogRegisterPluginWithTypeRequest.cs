...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PluginsCatalogRegisterPluginWithTypeRequest")]
    public partial class PluginsCatalogRegisterPluginWithTypeRequest : IEquatable<PluginsCatalogRegisterPluginWithTypeRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PluginsCatalogRegisterPluginWithTypeRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PluginsCatalogRegisterPluginWithTypeRequest {\n");
        ...
        {
            return this.Equals(input as PluginsCatalogRegisterPluginWithTypeRequest);
        }

        /// <summary>
        /// Returns true if PluginsCatalogRegisterPluginWithTypeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PluginsCatalogRegisterPluginWithTypeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PluginsCatalogRegisterPluginWithTypeRequest input)
        {
            if (input == null)
            {
                return false;
