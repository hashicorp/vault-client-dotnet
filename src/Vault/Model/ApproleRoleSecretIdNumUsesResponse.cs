...
{
    /// <summary>
    /// ApproleRoleSecretIdNumUsesResponse
    /// </summary>
    [DataContract(Name = "ApproleRoleSecretIdNumUsesResponse")]
    public partial class ApproleRoleSecretIdNumUsesResponse : IEquatable<ApproleRoleSecretIdNumUsesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproleRoleSecretIdNumUsesResponse" /> class.
        /// </summary>
        ...
        public ApproleRoleSecretIdNumUsesResponse(int secretIdNumUses = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApproleRoleSecretIdNumUsesResponse {\n");
        ...
        {
            return this.Equals(input as ApproleRoleSecretIdNumUsesResponse);
        }

        /// <summary>
        /// Returns true if ApproleRoleSecretIdNumUsesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproleRoleSecretIdNumUsesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproleRoleSecretIdNumUsesResponse input)
        {
            if (input == null)
            {
                return false;
