...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiConfigureCrlRequest")]
    public partial class PkiConfigureCrlRequest : IEquatable<PkiConfigureCrlRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiConfigureCrlRequest" /> class.
        /// </summary>
        ...
        /// <param name="UnifiedCrl">If set to true enables global replication of revocation entries, also enabling unified versions of OCSP and CRLs if their respective features are enabled. disable for CRLs and ocsp_disable for OCSP. (default to false).</param>

        /// <param name="UnifiedCrlOnExistingPaths">If set to true, existing CRL and OCSP paths will return the unified CRL instead of a response based on cluster-local data (default to false).</param>


        public PkiConfigureCrlRequest(bool AutoRebuild = default(bool), string AutoRebuildGracePeriod = "12h", bool CrossClusterRevocation = default(bool), string DeltaRebuildInterval = "15m", bool Disable = default(bool), bool EnableDelta = default(bool), string Expiry = "72h", bool OcspDisable = default(bool), string OcspExpiry = "1h", bool UnifiedCrl = false, bool UnifiedCrlOnExistingPaths = false)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiConfigureCrlRequest {\n");
        ...
        {
            return this.Equals(input as PkiConfigureCrlRequest);
        }

        /// <summary>
        /// Returns true if PkiConfigureCrlRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiConfigureCrlRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiConfigureCrlRequest input)
        {
            if (input == null)
            {
                return false;
