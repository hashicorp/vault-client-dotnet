...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "JwtOidcRequestAuthorizationUrlRequest")]
    public partial class JwtOidcRequestAuthorizationUrlRequest : IEquatable<JwtOidcRequestAuthorizationUrlRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="JwtOidcRequestAuthorizationUrlRequest" /> class.
        /// </summary>
        ...
        public JwtOidcRequestAuthorizationUrlRequest(string ClientNonce = default(string), string RedirectUri = default(string), string Role = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JwtOidcRequestAuthorizationUrlRequest {\n");
        ...
        {
            return this.Equals(input as JwtOidcRequestAuthorizationUrlRequest);
        }

        /// <summary>
        /// Returns true if JwtOidcRequestAuthorizationUrlRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of JwtOidcRequestAuthorizationUrlRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JwtOidcRequestAuthorizationUrlRequest input)
        {
            if (input == null)
            {
                return false;
