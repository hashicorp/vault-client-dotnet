...
namespace Vault.Model
{
    ...
    public partial class AppRoleWriteRoleRequest : IEquatable<AppRoleWriteRoleRequest>, IValidatableObject
    {
        ...
        public AppRoleWriteRoleRequest(bool BindSecretId = true, List<string> BoundCidrList = default(List<string>), bool LocalSecretIds = default(bool), string Period = default(string), List<string> Policies = default(List<string>), string RoleId = default(string), List<string> SecretIdBoundCidrs = default(List<string>), int SecretIdNumUses = default(int), string SecretIdTtl = default(string), List<string> TokenBoundCidrs = default(List<string>), string TokenExplicitMaxTtl = default(string), string TokenMaxTtl = default(string), bool TokenNoDefaultPolicy = default(bool), int TokenNumUses = default(int), string TokenPeriod = default(string), List<string> TokenPolicies = default(List<string>), string TokenTtl = default(string), string TokenType = "default-service")
        {
        ...
        [Obsolete] public List<string> BoundCidrList { get; set; }
