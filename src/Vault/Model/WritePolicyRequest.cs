...
namespace Vault.Model
{
    ...
    public partial class WritePolicyRequest : IEquatable<WritePolicyRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WritePolicyRequest {\n");
        ...
        {
            return this.Equals(input as WritePolicyRequest);
        }

        /// <summary>
        /// Returns true if WritePolicyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of WritePolicyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WritePolicyRequest input)
        {
            if (input == null)
            {
                return false;
