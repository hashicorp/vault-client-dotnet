...
namespace Vault.Model
{
    ...
    public partial class PkiIssuersImportCertResponse : IEquatable<PkiIssuersImportCertResponse>, IValidatableObject
    {
        ...
        public PkiIssuersImportCertResponse(List<string> ExistingIssuers = default(List<string>), List<string> ExistingKeys = default(List<string>), List<string> ImportedIssuers = default(List<string>), List<string> ImportedKeys = default(List<string>), Object Mapping = default(Object))
        {
