...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiIssueWithRoleRequest")]
    public partial class PkiIssueWithRoleRequest : IEquatable<PkiIssueWithRoleRequest>, IValidatableObject
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiIssueWithRoleRequest" /> class.
        /// </summary>
        ...
        public PkiIssueWithRoleRequest(string AltNames = default(string), string CommonName = default(string), bool ExcludeCnFromSans = false, FormatEnum? Format = FormatEnum.Pem, List<string> IpSans = default(List<string>), string IssuerRef = "default", string NotAfter = default(string), List<string> OtherSans = default(List<string>), PrivateKeyFormatEnum? PrivateKeyFormat = PrivateKeyFormatEnum.Der, bool RemoveRootsFromChain = false, string SerialNumber = default(string), string Ttl = default(string), List<string> UriSans = default(List<string>), List<string> UserIds = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiIssueWithRoleRequest {\n");
        ...
        {
            return this.Equals(input as PkiIssueWithRoleRequest);
        }

        /// <summary>
        /// Returns true if PkiIssueWithRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiIssueWithRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiIssueWithRoleRequest input)
        {
            if (input == null)
            {
                return false;
