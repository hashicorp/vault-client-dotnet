...
namespace Vault.Model
{
    ...
    /// TokenCreateRequest
    /// </summary>
    [DataContract(Name = "TokenCreateRequest")]
    public partial class TokenCreateRequest : IEquatable<TokenCreateRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="TokenCreateRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TokenCreateRequest);
        }

        /// <summary>
        /// Returns true if TokenCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenCreateRequest input)
        {
            if (input == null)
            {
                return false;
