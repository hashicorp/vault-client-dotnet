...
namespace Vault.Model
{
    ...
    /// CertWriteCrlRequest
    /// </summary>
    [DataContract(Name = "CertWriteCrlRequest")]
    public partial class CertWriteCrlRequest : IEquatable<CertWriteCrlRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="CertWriteCrlRequest" /> class.
        /// </summary>
        ...
        public CertWriteCrlRequest(string Crl = default(string), string Url = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CertWriteCrlRequest {\n");
        ...
        {
            return this.Equals(input as CertWriteCrlRequest);
        }

        /// <summary>
        /// Returns true if CertWriteCrlRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CertWriteCrlRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CertWriteCrlRequest input)
        {
            if (input == null)
            {
                return false;
