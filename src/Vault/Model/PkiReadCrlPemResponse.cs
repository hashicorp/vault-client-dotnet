...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadCrlPemResponse")]
    public partial class PkiReadCrlPemResponse : IEquatable<PkiReadCrlPemResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadCrlPemResponse" /> class.
        /// </summary>
        ...
        public PkiReadCrlPemResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string RevocationTime = default(string), string RevocationTimeRfc3339 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadCrlPemResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadCrlPemResponse);
        }

        /// <summary>
        /// Returns true if PkiReadCrlPemResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadCrlPemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadCrlPemResponse input)
        {
            if (input == null)
            {
                return false;
