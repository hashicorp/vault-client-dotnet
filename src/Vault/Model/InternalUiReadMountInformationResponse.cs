...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InternalUiReadMountInformationResponse")]
    public partial class InternalUiReadMountInformationResponse : IEquatable<InternalUiReadMountInformationResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="InternalUiReadMountInformationResponse" /> class.
        /// </summary>
        ...
        public InternalUiReadMountInformationResponse(string Accessor = default(string), Object Config = default(Object), string Description = default(string), bool ExternalEntropyAccess = default(bool), bool Local = default(bool), Object Options = default(Object), string Path = default(string), string PluginVersion = default(string), string RunningPluginVersion = default(string), string RunningSha256 = default(string), bool SealWrap = default(bool), string Type = default(string), string Uuid = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InternalUiReadMountInformationResponse {\n");
        ...
        {
            return this.Equals(input as InternalUiReadMountInformationResponse);
        }

        /// <summary>
        /// Returns true if InternalUiReadMountInformationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of InternalUiReadMountInformationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InternalUiReadMountInformationResponse input)
        {
            if (input == null)
            {
                return false;
