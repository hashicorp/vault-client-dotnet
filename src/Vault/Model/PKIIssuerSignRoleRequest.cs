...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PKIIssuerSignRoleRequest")]
    public partial class PKIIssuerSignRoleRequest : IEquatable<PKIIssuerSignRoleRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PKIIssuerSignRoleRequest" /> class.
        /// </summary>
        ...
        public PKIIssuerSignRoleRequest(string AltNames = default(string), string CommonName = default(string), string Csr = "", bool ExcludeCnFromSans = false, FormatEnum? Format = FormatEnum.Pem, List<string> IpSans = default(List<string>), string NotAfter = default(string), List<string> OtherSans = default(List<string>), PrivateKeyFormatEnum? PrivateKeyFormat = PrivateKeyFormatEnum.Der, bool RemoveRootsFromChain = false, string SerialNumber = default(string), int Ttl = default(int), List<string> UriSans = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PKIIssuerSignRoleRequest {\n");
        ...
        {
            return this.Equals(input as PKIIssuerSignRoleRequest);
        }

        /// <summary>
        /// Returns true if PKIIssuerSignRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PKIIssuerSignRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PKIIssuerSignRoleRequest input)
        {
            if (input == null)
            {
                return false;
