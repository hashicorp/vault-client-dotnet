...
namespace Vault.Model
{
    ...
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ActiveDirectoryWriteConfigRequest" /> class.
        /// </summary>
        ...
        /// <param name="Formatter">Text to insert the password into, ex. \&quot;customPrefix{{PASSWORD}}customSuffix\&quot;..</param>
        ...
        /// <param name="LastRotationTolerance">The number of seconds after a Vault rotation where, if Active Directory shows a later rotation, it should be considered out-of-band. (default to 5).</param>

        /// <param name="Length">The desired length of passwords that Vault generates. (default to 64).</param>

        /// <param name="MaxTtl">In seconds, the maximum password time-to-live..</param>

        /// <param name="PasswordPolicy">Name of the password policy to use to generate passwords..</param>
        ...
        public ActiveDirectoryWriteConfigRequest(bool AnonymousGroupSearch = false, string Binddn = default(string), string Bindpass = default(string), bool CaseSensitiveNames = default(bool), string Certificate = default(string), string ClientTlsCert = default(string), string ClientTlsKey = default(string), bool DenyNullBind = true, bool Discoverdn = default(bool), string Formatter = default(string), string Groupattr = "cn", string Groupdn = default(string), string Groupfilter = "(|(memberUid={{.Username}})(member={{.UserDN}})(uniqueMember={{.UserDN}}))", bool InsecureTls = default(bool), int LastRotationTolerance = 5, int Length = 64, int MaxTtl = default(int), string PasswordPolicy = default(string), int RequestTimeout = default(int), bool Starttls = default(bool), TlsMaxVersionEnum? TlsMaxVersion = TlsMaxVersionEnum.Tls12, TlsMinVersionEnum? TlsMinVersion = TlsMinVersionEnum.Tls12, int Ttl = default(int), string Upndomain = default(string), string Url = "ldap://127.0.0.1", bool UsePre111GroupCnBehavior = default(bool), bool UseTokenGroups = false, string Userattr = "cn", string Userdn = default(string), string Userfilter = "({{.UserAttr}}={{.Username}})", bool UsernameAsAlias = false)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActiveDirectoryWriteConfigRequest {\n");
            ...
            sb.Append("  LastRotationTolerance: ").Append(LastRotationTolerance).Append("\n");
        ...
        {
            return this.Equals(input as ActiveDirectoryWriteConfigRequest);
        }

        /// <summary>
        /// Returns true if ActiveDirectoryWriteConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ActiveDirectoryWriteConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActiveDirectoryWriteConfigRequest input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                ...
                (
                    this.LastRotationTolerance == input.LastRotationTolerance ||

                    this.LastRotationTolerance.Equals(input.LastRotationTolerance)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.LastRotationTolerance.GetHashCode();
