...
namespace Vault.Model
{
    ...
    /// SystemMountsRequest
    /// </summary>
    [DataContract(Name = "SystemMountsRequest")]
    public partial class SystemMountsRequest : IEquatable<SystemMountsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemMountsRequest" /> class.
        /// </summary>
        ...
        public SystemMountsRequest(Object config = default(Object), string description = default(string), bool externalEntropyAccess = false, bool local = false, Object options = default(Object), string pluginName = default(string), string pluginVersion = default(string), bool sealWrap = false, string type = default(string))
        {
            this.Config = config;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemMountsRequest {\n");
        ...
        {
            return this.Equals(input as SystemMountsRequest);
        }

        /// <summary>
        /// Returns true if SystemMountsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemMountsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemMountsRequest input)
        {
            if (input == null)
            {
                return false;
