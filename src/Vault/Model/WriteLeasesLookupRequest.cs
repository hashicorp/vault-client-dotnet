...
namespace Vault.Model
{
    ...
    public partial class WriteLeasesLookupRequest : IEquatable<WriteLeasesLookupRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WriteLeasesLookupRequest" /> class.
        /// </summary>

        /// <param name="LeaseId">The lease identifier to renew. This is included with a lease..</param>


        public WriteLeasesLookupRequest(string LeaseId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WriteLeasesLookupRequest {\n");
        ...
        {
            return this.Equals(input as WriteLeasesLookupRequest);
        }

        /// <summary>
        /// Returns true if WriteLeasesLookupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of WriteLeasesLookupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteLeasesLookupRequest input)
        {
            if (input == null)
            {
                return false;
