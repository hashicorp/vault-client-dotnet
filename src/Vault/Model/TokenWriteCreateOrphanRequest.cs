...
namespace Vault.Model
{
    ...
    public partial class TokenWriteCreateOrphanRequest : IEquatable<TokenWriteCreateOrphanRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenWriteCreateOrphanRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenWriteCreateOrphanRequest {\n");
        ...
        {
            return this.Equals(input as TokenWriteCreateOrphanRequest);
        }

        /// <summary>
        /// Returns true if TokenWriteCreateOrphanRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenWriteCreateOrphanRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenWriteCreateOrphanRequest input)
        {
            if (input == null)
            {
                return false;
