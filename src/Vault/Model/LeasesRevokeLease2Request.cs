...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LeasesRevokeLease2Request")]
    public partial class LeasesRevokeLease2Request : IEquatable<LeasesRevokeLease2Request>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="LeasesRevokeLease2Request" /> class.
        /// </summary>
        ...
        public LeasesRevokeLease2Request(string LeaseId = default(string), bool Sync = true, string UrlLeaseId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LeasesRevokeLease2Request {\n");
        ...
        {
            return this.Equals(input as LeasesRevokeLease2Request);
        }

        /// <summary>
        /// Returns true if LeasesRevokeLease2Request instances are equal
        /// </summary>
        /// <param name="input">Instance of LeasesRevokeLease2Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LeasesRevokeLease2Request input)
        {
            if (input == null)
            {
                return false;
