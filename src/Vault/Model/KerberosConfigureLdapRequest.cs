...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "KerberosConfigureLdapRequest")]
    public partial class KerberosConfigureLdapRequest : IEquatable<KerberosConfigureLdapRequest>, IValidatableObject
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KerberosConfigureLdapRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KerberosConfigureLdapRequest {\n");
        ...
        {
            return this.Equals(input as KerberosConfigureLdapRequest);
        }

        /// <summary>
        /// Returns true if KerberosConfigureLdapRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KerberosConfigureLdapRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KerberosConfigureLdapRequest input)
        {
            if (input == null)
            {
                return false;
