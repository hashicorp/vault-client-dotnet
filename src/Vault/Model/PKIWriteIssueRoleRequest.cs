...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PKIWriteIssueRoleRequest")]
    public partial class PKIWriteIssueRoleRequest : IEquatable<PKIWriteIssueRoleRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PKIWriteIssueRoleRequest" /> class.
        /// </summary>
        ...
        public PKIWriteIssueRoleRequest(string AltNames = default(string), string CommonName = default(string), bool ExcludeCnFromSans = false, FormatEnum? Format = FormatEnum.Pem, List<string> IpSans = default(List<string>), string IssuerRef = "default", string NotAfter = default(string), List<string> OtherSans = default(List<string>), PrivateKeyFormatEnum? PrivateKeyFormat = PrivateKeyFormatEnum.Der, bool RemoveRootsFromChain = false, string SerialNumber = default(string), int Ttl = default(int), List<string> UriSans = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PKIWriteIssueRoleRequest {\n");
        ...
        {
            return this.Equals(input as PKIWriteIssueRoleRequest);
        }

        /// <summary>
        /// Returns true if PKIWriteIssueRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PKIWriteIssueRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PKIWriteIssueRoleRequest input)
        {
            if (input == null)
            {
                return false;
