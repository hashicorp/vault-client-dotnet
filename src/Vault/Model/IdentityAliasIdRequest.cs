...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityAliasIdRequest")]
    public partial class IdentityAliasIdRequest : IEquatable<IdentityAliasIdRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityAliasIdRequest" /> class.
        /// </summary>
        ...
        public IdentityAliasIdRequest(string canonicalId = default(string), string entityId = default(string), string mountAccessor = default(string), string name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityAliasIdRequest {\n");
        ...
        {
            return this.Equals(input as IdentityAliasIdRequest);
        }

        /// <summary>
        /// Returns true if IdentityAliasIdRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityAliasIdRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityAliasIdRequest input)
        {
            if (input == null)
            {
                return false;
