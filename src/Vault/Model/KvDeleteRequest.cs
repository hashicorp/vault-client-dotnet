...
namespace Vault.Model
{
    ...
    /// KvDeleteRequest
    /// </summary>
    [DataContract(Name = "KvDeleteRequest")]
    public partial class KvDeleteRequest : IEquatable<KvDeleteRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KvDeleteRequest" /> class.
        /// </summary>
        ...
        public KvDeleteRequest(List<int> versions = default(List<int>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KvDeleteRequest {\n");
        ...
        {
            return this.Equals(input as KvDeleteRequest);
        }

        /// <summary>
        /// Returns true if KvDeleteRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KvDeleteRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KvDeleteRequest input)
        {
            if (input == null)
            {
                return false;
