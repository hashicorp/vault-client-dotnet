...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadCaDerResponse")]
    public partial class PkiReadCaDerResponse : IEquatable<PkiReadCaDerResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadCaDerResponse" /> class.
        /// </summary>
        ...
        public PkiReadCaDerResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string RevocationTime = default(string), string RevocationTimeRfc3339 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadCaDerResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadCaDerResponse);
        }

        /// <summary>
        /// Returns true if PkiReadCaDerResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadCaDerResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadCaDerResponse input)
        {
            if (input == null)
            {
                return false;
