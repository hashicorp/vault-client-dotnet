...
namespace Vault.Model
{
    ...
    public partial class PkiReadCaDerResponse : IEquatable<PkiReadCaDerResponse>, IValidatableObject
    {
        ...
        public PkiReadCaDerResponse(string CaChain = default(string), string Certificate = default(string), string IssuerId = default(string), long RevocationTime = default(long), string RevocationTimeRfc3339 = default(string))
        {
