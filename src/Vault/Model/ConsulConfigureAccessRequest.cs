...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ConsulConfigureAccessRequest")]
    public partial class ConsulConfigureAccessRequest : IEquatable<ConsulConfigureAccessRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="ConsulConfigureAccessRequest" /> class.
        /// </summary>
        ...
        public ConsulConfigureAccessRequest(string Address = default(string), string CaCert = default(string), string ClientCert = default(string), string ClientKey = default(string), string Scheme = "http", string Token = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConsulConfigureAccessRequest {\n");
        ...
        {
            return this.Equals(input as ConsulConfigureAccessRequest);
        }

        /// <summary>
        /// Returns true if ConsulConfigureAccessRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ConsulConfigureAccessRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConsulConfigureAccessRequest input)
        {
            if (input == null)
            {
                return false;
