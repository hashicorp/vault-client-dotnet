...
namespace Vault.Model
{
    ...
    public partial class ApproleRoleSecretIdRequest : IEquatable<ApproleRoleSecretIdRequest>, IValidatableObject
    {
        ...
        public ApproleRoleSecretIdRequest(List<string> cidrList = default(List<string>), string metadata = default(string), int numUses = default(int), List<string> tokenBoundCidrs = default(List<string>), int ttl = default(int))
        {
