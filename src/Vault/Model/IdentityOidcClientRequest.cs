...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityOidcClientRequest")]
    public partial class IdentityOidcClientRequest : IEquatable<IdentityOidcClientRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityOidcClientRequest" /> class.
        /// </summary>
        ...
        public IdentityOidcClientRequest(int accessTokenTtl = default(int), List<string> assignments = default(List<string>), string clientType = "confidential", int idTokenTtl = default(int), string key = "default", List<string> redirectUris = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityOidcClientRequest {\n");
        ...
        {
            return this.Equals(input as IdentityOidcClientRequest);
        }

        /// <summary>
        /// Returns true if IdentityOidcClientRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityOidcClientRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityOidcClientRequest input)
        {
            if (input == null)
            {
                return false;
