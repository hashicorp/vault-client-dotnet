...
namespace Vault.Model
{
    ...
    public partial class UserpassWriteUserPoliciesRequest : IEquatable<UserpassWriteUserPoliciesRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserpassWriteUserPoliciesRequest {\n");
        ...
        {
            return this.Equals(input as UserpassWriteUserPoliciesRequest);
        }

        /// <summary>
        /// Returns true if UserpassWriteUserPoliciesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UserpassWriteUserPoliciesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserpassWriteUserPoliciesRequest input)
        {
            if (input == null)
            {
                return false;
