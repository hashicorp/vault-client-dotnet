...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiConfigureClusterRequest")]
    public partial class PkiConfigureClusterRequest : IEquatable<PkiConfigureClusterRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiConfigureClusterRequest" /> class.
        /// </summary>
        ...
        public PkiConfigureClusterRequest(string AiaPath = default(string), string Path = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiConfigureClusterRequest {\n");
        ...
        {
            return this.Equals(input as PkiConfigureClusterRequest);
        }

        /// <summary>
        /// Returns true if PkiConfigureClusterRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiConfigureClusterRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiConfigureClusterRequest input)
        {
            if (input == null)
            {
                return false;
