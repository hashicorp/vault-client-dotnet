...
namespace Vault.Model
{
    ...
    public partial class KerberosWriteGroupRequest : IEquatable<KerberosWriteGroupRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KerberosWriteGroupRequest {\n");
        ...
        {
            return this.Equals(input as KerberosWriteGroupRequest);
        }

        /// <summary>
        /// Returns true if KerberosWriteGroupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KerberosWriteGroupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KerberosWriteGroupRequest input)
        {
            if (input == null)
            {
                return false;
