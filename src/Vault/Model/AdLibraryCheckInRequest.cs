...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AdLibraryCheckInRequest")]
    public partial class AdLibraryCheckInRequest : IEquatable<AdLibraryCheckInRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AdLibraryCheckInRequest" /> class.
        /// </summary>
        /// <param name="serviceAccountNames">The username/logon name for the service accounts to check in..</param>
        public AdLibraryCheckInRequest(List<string> serviceAccountNames = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AdLibraryCheckInRequest {\n");
        ...
        {
            return this.Equals(input as AdLibraryCheckInRequest);
        }

        /// <summary>
        /// Returns true if AdLibraryCheckInRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AdLibraryCheckInRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AdLibraryCheckInRequest input)
        {
            if (input == null)
            {
                return false;
