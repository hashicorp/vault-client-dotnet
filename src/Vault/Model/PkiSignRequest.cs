...
namespace Vault.Model
{
    ...
    /// PkiSignRequest
    /// </summary>
    [DataContract(Name = "PkiSignRequest")]
    public partial class PkiSignRequest : IEquatable<PkiSignRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiSignRequest" /> class.
        /// </summary>
        ...
        public PkiSignRequest(string altNames = default(string), string commonName = default(string), string csr = "", bool excludeCnFromSans = false, FormatEnum? format = FormatEnum.Pem, List<string> ipSans = default(List<string>), string issuerRef = "default", string notAfter = default(string), List<string> otherSans = default(List<string>), PrivateKeyFormatEnum? privateKeyFormat = PrivateKeyFormatEnum.Der, bool removeRootsFromChain = false, string serialNumber = default(string), int ttl = default(int), List<string> uriSans = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiSignRequest {\n");
        ...
        {
            return this.Equals(input as PkiSignRequest);
        }

        /// <summary>
        /// Returns true if PkiSignRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiSignRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiSignRequest input)
        {
            if (input == null)
            {
                return false;
