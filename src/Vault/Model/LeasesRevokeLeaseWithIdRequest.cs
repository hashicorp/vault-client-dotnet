...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LeasesRevokeLeaseWithIdRequest")]
    public partial class LeasesRevokeLeaseWithIdRequest : IEquatable<LeasesRevokeLeaseWithIdRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="LeasesRevokeLeaseWithIdRequest" /> class.
        /// </summary>
        ...
        public LeasesRevokeLeaseWithIdRequest(string LeaseId = default(string), bool Sync = true)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LeasesRevokeLeaseWithIdRequest {\n");
        ...
        {
            return this.Equals(input as LeasesRevokeLeaseWithIdRequest);
        }

        /// <summary>
        /// Returns true if LeasesRevokeLeaseWithIdRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LeasesRevokeLeaseWithIdRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LeasesRevokeLeaseWithIdRequest input)
        {
            if (input == null)
            {
                return false;
