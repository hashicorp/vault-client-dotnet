...
namespace Vault.Model
{
    ...
    public partial class GoogleCloudWriteStaticAccountKeyRequest : IEquatable<GoogleCloudWriteStaticAccountKeyRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GoogleCloudWriteStaticAccountKeyRequest {\n");
        ...
        {
            return this.Equals(input as GoogleCloudWriteStaticAccountKeyRequest);
        }

        /// <summary>
        /// Returns true if GoogleCloudWriteStaticAccountKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GoogleCloudWriteStaticAccountKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoogleCloudWriteStaticAccountKeyRequest input)
        {
            if (input == null)
            {
                return false;
