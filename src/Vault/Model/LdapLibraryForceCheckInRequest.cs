...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LdapLibraryForceCheckInRequest")]
    public partial class LdapLibraryForceCheckInRequest : IEquatable<LdapLibraryForceCheckInRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="LdapLibraryForceCheckInRequest" /> class.
        /// </summary>

        /// <param name="ServiceAccountNames">The username/logon name for the service accounts to check in..</param>


        public LdapLibraryForceCheckInRequest(List<string> ServiceAccountNames = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LdapLibraryForceCheckInRequest {\n");
        ...
        {
            return this.Equals(input as LdapLibraryForceCheckInRequest);
        }

        /// <summary>
        /// Returns true if LdapLibraryForceCheckInRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LdapLibraryForceCheckInRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LdapLibraryForceCheckInRequest input)
        {
            if (input == null)
            {
                return false;
