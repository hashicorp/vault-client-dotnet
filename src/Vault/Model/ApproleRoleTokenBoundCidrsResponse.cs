...
{
    /// <summary>
    /// ApproleRoleTokenBoundCidrsResponse
    /// </summary>
    [DataContract(Name = "ApproleRoleTokenBoundCidrsResponse")]
    public partial class ApproleRoleTokenBoundCidrsResponse : IEquatable<ApproleRoleTokenBoundCidrsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproleRoleTokenBoundCidrsResponse" /> class.
        /// </summary>
        ...
        public ApproleRoleTokenBoundCidrsResponse(List<string> tokenBoundCidrs = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApproleRoleTokenBoundCidrsResponse {\n");
        ...
        {
            return this.Equals(input as ApproleRoleTokenBoundCidrsResponse);
        }

        /// <summary>
        /// Returns true if ApproleRoleTokenBoundCidrsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproleRoleTokenBoundCidrsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproleRoleTokenBoundCidrsResponse input)
        {
            if (input == null)
            {
                return false;
