...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiGenerateIntermediateResponse")]
    public partial class PkiGenerateIntermediateResponse : IEquatable<PkiGenerateIntermediateResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiGenerateIntermediateResponse" /> class.
        /// </summary>
        ...
        public PkiGenerateIntermediateResponse(string Csr = default(string), string KeyId = default(string), string PrivateKey = default(string), string PrivateKeyType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiGenerateIntermediateResponse {\n");
        ...
        {
            return this.Equals(input as PkiGenerateIntermediateResponse);
        }

        /// <summary>
        /// Returns true if PkiGenerateIntermediateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiGenerateIntermediateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiGenerateIntermediateResponse input)
        {
            if (input == null)
            {
                return false;
