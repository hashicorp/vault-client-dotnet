...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadCertCrlResponse")]
    public partial class PkiReadCertCrlResponse : IEquatable<PkiReadCertCrlResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadCertCrlResponse" /> class.
        /// </summary>
        ...
        public PkiReadCertCrlResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string RevocationTime = default(string), string RevocationTimeRfc3339 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadCertCrlResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadCertCrlResponse);
        }

        /// <summary>
        /// Returns true if PkiReadCertCrlResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadCertCrlResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadCertCrlResponse input)
        {
            if (input == null)
            {
                return false;
