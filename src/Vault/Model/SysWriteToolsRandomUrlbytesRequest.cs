...
namespace Vault.Model
{
    ...
    public partial class SysWriteToolsRandomUrlbytesRequest : IEquatable<SysWriteToolsRandomUrlbytesRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SysWriteToolsRandomUrlbytesRequest {\n");
        ...
        {
            return this.Equals(input as SysWriteToolsRandomUrlbytesRequest);
        }

        /// <summary>
        /// Returns true if SysWriteToolsRandomUrlbytesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SysWriteToolsRandomUrlbytesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SysWriteToolsRandomUrlbytesRequest input)
        {
            if (input == null)
            {
                return false;
