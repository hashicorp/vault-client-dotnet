...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiIssuerSignVerbatimResponse")]
    public partial class PkiIssuerSignVerbatimResponse : IEquatable<PkiIssuerSignVerbatimResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiIssuerSignVerbatimResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiIssuerSignVerbatimResponse {\n");
        ...
        {
            return this.Equals(input as PkiIssuerSignVerbatimResponse);
        }

        /// <summary>
        /// Returns true if PkiIssuerSignVerbatimResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiIssuerSignVerbatimResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiIssuerSignVerbatimResponse input)
        {
            if (input == null)
            {
                return false;
