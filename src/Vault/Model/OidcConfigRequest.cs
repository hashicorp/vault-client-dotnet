...
namespace Vault.Model
{
    ...
    /// OidcConfigRequest
    /// </summary>
    [DataContract(Name = "OidcConfigRequest")]
    public partial class OidcConfigRequest : IEquatable<OidcConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OidcConfigRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OidcConfigRequest {\n");
        ...
        {
            return this.Equals(input as OidcConfigRequest);
        }

        /// <summary>
        /// Returns true if OidcConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OidcConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OidcConfigRequest input)
        {
            if (input == null)
            {
                return false;
