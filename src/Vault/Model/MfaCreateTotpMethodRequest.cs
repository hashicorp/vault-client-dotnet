...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MfaCreateTotpMethodRequest")]
    public partial class MfaCreateTotpMethodRequest : IEquatable<MfaCreateTotpMethodRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="MfaCreateTotpMethodRequest" /> class.
        /// </summary>
        ...
        public MfaCreateTotpMethodRequest(string Algorithm = "SHA1", int Digits = 6, string Issuer = default(string), int KeySize = 20, int MaxValidationAttempts = default(int), string MethodName = default(string), string Period = "30", int QrSize = 200, int Skew = 1)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfaCreateTotpMethodRequest {\n");
        ...
        {
            return this.Equals(input as MfaCreateTotpMethodRequest);
        }

        /// <summary>
        /// Returns true if MfaCreateTotpMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MfaCreateTotpMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MfaCreateTotpMethodRequest input)
        {
            if (input == null)
            {
                return false;
