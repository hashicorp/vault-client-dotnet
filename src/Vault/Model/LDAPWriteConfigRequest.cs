...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LDAPWriteConfigRequest")]

    public partial class LDAPWriteConfigRequest : IEquatable<LDAPWriteConfigRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LDAPWriteConfigRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LDAPWriteConfigRequest {\n");
        ...
        {
            return this.Equals(input as LDAPWriteConfigRequest);
        }

        /// <summary>
        /// Returns true if LDAPWriteConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LDAPWriteConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LDAPWriteConfigRequest input)
        {
            if (input == null)
            {
                return false;
