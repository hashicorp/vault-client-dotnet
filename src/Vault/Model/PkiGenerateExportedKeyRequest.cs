...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiGenerateExportedKeyRequest")]
    public partial class PkiGenerateExportedKeyRequest : IEquatable<PkiGenerateExportedKeyRequest>, IValidatableObject
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiGenerateExportedKeyRequest" /> class.
        /// </summary>
        ...
        public PkiGenerateExportedKeyRequest(int KeyBits = 0, string KeyName = default(string), KeyTypeEnum? KeyType = KeyTypeEnum.Rsa, string ManagedKeyId = default(string), string ManagedKeyName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiGenerateExportedKeyRequest {\n");
        ...
        {
            return this.Equals(input as PkiGenerateExportedKeyRequest);
        }

        /// <summary>
        /// Returns true if PkiGenerateExportedKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiGenerateExportedKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiGenerateExportedKeyRequest input)
        {
            if (input == null)
            {
                return false;
