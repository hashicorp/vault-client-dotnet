...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiIssuerSignWithRoleRequest")]
    public partial class PkiIssuerSignWithRoleRequest : IEquatable<PkiIssuerSignWithRoleRequest>, IValidatableObject
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiIssuerSignWithRoleRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiIssuerSignWithRoleRequest {\n");
        ...
        {
            return this.Equals(input as PkiIssuerSignWithRoleRequest);
        }

        /// <summary>
        /// Returns true if PkiIssuerSignWithRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiIssuerSignWithRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiIssuerSignWithRoleRequest input)
        {
            if (input == null)
            {
                return false;
