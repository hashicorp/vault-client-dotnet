...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityGroupNameRequest")]
    public partial class IdentityGroupNameRequest : IEquatable<IdentityGroupNameRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityGroupNameRequest" /> class.
        /// </summary>
        ...
        public IdentityGroupNameRequest(string id = default(string), List<string> memberEntityIds = default(List<string>), List<string> memberGroupIds = default(List<string>), Object metadata = default(Object), List<string> policies = default(List<string>), string type = default(string))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityGroupNameRequest {\n");
        ...
        {
            return this.Equals(input as IdentityGroupNameRequest);
        }

        /// <summary>
        /// Returns true if IdentityGroupNameRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityGroupNameRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityGroupNameRequest input)
        {
            if (input == null)
            {
                return false;
