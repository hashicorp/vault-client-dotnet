...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserpassUsersPoliciesRequest")]
    public partial class UserpassUsersPoliciesRequest : IEquatable<UserpassUsersPoliciesRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserpassUsersPoliciesRequest" /> class.
        /// </summary>
        ...
        public UserpassUsersPoliciesRequest(List<string> policies = default(List<string>), List<string> tokenPolicies = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserpassUsersPoliciesRequest {\n");
        ...
        {
            return this.Equals(input as UserpassUsersPoliciesRequest);
        }

        /// <summary>
        /// Returns true if UserpassUsersPoliciesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UserpassUsersPoliciesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserpassUsersPoliciesRequest input)
        {
            if (input == null)
            {
                return false;
