...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiConfigureUrlsRequest")]
    public partial class PkiConfigureUrlsRequest : IEquatable<PkiConfigureUrlsRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiConfigureUrlsRequest" /> class.
        /// </summary>
        ...
        public PkiConfigureUrlsRequest(List<string> CrlDistributionPoints = default(List<string>), bool EnableTemplating = false, List<string> IssuingCertificates = default(List<string>), List<string> OcspServers = default(List<string>))
        {
        ...
        /// </summary>
        /// <value>Whether or not to enabling templating of the above AIA fields. When templating is enabled the special values &#x27;{{issuer_id}}&#x27;, &#x27;{{cluster_path}}&#x27;, and &#x27;{{cluster_aia_path}}&#x27; are available, but the addresses are not checked for URI validity until issuance time. Using &#x27;{{cluster_path}}&#x27; requires /config/cluster&#x27;s &#x27;path&#x27; member to be set on all PR Secondary clusters and using &#x27;{{cluster_aia_path}}&#x27; requires /config/cluster&#x27;s &#x27;aia_path&#x27; member to be set on all PR secondary clusters.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiConfigureUrlsRequest {\n");
        ...
        {
            return this.Equals(input as PkiConfigureUrlsRequest);
        }

        /// <summary>
        /// Returns true if PkiConfigureUrlsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiConfigureUrlsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiConfigureUrlsRequest input)
        {
            if (input == null)
            {
                return false;
