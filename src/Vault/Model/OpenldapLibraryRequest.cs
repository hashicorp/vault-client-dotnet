...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OpenldapLibraryRequest")]
    public partial class OpenldapLibraryRequest : IEquatable<OpenldapLibraryRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenldapLibraryRequest" /> class.
        /// </summary>
        ...
        public OpenldapLibraryRequest(bool disableCheckInEnforcement = false, int maxTtl = 86400, List<string> serviceAccountNames = default(List<string>), int ttl = 86400)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpenldapLibraryRequest {\n");
        ...
        {
            return this.Equals(input as OpenldapLibraryRequest);
        }

        /// <summary>
        /// Returns true if OpenldapLibraryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OpenldapLibraryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpenldapLibraryRequest input)
        {
            if (input == null)
            {
                return false;
