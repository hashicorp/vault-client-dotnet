...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RootTokenGenerationReadProgress2Response")]
    public partial class RootTokenGenerationReadProgress2Response : IEquatable<RootTokenGenerationReadProgress2Response>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="RootTokenGenerationReadProgress2Response" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RootTokenGenerationReadProgress2Response {\n");
        ...
        {
            return this.Equals(input as RootTokenGenerationReadProgress2Response);
        }

        /// <summary>
        /// Returns true if RootTokenGenerationReadProgress2Response instances are equal
        /// </summary>
        /// <param name="input">Instance of RootTokenGenerationReadProgress2Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RootTokenGenerationReadProgress2Response input)
        {
            if (input == null)
            {
                return false;
