...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApproleRoleBoundCidrListRequest")]
    public partial class ApproleRoleBoundCidrListRequest : IEquatable<ApproleRoleBoundCidrListRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproleRoleBoundCidrListRequest" /> class.
        /// </summary>
        ...
        public ApproleRoleBoundCidrListRequest(List<string> boundCidrList = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApproleRoleBoundCidrListRequest {\n");
        ...
        {
            return this.Equals(input as ApproleRoleBoundCidrListRequest);
        }

        /// <summary>
        /// Returns true if ApproleRoleBoundCidrListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproleRoleBoundCidrListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproleRoleBoundCidrListRequest input)
        {
            if (input == null)
            {
                return false;
