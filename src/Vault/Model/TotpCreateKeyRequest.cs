...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TotpCreateKeyRequest")]
    public partial class TotpCreateKeyRequest : IEquatable<TotpCreateKeyRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="TotpCreateKeyRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TotpCreateKeyRequest {\n");
        ...
        {
            return this.Equals(input as TotpCreateKeyRequest);
        }

        /// <summary>
        /// Returns true if TotpCreateKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TotpCreateKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TotpCreateKeyRequest input)
        {
            if (input == null)
            {
                return false;
