...
namespace Vault.Model
{
    ...
    /// SshIssueRequest
    /// </summary>
    [DataContract(Name = "SshIssueRequest")]
    public partial class SshIssueRequest : IEquatable<SshIssueRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SshIssueRequest" /> class.
        /// </summary>
        ...
        public SshIssueRequest(string certType = "user", Object criticalOptions = default(Object), Object extensions = default(Object), int keyBits = 0, string keyId = default(string), string keyType = "rsa", int ttl = default(int), string validPrincipals = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SshIssueRequest {\n");
        ...
        {
            return this.Equals(input as SshIssueRequest);
        }

        /// <summary>
        /// Returns true if SshIssueRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SshIssueRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SshIssueRequest input)
        {
            if (input == null)
            {
                return false;
