...
namespace Vault.Model
{
    ...
    /// SealStatusResponse
    /// </summary>
    [DataContract(Name = "SealStatusResponse")]
    public partial class SealStatusResponse : IEquatable<SealStatusResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="SealStatusResponse" /> class.
        /// </summary>
        ...
        public SealStatusResponse(string BuildDate = default(string), string ClusterId = default(string), string ClusterName = default(string), string HcpLinkResourceID = default(string), string HcpLinkStatus = default(string), bool Initialized = default(bool), bool Migration = default(bool), int N = default(int), string Nonce = default(string), int Progress = default(int), bool RecoverySeal = default(bool), bool Sealed = default(bool), string StorageType = default(string), int T = default(int), string Type = default(string), string _Version = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SealStatusResponse {\n");
        ...
        {
            return this.Equals(input as SealStatusResponse);
        }

        /// <summary>
        /// Returns true if SealStatusResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SealStatusResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SealStatusResponse input)
        {
            if (input == null)
            {
                return false;
