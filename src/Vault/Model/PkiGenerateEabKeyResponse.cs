...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiGenerateEabKeyResponse")]
    public partial class PkiGenerateEabKeyResponse : IEquatable<PkiGenerateEabKeyResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiGenerateEabKeyResponse" /> class.
        /// </summary>
        ...
        public PkiGenerateEabKeyResponse(string AcmeDirectory = default(string), DateTime CreatedOn = default(DateTime), string Id = default(string), string Key = default(string), string KeyType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiGenerateEabKeyResponse {\n");
        ...
        {
            return this.Equals(input as PkiGenerateEabKeyResponse);
        }

        /// <summary>
        /// Returns true if PkiGenerateEabKeyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiGenerateEabKeyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiGenerateEabKeyResponse input)
        {
            if (input == null)
            {
                return false;
