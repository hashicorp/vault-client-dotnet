...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiPatchRoleResponse")]
    public partial class PkiPatchRoleResponse : IEquatable<PkiPatchRoleResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiPatchRoleResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiPatchRoleResponse {\n");
        ...
        {
            return this.Equals(input as PkiPatchRoleResponse);
        }

        /// <summary>
        /// Returns true if PkiPatchRoleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiPatchRoleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiPatchRoleResponse input)
        {
            if (input == null)
            {
                return false;
