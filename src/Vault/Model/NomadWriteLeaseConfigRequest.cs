...
namespace Vault.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NomadWriteLeaseConfigRequest" /> class.
        /// </summary>
        ...
        public NomadWriteLeaseConfigRequest(int maxTtl = default(int), int ttl = default(int))
        {
            this.MaxTtl = maxTtl;
            this.Ttl = ttl;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NomadWriteLeaseConfigRequest {\n");
        ...
        {
            return this.Equals(input as NomadWriteLeaseConfigRequest);
        }

        /// <summary>
        /// Returns true if NomadWriteLeaseConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NomadWriteLeaseConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NomadWriteLeaseConfigRequest input)
        {
            if (input == null)
            {
                return false;
