...
{
    /// <summary>
    /// AwsGenerateCredentials2Request
    /// </summary>
    [DataContract(Name = "AwsGenerateCredentials2Request")]
    public partial class AwsGenerateCredentials2Request : IEquatable<AwsGenerateCredentials2Request>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AwsGenerateCredentials2Request" /> class.
        /// </summary>
        ...
        public AwsGenerateCredentials2Request(string RoleArn = default(string), string RoleSessionName = default(string), int Ttl = 3600)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsGenerateCredentials2Request {\n");
        ...
        {
            return this.Equals(input as AwsGenerateCredentials2Request);
        }

        /// <summary>
        /// Returns true if AwsGenerateCredentials2Request instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsGenerateCredentials2Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsGenerateCredentials2Request input)
        {
            if (input == null)
            {
                return false;
