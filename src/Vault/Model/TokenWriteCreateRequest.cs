...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TokenWriteCreateRequest")]

    public partial class TokenWriteCreateRequest : IEquatable<TokenWriteCreateRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TokenWriteCreateRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TokenWriteCreateRequest {\n");
        ...
        {
            return this.Equals(input as TokenWriteCreateRequest);
        }

        /// <summary>
        /// Returns true if TokenWriteCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TokenWriteCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TokenWriteCreateRequest input)
        {
            if (input == null)
            {
                return false;
