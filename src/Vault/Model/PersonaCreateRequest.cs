...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PersonaCreateRequest")]
    public partial class PersonaCreateRequest : IEquatable<PersonaCreateRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PersonaCreateRequest" /> class.
        /// </summary>
        ...
        public PersonaCreateRequest(string EntityId = default(string), string Id = default(string), Object Metadata = default(Object), string MountAccessor = default(string), string Name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PersonaCreateRequest {\n");
        ...
        {
            return this.Equals(input as PersonaCreateRequest);
        }

        /// <summary>
        /// Returns true if PersonaCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PersonaCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PersonaCreateRequest input)
        {
            if (input == null)
            {
                return false;
