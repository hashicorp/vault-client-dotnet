...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AWSConfigWriteIdentityAccessListRequest")]
    public partial class AWSConfigWriteIdentityAccessListRequest : IEquatable<AWSConfigWriteIdentityAccessListRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AWSConfigWriteIdentityAccessListRequest" /> class.
        /// </summary>
        ...
        public AWSConfigWriteIdentityAccessListRequest(bool disablePeriodicTidy = false, int safetyBuffer = 259200)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AWSConfigWriteIdentityAccessListRequest {\n");
        ...
        {
            return this.Equals(input as AWSConfigWriteIdentityAccessListRequest);
        }

        /// <summary>
        /// Returns true if AWSConfigWriteIdentityAccessListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AWSConfigWriteIdentityAccessListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AWSConfigWriteIdentityAccessListRequest input)
        {
            if (input == null)
            {
                return false;
