...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsConfigTidyRoletagDenylistRequest")]
    public partial class AwsConfigTidyRoletagDenylistRequest : IEquatable<AwsConfigTidyRoletagDenylistRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AwsConfigTidyRoletagDenylistRequest" /> class.
        /// </summary>
        ...
        public AwsConfigTidyRoletagDenylistRequest(bool disablePeriodicTidy = false, int safetyBuffer = 15552000)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsConfigTidyRoletagDenylistRequest {\n");
        ...
        {
            return this.Equals(input as AwsConfigTidyRoletagDenylistRequest);
        }

        /// <summary>
        /// Returns true if AwsConfigTidyRoletagDenylistRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsConfigTidyRoletagDenylistRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsConfigTidyRoletagDenylistRequest input)
        {
            if (input == null)
            {
                return false;
