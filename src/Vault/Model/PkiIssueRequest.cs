...
namespace Vault.Model
{
    ...
    /// PkiIssueRequest
    /// </summary>
    [DataContract(Name = "PkiIssueRequest")]
    public partial class PkiIssueRequest : IEquatable<PkiIssueRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiIssueRequest" /> class.
        /// </summary>
        ...
        public PkiIssueRequest(string altNames = default(string), string commonName = default(string), bool excludeCnFromSans = false, FormatEnum? format = FormatEnum.Pem, List<string> ipSans = default(List<string>), string issuerRef = "default", string notAfter = default(string), List<string> otherSans = default(List<string>), PrivateKeyFormatEnum? privateKeyFormat = PrivateKeyFormatEnum.Der, bool removeRootsFromChain = false, string serialNumber = default(string), int ttl = default(int), List<string> uriSans = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiIssueRequest {\n");
        ...
        {
            return this.Equals(input as PkiIssueRequest);
        }

        /// <summary>
        /// Returns true if PkiIssueRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiIssueRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiIssueRequest input)
        {
            if (input == null)
            {
                return false;
