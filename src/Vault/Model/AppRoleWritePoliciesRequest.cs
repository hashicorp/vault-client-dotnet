...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AppRoleWritePoliciesRequest")]
    public partial class AppRoleWritePoliciesRequest : IEquatable<AppRoleWritePoliciesRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AppRoleWritePoliciesRequest" /> class.
        /// </summary>
        ...
        public AppRoleWritePoliciesRequest(List<string> Policies = default(List<string>), List<string> TokenPolicies = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppRoleWritePoliciesRequest {\n");
        ...
        {
            return this.Equals(input as AppRoleWritePoliciesRequest);
        }

        /// <summary>
        /// Returns true if AppRoleWritePoliciesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AppRoleWritePoliciesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppRoleWritePoliciesRequest input)
        {
            if (input == null)
            {
                return false;
