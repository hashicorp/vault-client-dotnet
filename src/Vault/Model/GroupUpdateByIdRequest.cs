...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupUpdateByIdRequest")]
    public partial class GroupUpdateByIdRequest : IEquatable<GroupUpdateByIdRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="GroupUpdateByIdRequest" /> class.
        /// </summary>
        ...
        public GroupUpdateByIdRequest(List<string> MemberEntityIds = default(List<string>), List<string> MemberGroupIds = default(List<string>), Object Metadata = default(Object), string Name = default(string), List<string> Policies = default(List<string>), string Type = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupUpdateByIdRequest {\n");
        ...
        {
            return this.Equals(input as GroupUpdateByIdRequest);
        }

        /// <summary>
        /// Returns true if GroupUpdateByIdRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupUpdateByIdRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupUpdateByIdRequest input)
        {
            if (input == null)
            {
                return false;
