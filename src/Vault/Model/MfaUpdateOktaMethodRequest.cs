...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MfaUpdateOktaMethodRequest")]
    public partial class MfaUpdateOktaMethodRequest : IEquatable<MfaUpdateOktaMethodRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="MfaUpdateOktaMethodRequest" /> class.
        /// </summary>
        ...
        public MfaUpdateOktaMethodRequest(string ApiToken = default(string), string BaseUrl = default(string), string MethodName = default(string), string OrgName = default(string), bool PrimaryEmail = default(bool), bool Production = default(bool), string UsernameFormat = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfaUpdateOktaMethodRequest {\n");
        ...
        {
            return this.Equals(input as MfaUpdateOktaMethodRequest);
        }

        /// <summary>
        /// Returns true if MfaUpdateOktaMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MfaUpdateOktaMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MfaUpdateOktaMethodRequest input)
        {
            if (input == null)
            {
                return false;
