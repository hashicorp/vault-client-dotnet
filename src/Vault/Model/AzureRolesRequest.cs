...
namespace Vault.Model
{
    ...
    public partial class AzureRolesRequest : IEquatable<AzureRolesRequest>, IValidatableObject
    {
        ...
        public AzureRolesRequest(string applicationObjectId = default(string), string azureGroups = default(string), string azureRoles = default(string), int maxTtl = default(int), bool permanentlyDelete = false, int ttl = default(int))
        {
