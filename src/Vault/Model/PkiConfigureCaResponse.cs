...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiConfigureCaResponse")]
    public partial class PkiConfigureCaResponse : IEquatable<PkiConfigureCaResponse>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as PkiConfigureCaResponse);
        }

        /// <summary>
        /// Returns true if PkiConfigureCaResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiConfigureCaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiConfigureCaResponse input)
        {
            if (input == null)
            {
                return false;
