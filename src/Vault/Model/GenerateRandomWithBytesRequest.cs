...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GenerateRandomWithBytesRequest")]
    public partial class GenerateRandomWithBytesRequest : IEquatable<GenerateRandomWithBytesRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateRandomWithBytesRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GenerateRandomWithBytesRequest);
        }

        /// <summary>
        /// Returns true if GenerateRandomWithBytesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateRandomWithBytesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateRandomWithBytesRequest input)
        {
            if (input == null)
            {
                return false;
