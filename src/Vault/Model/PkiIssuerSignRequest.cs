...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiIssuerSignRequest")]
    public partial class PkiIssuerSignRequest : IEquatable<PkiIssuerSignRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiIssuerSignRequest" /> class.
        /// </summary>
        ...
        public PkiIssuerSignRequest(string altNames = default(string), string commonName = default(string), string csr = "", bool excludeCnFromSans = false, FormatEnum? format = FormatEnum.Pem, List<string> ipSans = default(List<string>), string notAfter = default(string), List<string> otherSans = default(List<string>), PrivateKeyFormatEnum? privateKeyFormat = PrivateKeyFormatEnum.Der, bool removeRootsFromChain = false, string serialNumber = default(string), int ttl = default(int), List<string> uriSans = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiIssuerSignRequest {\n");
        ...
        {
            return this.Equals(input as PkiIssuerSignRequest);
        }

        /// <summary>
        /// Returns true if PkiIssuerSignRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiIssuerSignRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiIssuerSignRequest input)
        {
            if (input == null)
            {
                return false;
