...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiRotateRootResponse")]
    public partial class PkiRotateRootResponse : IEquatable<PkiRotateRootResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiRotateRootResponse" /> class.
        /// </summary>
        ...
        public PkiRotateRootResponse(string Certificate = default(string), long Expiration = default(long), string IssuerId = default(string), string IssuerName = default(string), string IssuingCa = default(string), string KeyId = default(string), string KeyName = default(string), string PrivateKey = default(string), string SerialNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiRotateRootResponse {\n");
        ...
        {
            return this.Equals(input as PkiRotateRootResponse);
        }

        /// <summary>
        /// Returns true if PkiRotateRootResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiRotateRootResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiRotateRootResponse input)
        {
            if (input == null)
            {
                return false;
