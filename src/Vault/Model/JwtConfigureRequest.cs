...
namespace Vault.Model
{
    ...
    /// JwtConfigureRequest
    /// </summary>
    [DataContract(Name = "JwtConfigureRequest")]
    public partial class JwtConfigureRequest : IEquatable<JwtConfigureRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="JwtConfigureRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JwtConfigureRequest {\n");
        ...
        {
            return this.Equals(input as JwtConfigureRequest);
        }

        /// <summary>
        /// Returns true if JwtConfigureRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of JwtConfigureRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JwtConfigureRequest input)
        {
            if (input == null)
            {
                return false;
