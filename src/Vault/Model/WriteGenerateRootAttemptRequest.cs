...
namespace Vault.Model
{
    ...
    public partial class WriteGenerateRootAttemptRequest : IEquatable<WriteGenerateRootAttemptRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WriteGenerateRootAttemptRequest" /> class.
        /// </summary>

        /// <param name="PgpKey">Specifies a base64-encoded PGP public key..</param>


        public WriteGenerateRootAttemptRequest(string PgpKey = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WriteGenerateRootAttemptRequest {\n");
        ...
        {
            return this.Equals(input as WriteGenerateRootAttemptRequest);
        }

        /// <summary>
        /// Returns true if WriteGenerateRootAttemptRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of WriteGenerateRootAttemptRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteGenerateRootAttemptRequest input)
        {
            if (input == null)
            {
                return false;
