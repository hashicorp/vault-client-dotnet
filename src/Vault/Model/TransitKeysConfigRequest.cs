...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransitKeysConfigRequest")]
    public partial class TransitKeysConfigRequest : IEquatable<TransitKeysConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransitKeysConfigRequest" /> class.
        /// </summary>
        ...
        public TransitKeysConfigRequest(bool allowPlaintextBackup = default(bool), int autoRotatePeriod = default(int), bool deletionAllowed = default(bool), bool exportable = default(bool), int minDecryptionVersion = default(int), int minEncryptionVersion = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitKeysConfigRequest {\n");
        ...
        {
            return this.Equals(input as TransitKeysConfigRequest);
        }

        /// <summary>
        /// Returns true if TransitKeysConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitKeysConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitKeysConfigRequest input)
        {
            if (input == null)
            {
                return false;
