...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityMfaMethodDuoRequest")]
    public partial class IdentityMfaMethodDuoRequest : IEquatable<IdentityMfaMethodDuoRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityMfaMethodDuoRequest" /> class.
        /// </summary>
        ...
        public IdentityMfaMethodDuoRequest(string apiHostname = default(string), string integrationKey = default(string), string methodId = default(string), string pushInfo = default(string), string secretKey = default(string), bool usePasscode = default(bool), string usernameFormat = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityMfaMethodDuoRequest {\n");
        ...
        {
            return this.Equals(input as IdentityMfaMethodDuoRequest);
        }

        /// <summary>
        /// Returns true if IdentityMfaMethodDuoRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityMfaMethodDuoRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityMfaMethodDuoRequest input)
        {
            if (input == null)
            {
                return false;
