...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiSetSignedIntermediateResponse")]
    public partial class PkiSetSignedIntermediateResponse : IEquatable<PkiSetSignedIntermediateResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiSetSignedIntermediateResponse" /> class.
        /// </summary>
        ...
        public PkiSetSignedIntermediateResponse(List<string> ExistingIssuers = default(List<string>), List<string> ExistingKeys = default(List<string>), List<string> ImportedIssuers = default(List<string>), List<string> ImportedKeys = default(List<string>), Object Mapping = default(Object))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiSetSignedIntermediateResponse {\n");
        ...
        {
            return this.Equals(input as PkiSetSignedIntermediateResponse);
        }

        /// <summary>
        /// Returns true if PkiSetSignedIntermediateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiSetSignedIntermediateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiSetSignedIntermediateResponse input)
        {
            if (input == null)
            {
                return false;
