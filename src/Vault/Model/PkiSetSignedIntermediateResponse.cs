...
namespace Vault.Model
{
    ...
    public partial class PkiSetSignedIntermediateResponse : IEquatable<PkiSetSignedIntermediateResponse>, IValidatableObject
    {
        ...
        public PkiSetSignedIntermediateResponse(List<string> ImportedIssuers = default(List<string>), List<string> ImportedKeys = default(List<string>), Object Mapping = default(Object))
        {
