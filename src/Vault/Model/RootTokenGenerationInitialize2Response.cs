...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RootTokenGenerationInitialize2Response")]
    public partial class RootTokenGenerationInitialize2Response : IEquatable<RootTokenGenerationInitialize2Response>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="RootTokenGenerationInitialize2Response" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RootTokenGenerationInitialize2Response {\n");
        ...
        {
            return this.Equals(input as RootTokenGenerationInitialize2Response);
        }

        /// <summary>
        /// Returns true if RootTokenGenerationInitialize2Response instances are equal
        /// </summary>
        /// <param name="input">Instance of RootTokenGenerationInitialize2Response to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RootTokenGenerationInitialize2Response input)
        {
            if (input == null)
            {
                return false;
