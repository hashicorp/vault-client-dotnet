...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiIssuerSignVerbatimWithRoleResponse")]
    public partial class PkiIssuerSignVerbatimWithRoleResponse : IEquatable<PkiIssuerSignVerbatimWithRoleResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiIssuerSignVerbatimWithRoleResponse" /> class.
        /// </summary>
        ...
        public PkiIssuerSignVerbatimWithRoleResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string Expiration = default(string), string IssuingCa = default(string), string PrivateKey = default(string), string PrivateKeyType = default(string), string SerialNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiIssuerSignVerbatimWithRoleResponse {\n");
        ...
        {
            return this.Equals(input as PkiIssuerSignVerbatimWithRoleResponse);
        }

        /// <summary>
        /// Returns true if PkiIssuerSignVerbatimWithRoleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiIssuerSignVerbatimWithRoleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiIssuerSignVerbatimWithRoleResponse input)
        {
            if (input == null)
            {
                return false;
