...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AppRoleLookUpSecretIdResponse")]
    public partial class AppRoleLookUpSecretIdResponse : IEquatable<AppRoleLookUpSecretIdResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AppRoleLookUpSecretIdResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppRoleLookUpSecretIdResponse {\n");
        ...
        {
            return this.Equals(input as AppRoleLookUpSecretIdResponse);
        }

        /// <summary>
        /// Returns true if AppRoleLookUpSecretIdResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AppRoleLookUpSecretIdResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppRoleLookUpSecretIdResponse input)
        {
            if (input == null)
            {
                return false;
