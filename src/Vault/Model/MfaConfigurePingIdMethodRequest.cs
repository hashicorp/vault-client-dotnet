...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MfaConfigurePingIdMethodRequest")]
    public partial class MfaConfigurePingIdMethodRequest : IEquatable<MfaConfigurePingIdMethodRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="MfaConfigurePingIdMethodRequest" /> class.
        /// </summary>
        ...
        public MfaConfigurePingIdMethodRequest(string MethodName = default(string), string SettingsFileBase64 = default(string), string UsernameFormat = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfaConfigurePingIdMethodRequest {\n");
        ...
        {
            return this.Equals(input as MfaConfigurePingIdMethodRequest);
        }

        /// <summary>
        /// Returns true if MfaConfigurePingIdMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MfaConfigurePingIdMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MfaConfigurePingIdMethodRequest input)
        {
            if (input == null)
            {
                return false;
