...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransitGenerateRandomWithSourceRequest")]
    public partial class TransitGenerateRandomWithSourceRequest : IEquatable<TransitGenerateRandomWithSourceRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="TransitGenerateRandomWithSourceRequest" /> class.
        /// </summary>
        ...
        public TransitGenerateRandomWithSourceRequest(int Bytes = 32, string Format = "base64", string Urlbytes = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitGenerateRandomWithSourceRequest {\n");
        ...
        {
            return this.Equals(input as TransitGenerateRandomWithSourceRequest);
        }

        /// <summary>
        /// Returns true if TransitGenerateRandomWithSourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitGenerateRandomWithSourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitGenerateRandomWithSourceRequest input)
        {
            if (input == null)
            {
                return false;
