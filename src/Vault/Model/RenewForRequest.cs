...
namespace Vault.Model
{
    ...
    public partial class RenewForRequest : IEquatable<RenewForRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RenewForRequest" /> class.
        /// </summary>
        ...
        public RenewForRequest(int Increment = default(int), string LeaseId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RenewForRequest {\n");
        ...
        {
            return this.Equals(input as RenewForRequest);
        }

        /// <summary>
        /// Returns true if RenewForRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RenewForRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RenewForRequest input)
        {
            if (input == null)
            {
                return false;
