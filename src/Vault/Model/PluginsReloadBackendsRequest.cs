...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PluginsReloadBackendsRequest")]
    public partial class PluginsReloadBackendsRequest : IEquatable<PluginsReloadBackendsRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PluginsReloadBackendsRequest" /> class.
        /// </summary>
        ...
        public PluginsReloadBackendsRequest(List<string> Mounts = default(List<string>), string Plugin = default(string), string Scope = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PluginsReloadBackendsRequest {\n");
        ...
        {
            return this.Equals(input as PluginsReloadBackendsRequest);
        }

        /// <summary>
        /// Returns true if PluginsReloadBackendsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PluginsReloadBackendsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PluginsReloadBackendsRequest input)
        {
            if (input == null)
            {
                return false;
