...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemInternalCountersConfigRequest")]
    public partial class SystemInternalCountersConfigRequest : IEquatable<SystemInternalCountersConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemInternalCountersConfigRequest" /> class.
        /// </summary>
        ...
        public SystemInternalCountersConfigRequest(int defaultReportMonths = 12, string enabled = "default", int retentionMonths = 24)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemInternalCountersConfigRequest {\n");
        ...
        {
            return this.Equals(input as SystemInternalCountersConfigRequest);
        }

        /// <summary>
        /// Returns true if SystemInternalCountersConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemInternalCountersConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemInternalCountersConfigRequest input)
        {
            if (input == null)
            {
                return false;
