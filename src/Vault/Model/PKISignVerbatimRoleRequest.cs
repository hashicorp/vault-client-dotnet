...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PKISignVerbatimRoleRequest")]

    public partial class PKISignVerbatimRoleRequest : IEquatable<PKISignVerbatimRoleRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PKISignVerbatimRoleRequest" /> class.
        /// </summary>
        ...
        public PKISignVerbatimRoleRequest(string AltNames = default(string), string CommonName = default(string), string Csr = "", bool ExcludeCnFromSans = false, List<string> ExtKeyUsage = default(List<string>), List<string> ExtKeyUsageOids = default(List<string>), FormatEnum? Format = FormatEnum.Pem, List<string> IpSans = default(List<string>), string IssuerRef = "default", List<string> KeyUsage = default(List<string>), string NotAfter = default(string), List<string> OtherSans = default(List<string>), PrivateKeyFormatEnum? PrivateKeyFormat = PrivateKeyFormatEnum.Der, bool RemoveRootsFromChain = false, string SerialNumber = default(string), int SignatureBits = 0, int Ttl = default(int), List<string> UriSans = default(List<string>), bool UsePss = false)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PKISignVerbatimRoleRequest {\n");
        ...
        {
            return this.Equals(input as PKISignVerbatimRoleRequest);
        }

        /// <summary>
        /// Returns true if PKISignVerbatimRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PKISignVerbatimRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PKISignVerbatimRoleRequest input)
        {
            if (input == null)
            {
                return false;
