...
namespace Vault.Model
{
    ...
    public partial class EntityWriteAliasByIDRequest : IEquatable<EntityWriteAliasByIDRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityWriteAliasByIDRequest" /> class.
        /// </summary>
        ...
        public EntityWriteAliasByIDRequest(string CanonicalId = default(string), Object CustomMetadata = default(Object), string EntityId = default(string), string MountAccessor = default(string), string Name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EntityWriteAliasByIDRequest {\n");
        ...
        {
            return this.Equals(input as EntityWriteAliasByIDRequest);
        }

        /// <summary>
        /// Returns true if EntityWriteAliasByIDRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityWriteAliasByIDRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityWriteAliasByIDRequest input)
        {
            if (input == null)
            {
                return false;
