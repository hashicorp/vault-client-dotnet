...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "QueryTokenAccessorCapabilitiesRequest")]
    public partial class QueryTokenAccessorCapabilitiesRequest : IEquatable<QueryTokenAccessorCapabilitiesRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="QueryTokenAccessorCapabilitiesRequest" /> class.
        /// </summary>
        ...
        public QueryTokenAccessorCapabilitiesRequest(string Accessor = default(string), List<string> Path = default(List<string>), List<string> Paths = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QueryTokenAccessorCapabilitiesRequest {\n");
        ...
        {
            return this.Equals(input as QueryTokenAccessorCapabilitiesRequest);
        }

        /// <summary>
        /// Returns true if QueryTokenAccessorCapabilitiesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of QueryTokenAccessorCapabilitiesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QueryTokenAccessorCapabilitiesRequest input)
        {
            if (input == null)
            {
                return false;
