...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EncryptionKeyConfigureRotationRequest")]
    public partial class EncryptionKeyConfigureRotationRequest : IEquatable<EncryptionKeyConfigureRotationRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="EncryptionKeyConfigureRotationRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EncryptionKeyConfigureRotationRequest {\n");
        ...
        {
            return this.Equals(input as EncryptionKeyConfigureRotationRequest);
        }

        /// <summary>
        /// Returns true if EncryptionKeyConfigureRotationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EncryptionKeyConfigureRotationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EncryptionKeyConfigureRotationRequest input)
        {
            if (input == null)
            {
                return false;
