...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReplaceRootResponse")]
    public partial class PkiReplaceRootResponse : IEquatable<PkiReplaceRootResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReplaceRootResponse" /> class.
        /// </summary>
        ...
        public PkiReplaceRootResponse(string Default = default(string), bool DefaultFollowsLatestIssuer = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReplaceRootResponse {\n");
        ...
        {
            return this.Equals(input as PkiReplaceRootResponse);
        }

        /// <summary>
        /// Returns true if PkiReplaceRootResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReplaceRootResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReplaceRootResponse input)
        {
            if (input == null)
            {
                return false;
