...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AliasUpdateByIdRequest")]
    public partial class AliasUpdateByIdRequest : IEquatable<AliasUpdateByIdRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AliasUpdateByIdRequest" /> class.
        /// </summary>
        ...
        public AliasUpdateByIdRequest(string CanonicalId = default(string), string EntityId = default(string), string MountAccessor = default(string), string Name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AliasUpdateByIdRequest {\n");
        ...
        {
            return this.Equals(input as AliasUpdateByIdRequest);
        }

        /// <summary>
        /// Returns true if AliasUpdateByIdRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AliasUpdateByIdRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AliasUpdateByIdRequest input)
        {
            if (input == null)
            {
                return false;
