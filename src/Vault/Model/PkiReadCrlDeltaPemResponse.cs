...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadCrlDeltaPemResponse")]
    public partial class PkiReadCrlDeltaPemResponse : IEquatable<PkiReadCrlDeltaPemResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadCrlDeltaPemResponse" /> class.
        /// </summary>
        ...
        public PkiReadCrlDeltaPemResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string RevocationTime = default(string), string RevocationTimeRfc3339 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadCrlDeltaPemResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadCrlDeltaPemResponse);
        }

        /// <summary>
        /// Returns true if PkiReadCrlDeltaPemResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadCrlDeltaPemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadCrlDeltaPemResponse input)
        {
            if (input == null)
            {
                return false;
