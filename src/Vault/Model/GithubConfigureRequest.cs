...
namespace Vault.Model
{
    ...
    public partial class GithubConfigureRequest : IEquatable<GithubConfigureRequest>, IValidatableObject
    {
        ...
        public GithubConfigureRequest(string BaseUrl = default(string), string MaxTtl = default(string), string Organization = default(string), long OrganizationId = default(long), List<string> TokenBoundCidrs = default(List<string>), string TokenExplicitMaxTtl = default(string), string TokenMaxTtl = default(string), bool TokenNoDefaultPolicy = default(bool), int TokenNumUses = default(int), string TokenPeriod = default(string), List<string> TokenPolicies = default(List<string>), string TokenTtl = default(string), string TokenType = "default-service", string Ttl = default(string))
        {
