...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LDAPWriteLibraryRequest")]
    public partial class LDAPWriteLibraryRequest : IEquatable<LDAPWriteLibraryRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="LDAPWriteLibraryRequest" /> class.
        /// </summary>
        ...
        public LDAPWriteLibraryRequest(bool DisableCheckInEnforcement = false, int MaxTtl = 86400, List<string> ServiceAccountNames = default(List<string>), int Ttl = 86400)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LDAPWriteLibraryRequest {\n");
        ...
        {
            return this.Equals(input as LDAPWriteLibraryRequest);
        }

        /// <summary>
        /// Returns true if LDAPWriteLibraryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LDAPWriteLibraryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LDAPWriteLibraryRequest input)
        {
            if (input == null)
            {
                return false;
