...
namespace Vault.Model
{
    ...
    /// AliasCreateRequest
    /// </summary>
    [DataContract(Name = "AliasCreateRequest")]
    public partial class AliasCreateRequest : IEquatable<AliasCreateRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AliasCreateRequest" /> class.
        /// </summary>
        ...
        public AliasCreateRequest(string CanonicalId = default(string), string EntityId = default(string), string Id = default(string), string MountAccessor = default(string), string Name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AliasCreateRequest {\n");
        ...
        {
            return this.Equals(input as AliasCreateRequest);
        }

        /// <summary>
        /// Returns true if AliasCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AliasCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AliasCreateRequest input)
        {
            if (input == null)
            {
                return false;
