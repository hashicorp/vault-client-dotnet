...
namespace Vault.Model
{
    ...
    /// GroupCreateRequest
    /// </summary>
    [DataContract(Name = "GroupCreateRequest")]
    public partial class GroupCreateRequest : IEquatable<GroupCreateRequest>, IValidatableObject
    {
        ...
        public GroupCreateRequest(string Id = default(string), List<string> MemberEntityIds = default(List<string>), List<string> MemberGroupIds = default(List<string>), Object Metadata = default(Object), string Name = default(string), List<string> Policies = default(List<string>), string Type = default(string))
        {
        ...
        {
            return this.Equals(input as GroupCreateRequest);
        }

        /// <summary>
        /// Returns true if GroupCreateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupCreateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupCreateRequest input)
        {
            if (input == null)
            {
                return false;
