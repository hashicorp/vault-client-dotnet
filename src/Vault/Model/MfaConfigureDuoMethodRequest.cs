...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MfaConfigureDuoMethodRequest")]
    public partial class MfaConfigureDuoMethodRequest : IEquatable<MfaConfigureDuoMethodRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="MfaConfigureDuoMethodRequest" /> class.
        /// </summary>
        ...
        public MfaConfigureDuoMethodRequest(string ApiHostname = default(string), string IntegrationKey = default(string), string MethodName = default(string), string PushInfo = default(string), string SecretKey = default(string), bool UsePasscode = default(bool), string UsernameFormat = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfaConfigureDuoMethodRequest {\n");
        ...
        {
            return this.Equals(input as MfaConfigureDuoMethodRequest);
        }

        /// <summary>
        /// Returns true if MfaConfigureDuoMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MfaConfigureDuoMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MfaConfigureDuoMethodRequest input)
        {
            if (input == null)
            {
                return false;
