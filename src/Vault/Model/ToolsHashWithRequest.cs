...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ToolsHashWithRequest")]
    public partial class ToolsHashWithRequest : IEquatable<ToolsHashWithRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolsHashWithRequest" /> class.
        /// </summary>
        ...
        public ToolsHashWithRequest(string Algorithm = "sha2-256", string Format = "hex", string Input = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ToolsHashWithRequest {\n");
        ...
        {
            return this.Equals(input as ToolsHashWithRequest);
        }

        /// <summary>
        /// Returns true if ToolsHashWithRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ToolsHashWithRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ToolsHashWithRequest input)
        {
            if (input == null)
            {
                return false;
