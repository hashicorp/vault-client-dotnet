...
namespace Vault.Model
{
    ...
    public partial class OIDCWriteProviderAuthorizeRequest : IEquatable<OIDCWriteProviderAuthorizeRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OIDCWriteProviderAuthorizeRequest {\n");
        ...
        {
            return this.Equals(input as OIDCWriteProviderAuthorizeRequest);
        }

        /// <summary>
        /// Returns true if OIDCWriteProviderAuthorizeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OIDCWriteProviderAuthorizeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OIDCWriteProviderAuthorizeRequest input)
        {
            if (input == null)
            {
                return false;
