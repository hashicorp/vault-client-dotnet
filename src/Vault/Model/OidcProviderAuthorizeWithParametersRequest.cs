...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OidcProviderAuthorizeWithParametersRequest")]
    public partial class OidcProviderAuthorizeWithParametersRequest : IEquatable<OidcProviderAuthorizeWithParametersRequest>, IValidatableObject
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="OidcProviderAuthorizeWithParametersRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected OidcProviderAuthorizeWithParametersRequest() { }
        ...
        public OidcProviderAuthorizeWithParametersRequest(string ClientId = default(string), string CodeChallenge = default(string), string CodeChallengeMethod = "plain", int MaxAge = default(int), string Nonce = default(string), string RedirectUri = default(string), string ResponseType = default(string), string Scope = default(string), string State = default(string))
        {
            ...
            if (RedirectUri == null)
            {
                throw new ArgumentNullException("RedirectUri is a required property for OidcProviderAuthorizeWithParametersRequest and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("ResponseType is a required property for OidcProviderAuthorizeWithParametersRequest and cannot be null");
            }
            ...
            if (Scope == null)
            {
                throw new ArgumentNullException("Scope is a required property for OidcProviderAuthorizeWithParametersRequest and cannot be null");
            }
            this.Scope = Scope;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OidcProviderAuthorizeWithParametersRequest {\n");
        ...
        {
            return this.Equals(input as OidcProviderAuthorizeWithParametersRequest);
        }

        /// <summary>
        /// Returns true if OidcProviderAuthorizeWithParametersRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OidcProviderAuthorizeWithParametersRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OidcProviderAuthorizeWithParametersRequest input)
        {
            if (input == null)
            {
                return false;
