...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityPersonaRequest")]
    public partial class IdentityPersonaRequest : IEquatable<IdentityPersonaRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityPersonaRequest" /> class.
        /// </summary>
        ...
        public IdentityPersonaRequest(string entityId = default(string), string id = default(string), Object metadata = default(Object), string mountAccessor = default(string), string name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityPersonaRequest {\n");
        ...
        {
            return this.Equals(input as IdentityPersonaRequest);
        }

        /// <summary>
        /// Returns true if IdentityPersonaRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityPersonaRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityPersonaRequest input)
        {
            if (input == null)
            {
                return false;
