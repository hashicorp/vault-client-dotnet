...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadIssuerResponse")]
    public partial class PkiReadIssuerResponse : IEquatable<PkiReadIssuerResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadIssuerResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadIssuerResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadIssuerResponse);
        }

        /// <summary>
        /// Returns true if PkiReadIssuerResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadIssuerResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadIssuerResponse input)
        {
            if (input == null)
            {
                return false;
