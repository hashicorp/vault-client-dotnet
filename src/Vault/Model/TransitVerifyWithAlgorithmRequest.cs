...
namespace Vault.Model
{
    ...
    public partial class TransitVerifyWithAlgorithmRequest : IEquatable<TransitVerifyWithAlgorithmRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransitVerifyWithAlgorithmRequest" /> class.
        /// </summary>
        ...
        public TransitVerifyWithAlgorithmRequest(string Algorithm = "sha2-256", List<Object> BatchInput = default(List<Object>), string Context = default(string), string HashAlgorithm = "sha2-256", string Hmac = default(string), string Input = default(string), string MarshalingAlgorithm = "asn1", bool Prehashed = default(bool), string SaltLength = "auto", string Signature = default(string), string SignatureAlgorithm = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitVerifyWithAlgorithmRequest {\n");
        ...
        {
            return this.Equals(input as TransitVerifyWithAlgorithmRequest);
        }

        /// <summary>
        /// Returns true if TransitVerifyWithAlgorithmRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitVerifyWithAlgorithmRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitVerifyWithAlgorithmRequest input)
        {
            if (input == null)
            {
                return false;
