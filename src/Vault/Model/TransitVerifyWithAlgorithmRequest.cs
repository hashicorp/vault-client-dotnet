...
namespace Vault.Model
{
    ...
    public partial class TransitVerifyWithAlgorithmRequest : IEquatable<TransitVerifyWithAlgorithmRequest>, IValidatableObject
    {
        ...
        public TransitVerifyWithAlgorithmRequest(string Algorithm = "sha2-256", string Context = default(string), string HashAlgorithm = "sha2-256", string Hmac = default(string), string Input = default(string), string MarshalingAlgorithm = "asn1", bool Prehashed = default(bool), string SaltLength = "auto", string Signature = default(string), string SignatureAlgorithm = default(string))
        {
