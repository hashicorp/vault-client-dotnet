...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiConfigureIssuersResponse")]
    public partial class PkiConfigureIssuersResponse : IEquatable<PkiConfigureIssuersResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiConfigureIssuersResponse" /> class.
        /// </summary>
        ...
        public PkiConfigureIssuersResponse(string Default = default(string), bool DefaultFollowsLatestIssuer = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiConfigureIssuersResponse {\n");
        ...
        {
            return this.Equals(input as PkiConfigureIssuersResponse);
        }

        /// <summary>
        /// Returns true if PkiConfigureIssuersResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiConfigureIssuersResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiConfigureIssuersResponse input)
        {
            if (input == null)
            {
                return false;
