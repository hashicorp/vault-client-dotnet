...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GenerateRandomWithSourceAndBytesRequest")]
    public partial class GenerateRandomWithSourceAndBytesRequest : IEquatable<GenerateRandomWithSourceAndBytesRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateRandomWithSourceAndBytesRequest" /> class.
        /// </summary>
        ...
        public GenerateRandomWithSourceAndBytesRequest(int Bytes = 32, string Format = "base64")
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GenerateRandomWithSourceAndBytesRequest {\n");
        ...
        {
            return this.Equals(input as GenerateRandomWithSourceAndBytesRequest);
        }

        /// <summary>
        /// Returns true if GenerateRandomWithSourceAndBytesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateRandomWithSourceAndBytesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateRandomWithSourceAndBytesRequest input)
        {
            if (input == null)
            {
                return false;
