...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SshIssueCertificateRequest")]
    public partial class SshIssueCertificateRequest : IEquatable<SshIssueCertificateRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="SshIssueCertificateRequest" /> class.
        /// </summary>
        ...
        public SshIssueCertificateRequest(string CertType = "user", Object CriticalOptions = default(Object), Object Extensions = default(Object), int KeyBits = 0, string KeyId = default(string), string KeyType = "rsa", string Ttl = default(string), string ValidPrincipals = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SshIssueCertificateRequest {\n");
        ...
        {
            return this.Equals(input as SshIssueCertificateRequest);
        }

        /// <summary>
        /// Returns true if SshIssueCertificateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SshIssueCertificateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SshIssueCertificateRequest input)
        {
            if (input == null)
            {
                return false;
