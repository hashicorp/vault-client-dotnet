...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadIssuerPemResponse")]
    public partial class PkiReadIssuerPemResponse : IEquatable<PkiReadIssuerPemResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadIssuerPemResponse" /> class.
        /// </summary>
        ...
        public PkiReadIssuerPemResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string IssuerName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadIssuerPemResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadIssuerPemResponse);
        }

        /// <summary>
        /// Returns true if PkiReadIssuerPemResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadIssuerPemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadIssuerPemResponse input)
        {
            if (input == null)
            {
                return false;
