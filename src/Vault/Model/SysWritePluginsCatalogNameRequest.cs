...
namespace Vault.Model
{
    ...
    public partial class SysWritePluginsCatalogNameRequest : IEquatable<SysWritePluginsCatalogNameRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SysWritePluginsCatalogNameRequest {\n");
        ...
        {
            return this.Equals(input as SysWritePluginsCatalogNameRequest);
        }

        /// <summary>
        /// Returns true if SysWritePluginsCatalogNameRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SysWritePluginsCatalogNameRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SysWritePluginsCatalogNameRequest input)
        {
            if (input == null)
            {
                return false;
