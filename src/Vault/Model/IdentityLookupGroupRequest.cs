...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityLookupGroupRequest")]
    public partial class IdentityLookupGroupRequest : IEquatable<IdentityLookupGroupRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityLookupGroupRequest" /> class.
        /// </summary>
        ...
        public IdentityLookupGroupRequest(string aliasId = default(string), string aliasMountAccessor = default(string), string aliasName = default(string), string id = default(string), string name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityLookupGroupRequest {\n");
        ...
        {
            return this.Equals(input as IdentityLookupGroupRequest);
        }

        /// <summary>
        /// Returns true if IdentityLookupGroupRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityLookupGroupRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityLookupGroupRequest input)
        {
            if (input == null)
            {
                return false;
