...
namespace Vault.Model
{
    ...
    public partial class PkiConfigAutoTidyRequest : IEquatable<PkiConfigAutoTidyRequest>, IValidatableObject
    {
        ...
        public PkiConfigAutoTidyRequest(bool enabled = default(bool), int intervalDuration = 43200, string pauseDuration = "0s", int safetyBuffer = 259200, bool tidyCertStore = default(bool), bool tidyRevocationList = default(bool), bool tidyRevokedCertIssuerAssociations = default(bool), bool tidyRevokedCerts = default(bool))
        {
