...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CorsConfigureRequest")]
    public partial class CorsConfigureRequest : IEquatable<CorsConfigureRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="CorsConfigureRequest" /> class.
        /// </summary>
        ...
        public CorsConfigureRequest(List<string> AllowedHeaders = default(List<string>), List<string> AllowedOrigins = default(List<string>), bool Enable = default(bool))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CorsConfigureRequest {\n");
        ...
        {
            return this.Equals(input as CorsConfigureRequest);
        }

        /// <summary>
        /// Returns true if CorsConfigureRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CorsConfigureRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CorsConfigureRequest input)
        {
            if (input == null)
            {
                return false;
