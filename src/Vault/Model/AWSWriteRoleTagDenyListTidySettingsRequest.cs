...
namespace Vault.Model
{
    ...
    public partial class AWSWriteRoleTagDenyListTidySettingsRequest : IEquatable<AWSWriteRoleTagDenyListTidySettingsRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AWSWriteRoleTagDenyListTidySettingsRequest {\n");
        ...
        {
            return this.Equals(input as AWSWriteRoleTagDenyListTidySettingsRequest);
        }

        /// <summary>
        /// Returns true if AWSWriteRoleTagDenyListTidySettingsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AWSWriteRoleTagDenyListTidySettingsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AWSWriteRoleTagDenyListTidySettingsRequest input)
        {
            if (input == null)
            {
                return false;
