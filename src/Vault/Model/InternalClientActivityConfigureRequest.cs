...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "InternalClientActivityConfigureRequest")]
    public partial class InternalClientActivityConfigureRequest : IEquatable<InternalClientActivityConfigureRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="InternalClientActivityConfigureRequest" /> class.
        /// </summary>
        ...
        public InternalClientActivityConfigureRequest(int DefaultReportMonths = 12, string Enabled = "default", int RetentionMonths = 24)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class InternalClientActivityConfigureRequest {\n");
        ...
        {
            return this.Equals(input as InternalClientActivityConfigureRequest);
        }

        /// <summary>
        /// Returns true if InternalClientActivityConfigureRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InternalClientActivityConfigureRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InternalClientActivityConfigureRequest input)
        {
            if (input == null)
            {
                return false;
