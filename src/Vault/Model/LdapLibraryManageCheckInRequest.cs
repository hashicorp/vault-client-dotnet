...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LdapLibraryManageCheckInRequest")]
    public partial class LdapLibraryManageCheckInRequest : IEquatable<LdapLibraryManageCheckInRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LdapLibraryManageCheckInRequest" /> class.
        /// </summary>
        /// <param name="serviceAccountNames">The username/logon name for the service accounts to check in..</param>
        public LdapLibraryManageCheckInRequest(List<string> serviceAccountNames = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LdapLibraryManageCheckInRequest {\n");
        ...
        {
            return this.Equals(input as LdapLibraryManageCheckInRequest);
        }

        /// <summary>
        /// Returns true if LdapLibraryManageCheckInRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LdapLibraryManageCheckInRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LdapLibraryManageCheckInRequest input)
        {
            if (input == null)
            {
                return false;
