...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadCaChainPemResponse")]
    public partial class PkiReadCaChainPemResponse : IEquatable<PkiReadCaChainPemResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadCaChainPemResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadCaChainPemResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadCaChainPemResponse);
        }

        /// <summary>
        /// Returns true if PkiReadCaChainPemResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadCaChainPemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadCaChainPemResponse input)
        {
            if (input == null)
            {
                return false;
