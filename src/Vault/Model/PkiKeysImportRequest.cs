...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiKeysImportRequest")]
    public partial class PkiKeysImportRequest : IEquatable<PkiKeysImportRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiKeysImportRequest" /> class.
        /// </summary>
        ...
        public PkiKeysImportRequest(string keyName = default(string), string pemBundle = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiKeysImportRequest {\n");
        ...
        {
            return this.Equals(input as PkiKeysImportRequest);
        }

        /// <summary>
        /// Returns true if PkiKeysImportRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiKeysImportRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiKeysImportRequest input)
        {
            if (input == null)
            {
                return false;
