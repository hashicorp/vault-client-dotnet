...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CertConfigureRequest")]
    public partial class CertConfigureRequest : IEquatable<CertConfigureRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="CertConfigureRequest" /> class.
        /// </summary>
        ...
        public CertConfigureRequest(bool DisableBinding = false, bool EnableIdentityAliasMetadata = false, int OcspCacheSize = 100)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CertConfigureRequest {\n");
        ...
        {
            return this.Equals(input as CertConfigureRequest);
        }

        /// <summary>
        /// Returns true if CertConfigureRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CertConfigureRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CertConfigureRequest input)
        {
            if (input == null)
            {
                return false;
