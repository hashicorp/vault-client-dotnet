...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiConfigClusterRequest")]
    public partial class PkiConfigClusterRequest : IEquatable<PkiConfigClusterRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiConfigClusterRequest" /> class.
        /// </summary>
        ...
        public PkiConfigClusterRequest(string path = default(string))
        {
            this.Path = path;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiConfigClusterRequest {\n");
        ...
        {
            return this.Equals(input as PkiConfigClusterRequest);
        }

        /// <summary>
        /// Returns true if PkiConfigClusterRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiConfigClusterRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiConfigClusterRequest input)
        {
            if (input == null)
            {
                return false;
