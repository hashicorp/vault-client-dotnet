...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadCrlDerResponse")]
    public partial class PkiReadCrlDerResponse : IEquatable<PkiReadCrlDerResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadCrlDerResponse" /> class.
        /// </summary>
        ...
        public PkiReadCrlDerResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string RevocationTime = default(string), string RevocationTimeRfc3339 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadCrlDerResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadCrlDerResponse);
        }

        /// <summary>
        /// Returns true if PkiReadCrlDerResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadCrlDerResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadCrlDerResponse input)
        {
            if (input == null)
            {
                return false;
