...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiWriteRoleResponse")]
    public partial class PkiWriteRoleResponse : IEquatable<PkiWriteRoleResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiWriteRoleResponse" /> class.
        /// </summary>
        ...
        /// <param name="AllowIpSans">If set, IP Subject Alternative Names are allowed. Any valid IP is accepted and No authorization checking is performed..</param>

        /// <param name="AllowLocalhost">Whether to allow \&quot;localhost\&quot; and \&quot;localdomain\&quot; as a valid common name in a request, independent of allowed_domains value..</param>
        ...
        /// <param name="AllowTokenDisplayname">Whether to allow \&quot;localhost\&quot; and \&quot;localdomain\&quot; as a valid common name in a request, independent of allowed_domains value..</param>

        /// <param name="AllowWildcardCertificates">If set, allows certificates with wildcards in the common name to be issued, conforming to RFC 6125&#x27;s Section 6.4.3; e.g., \&quot;*.example.net\&quot; or \&quot;b*z.example.net\&quot;. See the documentation for more information..</param>
        ...
        /// <param name="AllowedDomainsTemplate">If set, Allowed domains can be specified using identity template policies. Non-templated domains are also permitted..</param>
        ...
        /// <param name="AllowedUriSansTemplate">If set, Allowed URI SANs can be specified using identity template policies. Non-templated URI SANs are also permitted..</param>
        ...
        /// <param name="ClientFlag">If set, certificates are flagged for client auth use. Defaults to true. See also RFC 5280 Section 4.2.1.12..</param>
        ...
        /// <param name="EnforceHostnames">If set, only valid host names are allowed for CN and DNS SANs, and the host part of email addresses. Defaults to true..</param>
        ...
        /// <param name="IssuerRef">Reference to the issuer used to sign requests serviced by this role..</param>

        /// <param name="KeyBits">The number of bits to use. Allowed values are 0 (universal default); with rsa key_type: 2048 (default), 3072, or 4096; with ec key_type: 224, 256 (default), 384, or 521; ignored with ed25519..</param>

        /// <param name="KeyType">The type of key to use; defaults to RSA. \&quot;rsa\&quot; \&quot;ec\&quot;, \&quot;ed25519\&quot; and \&quot;any\&quot; are the only valid values..</param>
        ...
        /// <param name="RequireCn">If set to false, makes the &#x27;common_name&#x27; field optional while generating a certificate..</param>
        ...
        /// <param name="SignatureBits">The number of bits to use in the signature algorithm; accepts 256 for SHA-2-256, 384 for SHA-2-384, and 512 for SHA-2-512. Defaults to 0 to automatically detect based on key length (SHA-2-256 for RSA keys, and matching the curve size for NIST P-Curves)..</param>
        ...
        public PkiWriteRoleResponse(bool AllowAnyName = default(bool), bool AllowBareDomains = default(bool), bool AllowGlobDomains = default(bool), bool AllowIpSans = default(bool), bool AllowLocalhost = default(bool), bool AllowSubdomains = default(bool), bool AllowTokenDisplayname = default(bool), bool AllowWildcardCertificates = default(bool), List<string> AllowedDomains = default(List<string>), bool AllowedDomainsTemplate = default(bool), List<string> AllowedOtherSans = default(List<string>), List<string> AllowedSerialNumbers = default(List<string>), List<string> AllowedUriSans = default(List<string>), bool AllowedUriSansTemplate = default(bool), List<string> AllowedUserIds = default(List<string>), bool BasicConstraintsValidForNonCa = default(bool), bool ClientFlag = default(bool), List<string> CnValidations = default(List<string>), bool CodeSigningFlag = default(bool), List<string> Country = default(List<string>), bool EmailProtectionFlag = default(bool), bool EnforceHostnames = default(bool), List<string> ExtKeyUsage = default(List<string>), List<string> ExtKeyUsageOids = default(List<string>), bool GenerateLease = default(bool), string IssuerRef = default(string), int KeyBits = default(int), string KeyType = default(string), List<string> KeyUsage = default(List<string>), List<string> Locality = default(List<string>), int MaxTtl = default(int), bool NoStore = default(bool), string NotAfter = default(string), int NotBeforeDuration = default(int), List<string> Organization = default(List<string>), List<string> Ou = default(List<string>), List<string> PolicyIdentifiers = default(List<string>), List<string> PostalCode = default(List<string>), List<string> Province = default(List<string>), bool RequireCn = default(bool), bool ServerFlag = true, int SignatureBits = default(int), List<string> StreetAddress = default(List<string>), int Ttl = default(int), bool UseCsrCommonName = default(bool), bool UseCsrSans = default(bool), bool UsePss = default(bool))
        {
            ...
            this.AllowTokenDisplayname = AllowTokenDisplayname;
        ...
        /// </summary>
        /// <value>Whether to allow \&quot;localhost\&quot; and \&quot;localdomain\&quot; as a valid common name in a request, independent of allowed_domains value.</value>
        [DataMember(Name = "allow_token_displayname", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiWriteRoleResponse {\n");
            ...
            sb.Append("  AllowTokenDisplayname: ").Append(AllowTokenDisplayname).Append("\n");
        ...
        {
            return this.Equals(input as PkiWriteRoleResponse);
        }

        /// <summary>
        /// Returns true if PkiWriteRoleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiWriteRoleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiWriteRoleResponse input)
        {
            if (input == null)
            {
                return false;
            ...
            return
                ...
                (
                    this.AllowTokenDisplayname == input.AllowTokenDisplayname ||

                    this.AllowTokenDisplayname.Equals(input.AllowTokenDisplayname)
                ) &&
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = (hashCode * 59) + this.AllowTokenDisplayname.GetHashCode();
