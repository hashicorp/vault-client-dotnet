...
namespace Vault.Model
{
    ...
    /// SshRolesRequest
    /// </summary>
    [DataContract(Name = "SshRolesRequest")]
    public partial class SshRolesRequest : IEquatable<SshRolesRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SshRolesRequest" /> class.
        /// </summary>
        ...
        public SshRolesRequest(string adminUser = default(string), string algorithmSigner = default(string), bool allowBareDomains = default(bool), bool allowHostCertificates = false, bool allowSubdomains = default(bool), bool allowUserCertificates = false, bool allowUserKeyIds = default(bool), string allowedCriticalOptions = default(string), string allowedDomains = default(string), string allowedExtensions = default(string), Object allowedUserKeyLengths = default(Object), string allowedUsers = default(string), bool allowedUsersTemplate = false, string cidrList = default(string), Object defaultCriticalOptions = default(Object), Object defaultExtensions = default(Object), bool defaultExtensionsTemplate = false, string defaultUser = default(string), string excludeCidrList = default(string), string installScript = default(string), string key = default(string), int keyBits = default(int), string keyIdFormat = default(string), string keyOptionSpecs = default(string), KeyTypeEnum? keyType = default(KeyTypeEnum?), int maxTtl = default(int), int notBeforeDuration = 30, int port = default(int), int ttl = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SshRolesRequest {\n");
        ...
        {
            return this.Equals(input as SshRolesRequest);
        }

        /// <summary>
        /// Returns true if SshRolesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SshRolesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SshRolesRequest input)
        {
            if (input == null)
            {
                return false;
