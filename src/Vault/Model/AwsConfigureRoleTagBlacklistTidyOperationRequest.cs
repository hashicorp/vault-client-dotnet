...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsConfigureRoleTagBlacklistTidyOperationRequest")]
    public partial class AwsConfigureRoleTagBlacklistTidyOperationRequest : IEquatable<AwsConfigureRoleTagBlacklistTidyOperationRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AwsConfigureRoleTagBlacklistTidyOperationRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsConfigureRoleTagBlacklistTidyOperationRequest {\n");
        ...
        {
            return this.Equals(input as AwsConfigureRoleTagBlacklistTidyOperationRequest);
        }

        /// <summary>
        /// Returns true if AwsConfigureRoleTagBlacklistTidyOperationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsConfigureRoleTagBlacklistTidyOperationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsConfigureRoleTagBlacklistTidyOperationRequest input)
        {
            if (input == null)
            {
                return false;
