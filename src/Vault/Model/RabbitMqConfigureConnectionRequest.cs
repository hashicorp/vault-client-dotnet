...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RabbitMqConfigureConnectionRequest")]
    public partial class RabbitMqConfigureConnectionRequest : IEquatable<RabbitMqConfigureConnectionRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="RabbitMqConfigureConnectionRequest" /> class.
        /// </summary>
        ...
        public RabbitMqConfigureConnectionRequest(string ConnectionUri = default(string), string Password = default(string), string PasswordPolicy = default(string), string Username = default(string), string UsernameTemplate = default(string), bool VerifyConnection = true)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RabbitMqConfigureConnectionRequest {\n");
        ...
        {
            return this.Equals(input as RabbitMqConfigureConnectionRequest);
        }

        /// <summary>
        /// Returns true if RabbitMqConfigureConnectionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RabbitMqConfigureConnectionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RabbitMqConfigureConnectionRequest input)
        {
            if (input == null)
            {
                return false;
