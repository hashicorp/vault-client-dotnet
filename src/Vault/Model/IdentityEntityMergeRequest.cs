...
namespace Vault.Model
{
    ...
    public partial class IdentityEntityMergeRequest : IEquatable<IdentityEntityMergeRequest>, IValidatableObject
    {
        ...
        public IdentityEntityMergeRequest(List<string> conflictingAliasIdsToKeep = default(List<string>), bool force = default(bool), List<string> fromEntityIds = default(List<string>), string toEntityId = default(string))
        {
