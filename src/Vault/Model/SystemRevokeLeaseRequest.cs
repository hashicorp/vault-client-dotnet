...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemRevokeLeaseRequest")]
    public partial class SystemRevokeLeaseRequest : IEquatable<SystemRevokeLeaseRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemRevokeLeaseRequest" /> class.
        /// </summary>
        ...
        public SystemRevokeLeaseRequest(string leaseId = default(string), bool sync = true)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemRevokeLeaseRequest {\n");
        ...
        {
            return this.Equals(input as SystemRevokeLeaseRequest);
        }

        /// <summary>
        /// Returns true if SystemRevokeLeaseRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemRevokeLeaseRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemRevokeLeaseRequest input)
        {
            if (input == null)
            {
                return false;
