...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransitKeysImportVersionRequest")]
    public partial class TransitKeysImportVersionRequest : IEquatable<TransitKeysImportVersionRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransitKeysImportVersionRequest" /> class.
        /// </summary>
        ...
        public TransitKeysImportVersionRequest(string ciphertext = default(string), string hashFunction = "SHA256")
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitKeysImportVersionRequest {\n");
        ...
        {
            return this.Equals(input as TransitKeysImportVersionRequest);
        }

        /// <summary>
        /// Returns true if TransitKeysImportVersionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitKeysImportVersionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitKeysImportVersionRequest input)
        {
            if (input == null)
            {
                return false;
