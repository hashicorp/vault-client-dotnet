...
namespace Vault.Model
{
    ...
    public partial class SystemQuotasRateLimitRequest : IEquatable<SystemQuotasRateLimitRequest>, IValidatableObject
    {
        ...
        public SystemQuotasRateLimitRequest(int blockInterval = default(int), int interval = default(int), string path = default(string), float rate = default(float), string role = default(string), string type = default(string))
        {
