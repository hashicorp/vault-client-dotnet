...
namespace Vault.Model
{
    ...
    public partial class KerberosWriteLDAPConfigRequest : IEquatable<KerberosWriteLDAPConfigRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KerberosWriteLDAPConfigRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KerberosWriteLDAPConfigRequest {\n");
        ...
        {
            return this.Equals(input as KerberosWriteLDAPConfigRequest);
        }

        /// <summary>
        /// Returns true if KerberosWriteLDAPConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KerberosWriteLDAPConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KerberosWriteLDAPConfigRequest input)
        {
            if (input == null)
            {
                return false;
