...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "DatabaseConfigureConnectionRequest")]
    public partial class DatabaseConfigureConnectionRequest : IEquatable<DatabaseConfigureConnectionRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="DatabaseConfigureConnectionRequest" /> class.
        /// </summary>
        ...
        public DatabaseConfigureConnectionRequest(List<string> AllowedRoles = default(List<string>), string PasswordPolicy = default(string), string PluginName = default(string), string PluginVersion = default(string), List<string> RootRotationStatements = default(List<string>), bool VerifyConnection = true)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DatabaseConfigureConnectionRequest {\n");
        ...
        {
            return this.Equals(input as DatabaseConfigureConnectionRequest);
        }

        /// <summary>
        /// Returns true if DatabaseConfigureConnectionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of DatabaseConfigureConnectionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DatabaseConfigureConnectionRequest input)
        {
            if (input == null)
            {
                return false;
