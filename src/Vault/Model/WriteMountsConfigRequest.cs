...
namespace Vault.Model
{
    ...
    public partial class WriteMountsConfigRequest : IEquatable<WriteMountsConfigRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WriteMountsConfigRequest" /> class.
        /// </summary>
        ...
        public WriteMountsConfigRequest(List<string> AllowedManagedKeys = default(List<string>), List<string> AllowedResponseHeaders = default(List<string>), List<string> AuditNonHmacRequestKeys = default(List<string>), List<string> AuditNonHmacResponseKeys = default(List<string>), string DefaultLeaseTtl = default(string), string Description = default(string), string ListingVisibility = default(string), string MaxLeaseTtl = default(string), Object Options = default(Object), List<string> PassthroughRequestHeaders = default(List<string>), string PluginVersion = default(string), string TokenType = default(string), Object UserLockoutConfig = default(Object))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WriteMountsConfigRequest {\n");
        ...
        {
            return this.Equals(input as WriteMountsConfigRequest);
        }

        /// <summary>
        /// Returns true if WriteMountsConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of WriteMountsConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteMountsConfigRequest input)
        {
            if (input == null)
            {
                return false;
