...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GoogleCloudGenerateRolesetKeyWithParameters2Request")]
    public partial class GoogleCloudGenerateRolesetKeyWithParameters2Request : IEquatable<GoogleCloudGenerateRolesetKeyWithParameters2Request>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="GoogleCloudGenerateRolesetKeyWithParameters2Request" /> class.
        /// </summary>
        ...
        public GoogleCloudGenerateRolesetKeyWithParameters2Request(string KeyAlgorithm = "KEY_ALG_RSA_2048", string KeyType = "TYPE_GOOGLE_CREDENTIALS_FILE", int Ttl = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GoogleCloudGenerateRolesetKeyWithParameters2Request {\n");
        ...
        {
            return this.Equals(input as GoogleCloudGenerateRolesetKeyWithParameters2Request);
        }

        /// <summary>
        /// Returns true if GoogleCloudGenerateRolesetKeyWithParameters2Request instances are equal
        /// </summary>
        /// <param name="input">Instance of GoogleCloudGenerateRolesetKeyWithParameters2Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoogleCloudGenerateRolesetKeyWithParameters2Request input)
        {
            if (input == null)
            {
                return false;
