...
namespace Vault.Model
{
    ...
    public partial class PkiIssuersImportBundleResponse : IEquatable<PkiIssuersImportBundleResponse>, IValidatableObject
    {
        ...
        public PkiIssuersImportBundleResponse(List<string> ImportedIssuers = default(List<string>), List<string> ImportedKeys = default(List<string>), Object Mapping = default(Object))
        {
