...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LeasesRenewLeaseWithId2Request")]
    public partial class LeasesRenewLeaseWithId2Request : IEquatable<LeasesRenewLeaseWithId2Request>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="LeasesRenewLeaseWithId2Request" /> class.
        /// </summary>
        ...
        public LeasesRenewLeaseWithId2Request(int Increment = default(int), string LeaseId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LeasesRenewLeaseWithId2Request {\n");
        ...
        {
            return this.Equals(input as LeasesRenewLeaseWithId2Request);
        }

        /// <summary>
        /// Returns true if LeasesRenewLeaseWithId2Request instances are equal
        /// </summary>
        /// <param name="input">Instance of LeasesRenewLeaseWithId2Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LeasesRenewLeaseWithId2Request input)
        {
            if (input == null)
            {
                return false;
