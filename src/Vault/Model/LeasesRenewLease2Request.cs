...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LeasesRenewLease2Request")]
    public partial class LeasesRenewLease2Request : IEquatable<LeasesRenewLease2Request>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="LeasesRenewLease2Request" /> class.
        /// </summary>
        ...
        public LeasesRenewLease2Request(int Increment = default(int), string LeaseId = default(string), string UrlLeaseId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LeasesRenewLease2Request {\n");
        ...
        {
            return this.Equals(input as LeasesRenewLease2Request);
        }

        /// <summary>
        /// Returns true if LeasesRenewLease2Request instances are equal
        /// </summary>
        /// <param name="input">Instance of LeasesRenewLease2Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LeasesRenewLease2Request input)
        {
            if (input == null)
            {
                return false;
