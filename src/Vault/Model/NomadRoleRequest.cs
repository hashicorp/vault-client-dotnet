...
namespace Vault.Model
{
    ...
    /// NomadRoleRequest
    /// </summary>
    [DataContract(Name = "NomadRoleRequest")]
    public partial class NomadRoleRequest : IEquatable<NomadRoleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NomadRoleRequest" /> class.
        /// </summary>
        ...
        public NomadRoleRequest(bool global = default(bool), List<string> policies = default(List<string>), string type = "client")
        {
            this.Global = global;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NomadRoleRequest {\n");
        ...
        {
            return this.Equals(input as NomadRoleRequest);
        }

        /// <summary>
        /// Returns true if NomadRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of NomadRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NomadRoleRequest input)
        {
            if (input == null)
            {
                return false;
