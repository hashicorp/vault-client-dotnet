...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupCreateAliasRequest")]
    public partial class GroupCreateAliasRequest : IEquatable<GroupCreateAliasRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="GroupCreateAliasRequest" /> class.
        /// </summary>
        ...
        public GroupCreateAliasRequest(string CanonicalId = default(string), string Id = default(string), string MountAccessor = default(string), string Name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupCreateAliasRequest {\n");
        ...
        {
            return this.Equals(input as GroupCreateAliasRequest);
        }

        /// <summary>
        /// Returns true if GroupCreateAliasRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupCreateAliasRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupCreateAliasRequest input)
        {
            if (input == null)
            {
                return false;
