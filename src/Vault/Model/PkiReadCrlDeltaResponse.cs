...
namespace Vault.Model
{
    ...
    public partial class PkiReadCrlDeltaResponse : IEquatable<PkiReadCrlDeltaResponse>, IValidatableObject
    {
        ...
        public PkiReadCrlDeltaResponse(string CaChain = default(string), string Certificate = default(string), string IssuerId = default(string), long RevocationTime = default(long), string RevocationTimeRfc3339 = default(string))
        {
