...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadCrlDeltaResponse")]
    public partial class PkiReadCrlDeltaResponse : IEquatable<PkiReadCrlDeltaResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadCrlDeltaResponse" /> class.
        /// </summary>
        ...
        public PkiReadCrlDeltaResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string RevocationTime = default(string), string RevocationTimeRfc3339 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadCrlDeltaResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadCrlDeltaResponse);
        }

        /// <summary>
        /// Returns true if PkiReadCrlDeltaResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadCrlDeltaResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadCrlDeltaResponse input)
        {
            if (input == null)
            {
                return false;
