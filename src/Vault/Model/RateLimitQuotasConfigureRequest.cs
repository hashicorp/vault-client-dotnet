...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RateLimitQuotasConfigureRequest")]
    public partial class RateLimitQuotasConfigureRequest : IEquatable<RateLimitQuotasConfigureRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="RateLimitQuotasConfigureRequest" /> class.
        /// </summary>
        ...
        public RateLimitQuotasConfigureRequest(bool EnableRateLimitAuditLogging = default(bool), bool EnableRateLimitResponseHeaders = default(bool), List<string> RateLimitExemptPaths = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RateLimitQuotasConfigureRequest {\n");
        ...
        {
            return this.Equals(input as RateLimitQuotasConfigureRequest);
        }

        /// <summary>
        /// Returns true if RateLimitQuotasConfigureRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RateLimitQuotasConfigureRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RateLimitQuotasConfigureRequest input)
        {
            if (input == null)
            {
                return false;
