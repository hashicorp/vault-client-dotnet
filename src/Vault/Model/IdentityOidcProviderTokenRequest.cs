...
namespace Vault.Model
{
    ...
    public partial class IdentityOidcProviderTokenRequest : IEquatable<IdentityOidcProviderTokenRequest>, IValidatableObject
    {
        ...
        public IdentityOidcProviderTokenRequest(string clientId = default(string), string clientSecret = default(string), string code = default(string), string codeVerifier = default(string), string grantType = default(string), string redirectUri = default(string))
        {
