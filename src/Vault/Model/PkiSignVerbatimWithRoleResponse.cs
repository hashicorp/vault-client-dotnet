...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiSignVerbatimWithRoleResponse")]
    public partial class PkiSignVerbatimWithRoleResponse : IEquatable<PkiSignVerbatimWithRoleResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiSignVerbatimWithRoleResponse" /> class.
        /// </summary>
        ...
        public PkiSignVerbatimWithRoleResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string Expiration = default(string), string IssuingCa = default(string), string PrivateKey = default(string), string PrivateKeyType = default(string), string SerialNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiSignVerbatimWithRoleResponse {\n");
        ...
        {
            return this.Equals(input as PkiSignVerbatimWithRoleResponse);
        }

        /// <summary>
        /// Returns true if PkiSignVerbatimWithRoleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiSignVerbatimWithRoleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiSignVerbatimWithRoleResponse input)
        {
            if (input == null)
            {
                return false;
