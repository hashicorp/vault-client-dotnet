...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MfaCreateDuoMethodRequest")]
    public partial class MfaCreateDuoMethodRequest : IEquatable<MfaCreateDuoMethodRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="MfaCreateDuoMethodRequest" /> class.
        /// </summary>
        ...
        public MfaCreateDuoMethodRequest(string ApiHostname = default(string), string IntegrationKey = default(string), string MethodName = default(string), string PushInfo = default(string), string SecretKey = default(string), bool UsePasscode = default(bool), string UsernameFormat = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfaCreateDuoMethodRequest {\n");
        ...
        {
            return this.Equals(input as MfaCreateDuoMethodRequest);
        }

        /// <summary>
        /// Returns true if MfaCreateDuoMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MfaCreateDuoMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MfaCreateDuoMethodRequest input)
        {
            if (input == null)
            {
                return false;
