...
namespace Vault.Model
{
    ...
    /// CertCertsRequest
    /// </summary>
    [DataContract(Name = "CertCertsRequest")]
    public partial class CertCertsRequest : IEquatable<CertCertsRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CertCertsRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CertCertsRequest {\n");
        ...
        {
            return this.Equals(input as CertCertsRequest);
        }

        /// <summary>
        /// Returns true if CertCertsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CertCertsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CertCertsRequest input)
        {
            if (input == null)
            {
                return false;
