...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LdapLibraryCheckInRequest")]
    public partial class LdapLibraryCheckInRequest : IEquatable<LdapLibraryCheckInRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="LdapLibraryCheckInRequest" /> class.
        /// </summary>

        /// <param name="ServiceAccountNames">The username/logon name for the service accounts to check in..</param>


        public LdapLibraryCheckInRequest(List<string> ServiceAccountNames = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LdapLibraryCheckInRequest {\n");
        ...
        {
            return this.Equals(input as LdapLibraryCheckInRequest);
        }

        /// <summary>
        /// Returns true if LdapLibraryCheckInRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LdapLibraryCheckInRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LdapLibraryCheckInRequest input)
        {
            if (input == null)
            {
                return false;
