...
namespace Vault.Model
{
    ...
    public partial class KerberosConfigRequest : IEquatable<KerberosConfigRequest>, IValidatableObject
    {
        ...
        public KerberosConfigRequest(bool addGroupAliases = default(bool), string keytab = default(string), bool removeInstanceName = default(bool), string serviceAccount = default(string))
        {
