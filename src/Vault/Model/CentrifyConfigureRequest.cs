...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CentrifyConfigureRequest")]
    public partial class CentrifyConfigureRequest : IEquatable<CentrifyConfigureRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="CentrifyConfigureRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CentrifyConfigureRequest {\n");
        ...
        {
            return this.Equals(input as CentrifyConfigureRequest);
        }

        /// <summary>
        /// Returns true if CentrifyConfigureRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CentrifyConfigureRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CentrifyConfigureRequest input)
        {
            if (input == null)
            {
                return false;
