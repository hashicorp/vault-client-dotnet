...
namespace Vault.Model
{
    ...
    /// SystemRenewRequest
    /// </summary>
    [DataContract(Name = "SystemRenewRequest")]
    public partial class SystemRenewRequest : IEquatable<SystemRenewRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemRenewRequest" /> class.
        /// </summary>
        ...
        public SystemRenewRequest(int increment = default(int), string leaseId = default(string), string urlLeaseId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemRenewRequest {\n");
        ...
        {
            return this.Equals(input as SystemRenewRequest);
        }

        /// <summary>
        /// Returns true if SystemRenewRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemRenewRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemRenewRequest input)
        {
            if (input == null)
            {
                return false;
