...
namespace Vault.Model
{
    ...
    public partial class PKIWriteCertsRequest : IEquatable<PKIWriteCertsRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PKIWriteCertsRequest {\n");
        ...
        {
            return this.Equals(input as PKIWriteCertsRequest);
        }

        /// <summary>
        /// Returns true if PKIWriteCertsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PKIWriteCertsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PKIWriteCertsRequest input)
        {
            if (input == null)
            {
                return false;
