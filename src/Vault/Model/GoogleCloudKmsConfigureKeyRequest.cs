...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GoogleCloudKmsConfigureKeyRequest")]
    public partial class GoogleCloudKmsConfigureKeyRequest : IEquatable<GoogleCloudKmsConfigureKeyRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="GoogleCloudKmsConfigureKeyRequest" /> class.
        /// </summary>
        ...
        public GoogleCloudKmsConfigureKeyRequest(int MaxVersion = default(int), int MinVersion = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GoogleCloudKmsConfigureKeyRequest {\n");
        ...
        {
            return this.Equals(input as GoogleCloudKmsConfigureKeyRequest);
        }

        /// <summary>
        /// Returns true if GoogleCloudKmsConfigureKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GoogleCloudKmsConfigureKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GoogleCloudKmsConfigureKeyRequest input)
        {
            if (input == null)
            {
                return false;
