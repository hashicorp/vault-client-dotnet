...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EntityUpdateByIdRequest")]
    public partial class EntityUpdateByIdRequest : IEquatable<EntityUpdateByIdRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="EntityUpdateByIdRequest" /> class.
        /// </summary>
        ...
        public EntityUpdateByIdRequest(bool Disabled = default(bool), Object Metadata = default(Object), string Name = default(string), List<string> Policies = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EntityUpdateByIdRequest {\n");
        ...
        {
            return this.Equals(input as EntityUpdateByIdRequest);
        }

        /// <summary>
        /// Returns true if EntityUpdateByIdRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityUpdateByIdRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityUpdateByIdRequest input)
        {
            if (input == null)
            {
                return false;
