...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiGenerateEabKeyForIssuerResponse")]
    public partial class PkiGenerateEabKeyForIssuerResponse : IEquatable<PkiGenerateEabKeyForIssuerResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiGenerateEabKeyForIssuerResponse" /> class.
        /// </summary>
        ...
        public PkiGenerateEabKeyForIssuerResponse(string AcmeDirectory = default(string), DateTime CreatedOn = default(DateTime), string Id = default(string), string Key = default(string), string KeyType = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiGenerateEabKeyForIssuerResponse {\n");
        ...
        {
            return this.Equals(input as PkiGenerateEabKeyForIssuerResponse);
        }

        /// <summary>
        /// Returns true if PkiGenerateEabKeyForIssuerResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiGenerateEabKeyForIssuerResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiGenerateEabKeyForIssuerResponse input)
        {
            if (input == null)
            {
                return false;
