...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OpenldapLibraryCheckInRequest")]
    public partial class OpenldapLibraryCheckInRequest : IEquatable<OpenldapLibraryCheckInRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OpenldapLibraryCheckInRequest" /> class.
        /// </summary>
        /// <param name="serviceAccountNames">The username/logon name for the service accounts to check in..</param>
        public OpenldapLibraryCheckInRequest(List<string> serviceAccountNames = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OpenldapLibraryCheckInRequest {\n");
        ...
        {
            return this.Equals(input as OpenldapLibraryCheckInRequest);
        }

        /// <summary>
        /// Returns true if OpenldapLibraryCheckInRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OpenldapLibraryCheckInRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OpenldapLibraryCheckInRequest input)
        {
            if (input == null)
            {
                return false;
