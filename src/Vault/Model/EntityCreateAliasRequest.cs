...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EntityCreateAliasRequest")]
    public partial class EntityCreateAliasRequest : IEquatable<EntityCreateAliasRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="EntityCreateAliasRequest" /> class.
        /// </summary>
        ...
        public EntityCreateAliasRequest(string CanonicalId = default(string), Object CustomMetadata = default(Object), string EntityId = default(string), string Id = default(string), string MountAccessor = default(string), string Name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EntityCreateAliasRequest {\n");
        ...
        {
            return this.Equals(input as EntityCreateAliasRequest);
        }

        /// <summary>
        /// Returns true if EntityCreateAliasRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityCreateAliasRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityCreateAliasRequest input)
        {
            if (input == null)
            {
                return false;
