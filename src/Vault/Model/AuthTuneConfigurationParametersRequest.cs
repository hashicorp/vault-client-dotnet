...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthTuneConfigurationParametersRequest")]
    public partial class AuthTuneConfigurationParametersRequest : IEquatable<AuthTuneConfigurationParametersRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AuthTuneConfigurationParametersRequest" /> class.
        /// </summary>
        ...
        public AuthTuneConfigurationParametersRequest(List<string> AllowedResponseHeaders = default(List<string>), List<string> AuditNonHmacRequestKeys = default(List<string>), List<string> AuditNonHmacResponseKeys = default(List<string>), string DefaultLeaseTtl = default(string), string Description = default(string), string ListingVisibility = default(string), string MaxLeaseTtl = default(string), Object Options = default(Object), List<string> PassthroughRequestHeaders = default(List<string>), string PluginVersion = default(string), string TokenType = default(string), Object UserLockoutConfig = default(Object))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthTuneConfigurationParametersRequest {\n");
        ...
        {
            return this.Equals(input as AuthTuneConfigurationParametersRequest);
        }

        /// <summary>
        /// Returns true if AuthTuneConfigurationParametersRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthTuneConfigurationParametersRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthTuneConfigurationParametersRequest input)
        {
            if (input == null)
            {
                return false;
