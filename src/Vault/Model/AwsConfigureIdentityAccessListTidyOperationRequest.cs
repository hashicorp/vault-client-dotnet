...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsConfigureIdentityAccessListTidyOperationRequest")]
    public partial class AwsConfigureIdentityAccessListTidyOperationRequest : IEquatable<AwsConfigureIdentityAccessListTidyOperationRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AwsConfigureIdentityAccessListTidyOperationRequest" /> class.
        /// </summary>
        ...
        public AwsConfigureIdentityAccessListTidyOperationRequest(bool DisablePeriodicTidy = false, string SafetyBuffer = "259200")
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsConfigureIdentityAccessListTidyOperationRequest {\n");
        ...
        {
            return this.Equals(input as AwsConfigureIdentityAccessListTidyOperationRequest);
        }

        /// <summary>
        /// Returns true if AwsConfigureIdentityAccessListTidyOperationRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsConfigureIdentityAccessListTidyOperationRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsConfigureIdentityAccessListTidyOperationRequest input)
        {
            if (input == null)
            {
                return false;
