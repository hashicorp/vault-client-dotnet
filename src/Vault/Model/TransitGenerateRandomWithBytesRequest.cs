...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransitGenerateRandomWithBytesRequest")]
    public partial class TransitGenerateRandomWithBytesRequest : IEquatable<TransitGenerateRandomWithBytesRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="TransitGenerateRandomWithBytesRequest" /> class.
        /// </summary>
        ...
        public TransitGenerateRandomWithBytesRequest(int Bytes = 32, string Format = "base64", string Source = "platform")
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitGenerateRandomWithBytesRequest {\n");
        ...
        {
            return this.Equals(input as TransitGenerateRandomWithBytesRequest);
        }

        /// <summary>
        /// Returns true if TransitGenerateRandomWithBytesRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitGenerateRandomWithBytesRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitGenerateRandomWithBytesRequest input)
        {
            if (input == null)
            {
                return false;
