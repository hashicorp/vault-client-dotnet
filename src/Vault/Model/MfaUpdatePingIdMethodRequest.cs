...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MfaUpdatePingIdMethodRequest")]
    public partial class MfaUpdatePingIdMethodRequest : IEquatable<MfaUpdatePingIdMethodRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="MfaUpdatePingIdMethodRequest" /> class.
        /// </summary>
        ...
        public MfaUpdatePingIdMethodRequest(string MethodName = default(string), string SettingsFileBase64 = default(string), string UsernameFormat = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfaUpdatePingIdMethodRequest {\n");
        ...
        {
            return this.Equals(input as MfaUpdatePingIdMethodRequest);
        }

        /// <summary>
        /// Returns true if MfaUpdatePingIdMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MfaUpdatePingIdMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MfaUpdatePingIdMethodRequest input)
        {
            if (input == null)
            {
                return false;
