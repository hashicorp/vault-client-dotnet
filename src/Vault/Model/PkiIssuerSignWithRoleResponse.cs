...
namespace Vault.Model
{
    ...
    public partial class PkiIssuerSignWithRoleResponse : IEquatable<PkiIssuerSignWithRoleResponse>, IValidatableObject
    {
        ...
        public PkiIssuerSignWithRoleResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string Expiration = default(string), string IssuingCa = default(string), string PrivateKey = default(string), string PrivateKeyType = default(string), string SerialNumber = default(string))
        {
