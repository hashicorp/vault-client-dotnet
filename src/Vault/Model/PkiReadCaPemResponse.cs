...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadCaPemResponse")]
    public partial class PkiReadCaPemResponse : IEquatable<PkiReadCaPemResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadCaPemResponse" /> class.
        /// </summary>
        ...
        public PkiReadCaPemResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string RevocationTime = default(string), string RevocationTimeRfc3339 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadCaPemResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadCaPemResponse);
        }

        /// <summary>
        /// Returns true if PkiReadCaPemResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadCaPemResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadCaPemResponse input)
        {
            if (input == null)
            {
                return false;
