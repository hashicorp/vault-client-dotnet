...
namespace Vault.Model
{
    ...
    public partial class ToolsHashRequest : IEquatable<ToolsHashRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ToolsHashRequest" /> class.
        /// </summary>
        ...
        public ToolsHashRequest(string Algorithm = "sha2-256", string Format = "hex", string Input = default(string), string Urlalgorithm = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ToolsHashRequest {\n");
        ...
        {
            return this.Equals(input as ToolsHashRequest);
        }

        /// <summary>
        /// Returns true if ToolsHashRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ToolsHashRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ToolsHashRequest input)
        {
            if (input == null)
            {
                return false;
