...
namespace Vault.Model
{
    ...
    public partial class PKIWriteIntermediateCrossSignRequest : IEquatable<PKIWriteIntermediateCrossSignRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PKIWriteIntermediateCrossSignRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PKIWriteIntermediateCrossSignRequest {\n");
        ...
        {
            return this.Equals(input as PKIWriteIntermediateCrossSignRequest);
        }

        /// <summary>
        /// Returns true if PKIWriteIntermediateCrossSignRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PKIWriteIntermediateCrossSignRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PKIWriteIntermediateCrossSignRequest input)
        {
            if (input == null)
            {
                return false;
