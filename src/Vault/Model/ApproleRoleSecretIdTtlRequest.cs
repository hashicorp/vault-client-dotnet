...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ApproleRoleSecretIdTtlRequest")]
    public partial class ApproleRoleSecretIdTtlRequest : IEquatable<ApproleRoleSecretIdTtlRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproleRoleSecretIdTtlRequest" /> class.
        /// </summary>
        ...
        public ApproleRoleSecretIdTtlRequest(int secretIdTtl = default(int))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApproleRoleSecretIdTtlRequest {\n");
        ...
        {
            return this.Equals(input as ApproleRoleSecretIdTtlRequest);
        }

        /// <summary>
        /// Returns true if ApproleRoleSecretIdTtlRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproleRoleSecretIdTtlRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproleRoleSecretIdTtlRequest input)
        {
            if (input == null)
            {
                return false;
