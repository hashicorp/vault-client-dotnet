...
namespace Vault.Model
{
    ...
    /// PkiReadRoleResponse
    /// </summary>
    [DataContract(Name = "PkiReadRoleResponse")]
    public partial class PkiReadRoleResponse : IEquatable<PkiReadRoleResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadRoleResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadRoleResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadRoleResponse);
        }

        /// <summary>
        /// Returns true if PkiReadRoleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadRoleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadRoleResponse input)
        {
            if (input == null)
            {
                return false;
