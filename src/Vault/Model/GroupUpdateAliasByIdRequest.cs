...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupUpdateAliasByIdRequest")]
    public partial class GroupUpdateAliasByIdRequest : IEquatable<GroupUpdateAliasByIdRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="GroupUpdateAliasByIdRequest" /> class.
        /// </summary>
        ...
        public GroupUpdateAliasByIdRequest(string CanonicalId = default(string), string MountAccessor = default(string), string Name = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupUpdateAliasByIdRequest {\n");
        ...
        {
            return this.Equals(input as GroupUpdateAliasByIdRequest);
        }

        /// <summary>
        /// Returns true if GroupUpdateAliasByIdRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupUpdateAliasByIdRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupUpdateAliasByIdRequest input)
        {
            if (input == null)
            {
                return false;
