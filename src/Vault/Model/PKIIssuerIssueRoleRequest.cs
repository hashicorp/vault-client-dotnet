...
namespace Vault.Model
{
    ...
    public partial class PKIIssuerIssueRoleRequest : IEquatable<PKIIssuerIssueRoleRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PKIIssuerIssueRoleRequest" /> class.
        /// </summary>
        ...
        public PKIIssuerIssueRoleRequest(string AltNames = default(string), string CommonName = default(string), bool ExcludeCnFromSans = false, FormatEnum? Format = FormatEnum.Pem, List<string> IpSans = default(List<string>), string NotAfter = default(string), List<string> OtherSans = default(List<string>), PrivateKeyFormatEnum? PrivateKeyFormat = PrivateKeyFormatEnum.Der, bool RemoveRootsFromChain = false, string SerialNumber = default(string), int Ttl = default(int), List<string> UriSans = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PKIIssuerIssueRoleRequest {\n");
        ...
        {
            return this.Equals(input as PKIIssuerIssueRoleRequest);
        }

        /// <summary>
        /// Returns true if PKIIssuerIssueRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PKIIssuerIssueRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PKIIssuerIssueRoleRequest input)
        {
            if (input == null)
            {
                return false;
