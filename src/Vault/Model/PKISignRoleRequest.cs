...
namespace Vault.Model
{
    ...
    /// PKISignRoleRequest
    /// </summary>
    [DataContract(Name = "PKISignRoleRequest")]
    public partial class PKISignRoleRequest : IEquatable<PKISignRoleRequest>, IValidatableObject
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PKISignRoleRequest" /> class.
        /// </summary>
        ...
        public PKISignRoleRequest(string AltNames = default(string), string CommonName = default(string), string Csr = "", bool ExcludeCnFromSans = false, FormatEnum? Format = FormatEnum.Pem, List<string> IpSans = default(List<string>), string IssuerRef = "default", string NotAfter = default(string), List<string> OtherSans = default(List<string>), PrivateKeyFormatEnum? PrivateKeyFormat = PrivateKeyFormatEnum.Der, bool RemoveRootsFromChain = false, string SerialNumber = default(string), int Ttl = default(int), List<string> UriSans = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PKISignRoleRequest {\n");
        ...
        {
            return this.Equals(input as PKISignRoleRequest);
        }

        /// <summary>
        /// Returns true if PKISignRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PKISignRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PKISignRoleRequest input)
        {
            if (input == null)
            {
                return false;
