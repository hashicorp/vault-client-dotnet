...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiIssuerIssueWithRoleResponse")]
    public partial class PkiIssuerIssueWithRoleResponse : IEquatable<PkiIssuerIssueWithRoleResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiIssuerIssueWithRoleResponse" /> class.
        /// </summary>
        ...
        public PkiIssuerIssueWithRoleResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string Expiration = default(string), string IssuingCa = default(string), string PrivateKey = default(string), string PrivateKeyType = default(string), string SerialNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiIssuerIssueWithRoleResponse {\n");
        ...
        {
            return this.Equals(input as PkiIssuerIssueWithRoleResponse);
        }

        /// <summary>
        /// Returns true if PkiIssuerIssueWithRoleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiIssuerIssueWithRoleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiIssuerIssueWithRoleResponse input)
        {
            if (input == null)
            {
                return false;
