...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiGenerateExportedKeyResponse")]
    public partial class PkiGenerateExportedKeyResponse : IEquatable<PkiGenerateExportedKeyResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiGenerateExportedKeyResponse" /> class.
        /// </summary>
        ...
        public PkiGenerateExportedKeyResponse(string KeyId = default(string), string KeyName = default(string), string KeyType = default(string), string PrivateKey = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiGenerateExportedKeyResponse {\n");
        ...
        {
            return this.Equals(input as PkiGenerateExportedKeyResponse);
        }

        /// <summary>
        /// Returns true if PkiGenerateExportedKeyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiGenerateExportedKeyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiGenerateExportedKeyResponse input)
        {
            if (input == null)
            {
                return false;
