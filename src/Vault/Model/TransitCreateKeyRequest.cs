...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransitCreateKeyRequest")]
    public partial class TransitCreateKeyRequest : IEquatable<TransitCreateKeyRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="TransitCreateKeyRequest" /> class.
        /// </summary>
        ...
        /// <param name="ManagedKeyId">The UUID of the managed key to use for this transit key.</param>

        /// <param name="ManagedKeyName">The name of the managed key to use for this transit key.</param>
        ...
        /// </summary>
        /// <value>The UUID of the managed key to use for this transit key</value>
        ...
        /// </summary>
        /// <value>The name of the managed key to use for this transit key</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitCreateKeyRequest {\n");
        ...
        {
            return this.Equals(input as TransitCreateKeyRequest);
        }

        /// <summary>
        /// Returns true if TransitCreateKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitCreateKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitCreateKeyRequest input)
        {
            if (input == null)
            {
                return false;
