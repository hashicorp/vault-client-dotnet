...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransitGenerateRandomRequest")]
    public partial class TransitGenerateRandomRequest : IEquatable<TransitGenerateRandomRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransitGenerateRandomRequest" /> class.
        /// </summary>
        ...
        public TransitGenerateRandomRequest(int bytes = 32, string format = "base64", string source = "platform", string urlbytes = default(string))
        {
            this.Bytes = bytes;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitGenerateRandomRequest {\n");
        ...
        {
            return this.Equals(input as TransitGenerateRandomRequest);
        }

        /// <summary>
        /// Returns true if TransitGenerateRandomRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitGenerateRandomRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitGenerateRandomRequest input)
        {
            if (input == null)
            {
                return false;
