...
namespace Vault.Model
{
    ...
    public partial class OIDCWriteConfigRequest : IEquatable<OIDCWriteConfigRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OIDCWriteConfigRequest {\n");
        ...
        {
            return this.Equals(input as OIDCWriteConfigRequest);
        }

        /// <summary>
        /// Returns true if OIDCWriteConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OIDCWriteConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OIDCWriteConfigRequest input)
        {
            if (input == null)
            {
                return false;
