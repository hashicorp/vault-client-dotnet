...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiGenerateKmsKeyRequest")]
    public partial class PkiGenerateKmsKeyRequest : IEquatable<PkiGenerateKmsKeyRequest>, IValidatableObject
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiGenerateKmsKeyRequest" /> class.
        /// </summary>
        ...
        public PkiGenerateKmsKeyRequest(int KeyBits = 0, string KeyName = default(string), KeyTypeEnum? KeyType = KeyTypeEnum.Rsa, string ManagedKeyId = default(string), string ManagedKeyName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiGenerateKmsKeyRequest {\n");
        ...
        {
            return this.Equals(input as PkiGenerateKmsKeyRequest);
        }

        /// <summary>
        /// Returns true if PkiGenerateKmsKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiGenerateKmsKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiGenerateKmsKeyRequest input)
        {
            if (input == null)
            {
                return false;
