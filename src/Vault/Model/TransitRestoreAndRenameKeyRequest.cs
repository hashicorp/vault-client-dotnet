...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransitRestoreAndRenameKeyRequest")]
    public partial class TransitRestoreAndRenameKeyRequest : IEquatable<TransitRestoreAndRenameKeyRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="TransitRestoreAndRenameKeyRequest" /> class.
        /// </summary>
        ...
        public TransitRestoreAndRenameKeyRequest(string Backup = default(string), bool Force = false)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitRestoreAndRenameKeyRequest {\n");
        ...
        {
            return this.Equals(input as TransitRestoreAndRenameKeyRequest);
        }

        /// <summary>
        /// Returns true if TransitRestoreAndRenameKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitRestoreAndRenameKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitRestoreAndRenameKeyRequest input)
        {
            if (input == null)
            {
                return false;
