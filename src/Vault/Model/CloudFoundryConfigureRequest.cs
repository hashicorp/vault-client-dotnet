...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CloudFoundryConfigureRequest")]
    public partial class CloudFoundryConfigureRequest : IEquatable<CloudFoundryConfigureRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="CloudFoundryConfigureRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CloudFoundryConfigureRequest {\n");
        ...
        {
            return this.Equals(input as CloudFoundryConfigureRequest);
        }

        /// <summary>
        /// Returns true if CloudFoundryConfigureRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CloudFoundryConfigureRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloudFoundryConfigureRequest input)
        {
            if (input == null)
            {
                return false;
