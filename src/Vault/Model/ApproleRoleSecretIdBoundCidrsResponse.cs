...
{
    /// <summary>
    /// ApproleRoleSecretIdBoundCidrsResponse
    /// </summary>
    [DataContract(Name = "ApproleRoleSecretIdBoundCidrsResponse")]
    public partial class ApproleRoleSecretIdBoundCidrsResponse : IEquatable<ApproleRoleSecretIdBoundCidrsResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproleRoleSecretIdBoundCidrsResponse" /> class.
        /// </summary>
        ...
        public ApproleRoleSecretIdBoundCidrsResponse(List<string> secretIdBoundCidrs = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApproleRoleSecretIdBoundCidrsResponse {\n");
        ...
        {
            return this.Equals(input as ApproleRoleSecretIdBoundCidrsResponse);
        }

        /// <summary>
        /// Returns true if ApproleRoleSecretIdBoundCidrsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproleRoleSecretIdBoundCidrsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproleRoleSecretIdBoundCidrsResponse input)
        {
            if (input == null)
            {
                return false;
