...
namespace Vault.Model
{
    ...
    public partial class UserpassWriteUserRequest : IEquatable<UserpassWriteUserRequest>, IValidatableObject
    {
        ...
        public UserpassWriteUserRequest(List<string> BoundCidrs = default(List<string>), int MaxTtl = default(int), string Password = default(string), List<string> Policies = default(List<string>), List<string> TokenBoundCidrs = default(List<string>), int TokenExplicitMaxTtl = default(int), int TokenMaxTtl = default(int), bool TokenNoDefaultPolicy = default(bool), int TokenNumUses = default(int), int TokenPeriod = default(int), List<string> TokenPolicies = default(List<string>), int TokenTtl = default(int), string TokenType = "default-service", int Ttl = default(int))
        {
