...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "UserpassWriteUserRequest")]
    public partial class UserpassWriteUserRequest : IEquatable<UserpassWriteUserRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="UserpassWriteUserRequest" /> class.
        /// </summary>
        ...
        public UserpassWriteUserRequest(List<string> BoundCidrs = default(List<string>), string MaxTtl = default(string), string Password = default(string), List<string> Policies = default(List<string>), List<string> TokenBoundCidrs = default(List<string>), string TokenExplicitMaxTtl = default(string), string TokenMaxTtl = default(string), bool TokenNoDefaultPolicy = default(bool), int TokenNumUses = default(int), string TokenPeriod = default(string), List<string> TokenPolicies = default(List<string>), string TokenTtl = default(string), string TokenType = "default-service", string Ttl = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserpassWriteUserRequest {\n");
        ...
        {
            return this.Equals(input as UserpassWriteUserRequest);
        }

        /// <summary>
        /// Returns true if UserpassWriteUserRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of UserpassWriteUserRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserpassWriteUserRequest input)
        {
            if (input == null)
            {
                return false;
