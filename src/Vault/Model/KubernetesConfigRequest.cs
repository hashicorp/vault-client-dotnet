...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "KubernetesConfigRequest")]
    public partial class KubernetesConfigRequest : IEquatable<KubernetesConfigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KubernetesConfigRequest" /> class.
        /// </summary>
        ...
        public KubernetesConfigRequest(bool disableIssValidation = true, bool disableLocalCaJwt = false, string issuer = default(string), string kubernetesCaCert = default(string), string kubernetesHost = default(string), List<string> pemKeys = default(List<string>), string tokenReviewerJwt = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KubernetesConfigRequest {\n");
        ...
        {
            return this.Equals(input as KubernetesConfigRequest);
        }

        /// <summary>
        /// Returns true if KubernetesConfigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KubernetesConfigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KubernetesConfigRequest input)
        {
            if (input == null)
            {
                return false;
