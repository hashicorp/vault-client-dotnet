...
namespace Vault.Model
{
    ...
    public partial class SystemPluginsCatalogRequest : IEquatable<SystemPluginsCatalogRequest>, IValidatableObject
    {
        ...
        public SystemPluginsCatalogRequest(List<string> args = default(List<string>), string command = default(string), List<string> env = default(List<string>), string sha256 = default(string), string type = default(string), string version = default(string))
        {
            this.Args = args;
