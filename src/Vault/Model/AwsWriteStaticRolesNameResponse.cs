...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsWriteStaticRolesNameResponse")]
    public partial class AwsWriteStaticRolesNameResponse : IEquatable<AwsWriteStaticRolesNameResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AwsWriteStaticRolesNameResponse" /> class.
        /// </summary>
        ...
        public AwsWriteStaticRolesNameResponse(string Name = default(string), string RotationPeriod = default(string), string Username = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsWriteStaticRolesNameResponse {\n");
        ...
        {
            return this.Equals(input as AwsWriteStaticRolesNameResponse);
        }

        /// <summary>
        /// Returns true if AwsWriteStaticRolesNameResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsWriteStaticRolesNameResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsWriteStaticRolesNameResponse input)
        {
            if (input == null)
            {
                return false;
