...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WriteLeasesRevoke2Request")]
    public partial class WriteLeasesRevoke2Request : IEquatable<WriteLeasesRevoke2Request>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="WriteLeasesRevoke2Request" /> class.
        /// </summary>
        ...
        public WriteLeasesRevoke2Request(string LeaseId = default(string), bool Sync = true)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WriteLeasesRevoke2Request {\n");
        ...
        {
            return this.Equals(input as WriteLeasesRevoke2Request);
        }

        /// <summary>
        /// Returns true if WriteLeasesRevoke2Request instances are equal
        /// </summary>
        /// <param name="input">Instance of WriteLeasesRevoke2Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteLeasesRevoke2Request input)
        {
            if (input == null)
            {
                return false;
