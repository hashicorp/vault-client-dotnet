...
namespace Vault.Model
{
    ...
    public partial class PkiReadCertRawPemResponse : IEquatable<PkiReadCertRawPemResponse>, IValidatableObject
    {
        ...
        public PkiReadCertRawPemResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string RevocationTime = default(string), string RevocationTimeRfc3339 = default(string))
        {
