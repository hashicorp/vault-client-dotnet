...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiConfigureCaRequest")]
    public partial class PkiConfigureCaRequest : IEquatable<PkiConfigureCaRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiConfigureCaRequest" /> class.
        /// </summary>

        /// <param name="PemBundle">PEM-format, concatenated unencrypted secret key and certificate..</param>


        public PkiConfigureCaRequest(string PemBundle = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiConfigureCaRequest {\n");
        ...
        {
            return this.Equals(input as PkiConfigureCaRequest);
        }

        /// <summary>
        /// Returns true if PkiConfigureCaRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiConfigureCaRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiConfigureCaRequest input)
        {
            if (input == null)
            {
                return false;
