...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthReadTuningInformationResponse")]
    public partial class AuthReadTuningInformationResponse : IEquatable<AuthReadTuningInformationResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AuthReadTuningInformationResponse" /> class.
        /// </summary>

        /// <param name="AllowedManagedKeys">AllowedManagedKeys.</param>

        /// <param name="AllowedResponseHeaders">AllowedResponseHeaders.</param>
        ...
        /// <param name="DefaultLeaseTtl">DefaultLeaseTtl.</param>
        ...
        /// <param name="MaxLeaseTtl">MaxLeaseTtl.</param>
        ...
        /// <summary>
        /// Gets or Sets AllowedResponseHeaders
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthReadTuningInformationResponse {\n");
        ...
        {
            return this.Equals(input as AuthReadTuningInformationResponse);
        }

        /// <summary>
        /// Returns true if AuthReadTuningInformationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthReadTuningInformationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthReadTuningInformationResponse input)
        {
            if (input == null)
            {
                return false;
