...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadCertRawDerResponse")]
    public partial class PkiReadCertRawDerResponse : IEquatable<PkiReadCertRawDerResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadCertRawDerResponse" /> class.
        /// </summary>
        ...
        public PkiReadCertRawDerResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string RevocationTime = default(string), string RevocationTimeRfc3339 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadCertRawDerResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadCertRawDerResponse);
        }

        /// <summary>
        /// Returns true if PkiReadCertRawDerResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadCertRawDerResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadCertRawDerResponse input)
        {
            if (input == null)
            {
                return false;
