...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiConfigureUrlsResponse")]
    public partial class PkiConfigureUrlsResponse : IEquatable<PkiConfigureUrlsResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiConfigureUrlsResponse" /> class.
        /// </summary>
        ...
        public PkiConfigureUrlsResponse(List<string> CrlDistributionPoints = default(List<string>), bool EnableTemplating = false, List<string> IssuingCertificates = default(List<string>), List<string> OcspServers = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiConfigureUrlsResponse {\n");
        ...
        {
            return this.Equals(input as PkiConfigureUrlsResponse);
        }

        /// <summary>
        /// Returns true if PkiConfigureUrlsResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiConfigureUrlsResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiConfigureUrlsResponse input)
        {
            if (input == null)
            {
                return false;
