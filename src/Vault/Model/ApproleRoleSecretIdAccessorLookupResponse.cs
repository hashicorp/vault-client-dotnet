...
{
    /// <summary>
    /// ApproleRoleSecretIdAccessorLookupResponse
    /// </summary>
    [DataContract(Name = "ApproleRoleSecretIdAccessorLookupResponse")]
    public partial class ApproleRoleSecretIdAccessorLookupResponse : IEquatable<ApproleRoleSecretIdAccessorLookupResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproleRoleSecretIdAccessorLookupResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApproleRoleSecretIdAccessorLookupResponse {\n");
        ...
        {
            return this.Equals(input as ApproleRoleSecretIdAccessorLookupResponse);
        }

        /// <summary>
        /// Returns true if ApproleRoleSecretIdAccessorLookupResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproleRoleSecretIdAccessorLookupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproleRoleSecretIdAccessorLookupResponse input)
        {
            if (input == null)
            {
                return false;
