...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdentityMfaMethodTotpRequest")]
    public partial class IdentityMfaMethodTotpRequest : IEquatable<IdentityMfaMethodTotpRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdentityMfaMethodTotpRequest" /> class.
        /// </summary>
        ...
        public IdentityMfaMethodTotpRequest(string algorithm = "SHA1", int digits = 6, string issuer = default(string), int keySize = 20, int maxValidationAttempts = default(int), string methodId = default(string), int period = 30, int qrSize = 200, int skew = 1)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdentityMfaMethodTotpRequest {\n");
        ...
        {
            return this.Equals(input as IdentityMfaMethodTotpRequest);
        }

        /// <summary>
        /// Returns true if IdentityMfaMethodTotpRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of IdentityMfaMethodTotpRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdentityMfaMethodTotpRequest input)
        {
            if (input == null)
            {
                return false;
