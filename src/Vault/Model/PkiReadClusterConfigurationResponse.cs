...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadClusterConfigurationResponse")]
    public partial class PkiReadClusterConfigurationResponse : IEquatable<PkiReadClusterConfigurationResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadClusterConfigurationResponse" /> class.
        /// </summary>
        ...
        public PkiReadClusterConfigurationResponse(string AiaPath = default(string), string Path = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadClusterConfigurationResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadClusterConfigurationResponse);
        }

        /// <summary>
        /// Returns true if PkiReadClusterConfigurationResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadClusterConfigurationResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadClusterConfigurationResponse input)
        {
            if (input == null)
            {
                return false;
