...
namespace Vault.Model
{
    ...
    /// PKIWriteKMSRequest
    /// </summary>
    [DataContract(Name = "PKIWriteKMSRequest")]

    public partial class PKIWriteKMSRequest : IEquatable<PKIWriteKMSRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PKIWriteKMSRequest" /> class.
        /// </summary>
        ...
        public PKIWriteKMSRequest(int KeyBits = 0, string KeyName = default(string), KeyTypeEnum? KeyType = KeyTypeEnum.Rsa, string ManagedKeyId = default(string), string ManagedKeyName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PKIWriteKMSRequest {\n");
        ...
        {
            return this.Equals(input as PKIWriteKMSRequest);
        }

        /// <summary>
        /// Returns true if PKIWriteKMSRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PKIWriteKMSRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PKIWriteKMSRequest input)
        {
            if (input == null)
            {
                return false;
