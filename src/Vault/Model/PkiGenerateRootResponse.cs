...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiGenerateRootResponse")]
    public partial class PkiGenerateRootResponse : IEquatable<PkiGenerateRootResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiGenerateRootResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiGenerateRootResponse {\n");
        ...
        {
            return this.Equals(input as PkiGenerateRootResponse);
        }

        /// <summary>
        /// Returns true if PkiGenerateRootResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiGenerateRootResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiGenerateRootResponse input)
        {
            if (input == null)
            {
                return false;
