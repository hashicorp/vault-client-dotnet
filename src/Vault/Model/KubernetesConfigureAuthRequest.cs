...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "KubernetesConfigureAuthRequest")]
    public partial class KubernetesConfigureAuthRequest : IEquatable<KubernetesConfigureAuthRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="KubernetesConfigureAuthRequest" /> class.
        /// </summary>
        ...
        public KubernetesConfigureAuthRequest(bool DisableIssValidation = true, bool DisableLocalCaJwt = false, string Issuer = default(string), string KubernetesCaCert = default(string), string KubernetesHost = default(string), List<string> PemKeys = default(List<string>), string TokenReviewerJwt = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class KubernetesConfigureAuthRequest {\n");
        ...
        {
            return this.Equals(input as KubernetesConfigureAuthRequest);
        }

        /// <summary>
        /// Returns true if KubernetesConfigureAuthRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of KubernetesConfigureAuthRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KubernetesConfigureAuthRequest input)
        {
            if (input == null)
            {
                return false;
