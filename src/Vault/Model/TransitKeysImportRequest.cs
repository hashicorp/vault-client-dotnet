...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransitKeysImportRequest")]
    public partial class TransitKeysImportRequest : IEquatable<TransitKeysImportRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransitKeysImportRequest" /> class.
        /// </summary>
        ...
        public TransitKeysImportRequest(bool allowPlaintextBackup = default(bool), bool allowRotation = default(bool), int autoRotatePeriod = 0, string ciphertext = default(string), string context = default(string), bool derived = default(bool), bool exportable = default(bool), string hashFunction = "SHA256", string type = "aes256-gcm96")
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitKeysImportRequest {\n");
        ...
        {
            return this.Equals(input as TransitKeysImportRequest);
        }

        /// <summary>
        /// Returns true if TransitKeysImportRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitKeysImportRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitKeysImportRequest input)
        {
            if (input == null)
            {
                return false;
