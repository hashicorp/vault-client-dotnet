...
namespace Vault.Model
{
    ...
    public partial class GitHubWriteMapUserRequest : IEquatable<GitHubWriteMapUserRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GitHubWriteMapUserRequest {\n");
        ...
        {
            return this.Equals(input as GitHubWriteMapUserRequest);
        }

        /// <summary>
        /// Returns true if GitHubWriteMapUserRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GitHubWriteMapUserRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GitHubWriteMapUserRequest input)
        {
            if (input == null)
            {
                return false;
