...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SshSignCertificateRequest")]
    public partial class SshSignCertificateRequest : IEquatable<SshSignCertificateRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="SshSignCertificateRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SshSignCertificateRequest {\n");
        ...
        {
            return this.Equals(input as SshSignCertificateRequest);
        }

        /// <summary>
        /// Returns true if SshSignCertificateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SshSignCertificateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SshSignCertificateRequest input)
        {
            if (input == null)
            {
                return false;
