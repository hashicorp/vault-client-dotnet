...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TerraformRoleRequest")]
    public partial class TerraformRoleRequest : IEquatable<TerraformRoleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TerraformRoleRequest" /> class.
        /// </summary>
        ...
        public TerraformRoleRequest(int maxTtl = default(int), string organization = default(string), string teamId = default(string), int ttl = default(int), string userId = default(string))
        {
            this.MaxTtl = maxTtl;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TerraformRoleRequest {\n");
        ...
        {
            return this.Equals(input as TerraformRoleRequest);
        }

        /// <summary>
        /// Returns true if TerraformRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TerraformRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TerraformRoleRequest input)
        {
            if (input == null)
            {
                return false;
