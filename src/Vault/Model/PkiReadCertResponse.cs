...
namespace Vault.Model
{
    ...
    /// PkiReadCertResponse
    /// </summary>
    [DataContract(Name = "PkiReadCertResponse")]
    public partial class PkiReadCertResponse : IEquatable<PkiReadCertResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadCertResponse" /> class.
        /// </summary>
        ...
        public PkiReadCertResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string RevocationTime = default(string), string RevocationTimeRfc3339 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadCertResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadCertResponse);
        }

        /// <summary>
        /// Returns true if PkiReadCertResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadCertResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadCertResponse input)
        {
            if (input == null)
            {
                return false;
