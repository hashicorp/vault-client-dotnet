...
namespace Vault.Model
{
    ...
    public partial class PkiReadCertResponse : IEquatable<PkiReadCertResponse>, IValidatableObject
    {
        ...
        public PkiReadCertResponse(string CaChain = default(string), string Certificate = default(string), string IssuerId = default(string), long RevocationTime = default(long), string RevocationTimeRfc3339 = default(string))
        {
