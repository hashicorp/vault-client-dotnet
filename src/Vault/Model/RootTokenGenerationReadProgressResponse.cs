...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "RootTokenGenerationReadProgressResponse")]
    public partial class RootTokenGenerationReadProgressResponse : IEquatable<RootTokenGenerationReadProgressResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="RootTokenGenerationReadProgressResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RootTokenGenerationReadProgressResponse {\n");
        ...
        {
            return this.Equals(input as RootTokenGenerationReadProgressResponse);
        }

        /// <summary>
        /// Returns true if RootTokenGenerationReadProgressResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of RootTokenGenerationReadProgressResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RootTokenGenerationReadProgressResponse input)
        {
            if (input == null)
            {
                return false;
