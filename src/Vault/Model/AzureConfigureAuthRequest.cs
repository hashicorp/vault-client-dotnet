...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AzureConfigureAuthRequest")]
    public partial class AzureConfigureAuthRequest : IEquatable<AzureConfigureAuthRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AzureConfigureAuthRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AzureConfigureAuthRequest {\n");
        ...
        {
            return this.Equals(input as AzureConfigureAuthRequest);
        }

        /// <summary>
        /// Returns true if AzureConfigureAuthRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AzureConfigureAuthRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AzureConfigureAuthRequest input)
        {
            if (input == null)
            {
                return false;
