...
namespace Vault.Model
{
    ...
    /// LdapRoleRequest
    /// </summary>
    [DataContract(Name = "LdapRoleRequest")]
    public partial class LdapRoleRequest : IEquatable<LdapRoleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LdapRoleRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LdapRoleRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LdapRoleRequest" /> class.
        /// </summary>
        ...
        public LdapRoleRequest(string creationLdif = default(string), int defaultTtl = default(int), string deletionLdif = default(string), int maxTtl = default(int), string rollbackLdif = default(string), string usernameTemplate = default(string))
        {
            // to ensure "creationLdif" is required (not null)
            if (creationLdif == null) {
                throw new ArgumentNullException("creationLdif is a required property for LdapRoleRequest and cannot be null");
            }
            this.CreationLdif = creationLdif;
            // to ensure "deletionLdif" is required (not null)
            if (deletionLdif == null) {
                throw new ArgumentNullException("deletionLdif is a required property for LdapRoleRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LdapRoleRequest {\n");
        ...
        {
            return this.Equals(input as LdapRoleRequest);
        }

        /// <summary>
        /// Returns true if LdapRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LdapRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LdapRoleRequest input)
        {
            if (input == null)
            {
                return false;
