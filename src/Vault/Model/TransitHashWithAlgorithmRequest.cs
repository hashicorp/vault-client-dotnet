...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TransitHashWithAlgorithmRequest")]
    public partial class TransitHashWithAlgorithmRequest : IEquatable<TransitHashWithAlgorithmRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TransitHashWithAlgorithmRequest" /> class.
        /// </summary>
        ...
        public TransitHashWithAlgorithmRequest(string Algorithm = "sha2-256", string Format = "hex", string Input = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitHashWithAlgorithmRequest {\n");
        ...
        {
            return this.Equals(input as TransitHashWithAlgorithmRequest);
        }

        /// <summary>
        /// Returns true if TransitHashWithAlgorithmRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitHashWithAlgorithmRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitHashWithAlgorithmRequest input)
        {
            if (input == null)
            {
                return false;
