...
namespace Vault.Model
{
    ...
    public partial class AWSConfigWriteRoleTagBlackListRequest : IEquatable<AWSConfigWriteRoleTagBlackListRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AWSConfigWriteRoleTagBlackListRequest" /> class.
        /// </summary>
        ...
        public AWSConfigWriteRoleTagBlackListRequest(bool DisablePeriodicTidy = false, int SafetyBuffer = 15552000)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AWSConfigWriteRoleTagBlackListRequest {\n");
        ...
        {
            return this.Equals(input as AWSConfigWriteRoleTagBlackListRequest);
        }

        /// <summary>
        /// Returns true if AWSConfigWriteRoleTagBlackListRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AWSConfigWriteRoleTagBlackListRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AWSConfigWriteRoleTagBlackListRequest input)
        {
            if (input == null)
            {
                return false;
