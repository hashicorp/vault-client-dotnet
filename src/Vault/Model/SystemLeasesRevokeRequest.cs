...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemLeasesRevokeRequest")]
    public partial class SystemLeasesRevokeRequest : IEquatable<SystemLeasesRevokeRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemLeasesRevokeRequest" /> class.
        /// </summary>
        ...
        public SystemLeasesRevokeRequest(string leaseId = default(string), bool sync = true, string urlLeaseId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemLeasesRevokeRequest {\n");
        ...
        {
            return this.Equals(input as SystemLeasesRevokeRequest);
        }

        /// <summary>
        /// Returns true if SystemLeasesRevokeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemLeasesRevokeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemLeasesRevokeRequest input)
        {
            if (input == null)
            {
                return false;
