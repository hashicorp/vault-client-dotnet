...
{
    /// <summary>
    /// ApproleRoleSecretIdLookupResponse
    /// </summary>
    [DataContract(Name = "ApproleRoleSecretIdLookupResponse")]
    public partial class ApproleRoleSecretIdLookupResponse : IEquatable<ApproleRoleSecretIdLookupResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproleRoleSecretIdLookupResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApproleRoleSecretIdLookupResponse {\n");
        ...
        {
            return this.Equals(input as ApproleRoleSecretIdLookupResponse);
        }

        /// <summary>
        /// Returns true if ApproleRoleSecretIdLookupResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproleRoleSecretIdLookupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproleRoleSecretIdLookupResponse input)
        {
            if (input == null)
            {
                return false;
