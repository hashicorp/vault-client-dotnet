...
namespace Vault.Model
{
    ...
    public partial class PKIWriteIntermediateSetSignedRequest : IEquatable<PKIWriteIntermediateSetSignedRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PKIWriteIntermediateSetSignedRequest {\n");
        ...
        {
            return this.Equals(input as PKIWriteIntermediateSetSignedRequest);
        }

        /// <summary>
        /// Returns true if PKIWriteIntermediateSetSignedRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PKIWriteIntermediateSetSignedRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PKIWriteIntermediateSetSignedRequest input)
        {
            if (input == null)
            {
                return false;
