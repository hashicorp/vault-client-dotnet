...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsWriteRoleTagRequest")]
    public partial class AwsWriteRoleTagRequest : IEquatable<AwsWriteRoleTagRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AwsWriteRoleTagRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsWriteRoleTagRequest {\n");
        ...
        {
            return this.Equals(input as AwsWriteRoleTagRequest);
        }

        /// <summary>
        /// Returns true if AwsWriteRoleTagRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsWriteRoleTagRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsWriteRoleTagRequest input)
        {
            if (input == null)
            {
                return false;
