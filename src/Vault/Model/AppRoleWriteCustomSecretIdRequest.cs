...
namespace Vault.Model
{
    ...
    public partial class AppRoleWriteCustomSecretIdRequest : IEquatable<AppRoleWriteCustomSecretIdRequest>, IValidatableObject
    {
        ...
        public AppRoleWriteCustomSecretIdRequest(List<string> CidrList = default(List<string>), string Metadata = default(string), int NumUses = default(int), string SecretId = default(string), List<string> TokenBoundCidrs = default(List<string>), string Ttl = default(string))
        {
