...
namespace Vault.Model
{
    ...
    public partial class InitializeRequest : IEquatable<InitializeRequest>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as InitializeRequest);
        }

        /// <summary>
        /// Returns true if InitializeRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of InitializeRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(InitializeRequest input)
        {
            if (input == null)
            {
                return false;
