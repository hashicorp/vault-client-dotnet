...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GenerateRandomWithSourceRequest")]
    public partial class GenerateRandomWithSourceRequest : IEquatable<GenerateRandomWithSourceRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="GenerateRandomWithSourceRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as GenerateRandomWithSourceRequest);
        }

        /// <summary>
        /// Returns true if GenerateRandomWithSourceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GenerateRandomWithSourceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GenerateRandomWithSourceRequest input)
        {
            if (input == null)
            {
                return false;
