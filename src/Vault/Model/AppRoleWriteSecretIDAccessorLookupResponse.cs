...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AppRoleWriteSecretIDAccessorLookupResponse")]

    public partial class AppRoleWriteSecretIDAccessorLookupResponse : IEquatable<AppRoleWriteSecretIDAccessorLookupResponse>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AppRoleWriteSecretIDAccessorLookupResponse" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AppRoleWriteSecretIDAccessorLookupResponse {\n");
        ...
        {
            return this.Equals(input as AppRoleWriteSecretIDAccessorLookupResponse);
        }

        /// <summary>
        /// Returns true if AppRoleWriteSecretIDAccessorLookupResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of AppRoleWriteSecretIDAccessorLookupResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppRoleWriteSecretIDAccessorLookupResponse input)
        {
            if (input == null)
            {
                return false;
