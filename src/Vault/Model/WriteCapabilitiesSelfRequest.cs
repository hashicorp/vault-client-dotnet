...
namespace Vault.Model
{
    ...
    public partial class WriteCapabilitiesSelfRequest : IEquatable<WriteCapabilitiesSelfRequest>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WriteCapabilitiesSelfRequest" /> class.
        /// </summary>
        ...
        public WriteCapabilitiesSelfRequest(List<string> Path = default(List<string>), List<string> Paths = default(List<string>), string Token = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WriteCapabilitiesSelfRequest {\n");
        ...
        {
            return this.Equals(input as WriteCapabilitiesSelfRequest);
        }

        /// <summary>
        /// Returns true if WriteCapabilitiesSelfRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of WriteCapabilitiesSelfRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteCapabilitiesSelfRequest input)
        {
            if (input == null)
            {
                return false;
