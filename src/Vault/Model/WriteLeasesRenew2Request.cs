...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "WriteLeasesRenew2Request")]
    public partial class WriteLeasesRenew2Request : IEquatable<WriteLeasesRenew2Request>, IValidatableObject
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WriteLeasesRenew2Request" /> class.
        /// </summary>
        ...
        public WriteLeasesRenew2Request(int Increment = default(int), string LeaseId = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class WriteLeasesRenew2Request {\n");
        ...
        {
            return this.Equals(input as WriteLeasesRenew2Request);
        }

        /// <summary>
        /// Returns true if WriteLeasesRenew2Request instances are equal
        /// </summary>
        /// <param name="input">Instance of WriteLeasesRenew2Request to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WriteLeasesRenew2Request input)
        {
            if (input == null)
            {
                return false;
