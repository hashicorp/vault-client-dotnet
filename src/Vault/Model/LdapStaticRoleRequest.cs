...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "LdapStaticRoleRequest")]
    public partial class LdapStaticRoleRequest : IEquatable<LdapStaticRoleRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LdapStaticRoleRequest" /> class.
        /// </summary>
        ...
        public LdapStaticRoleRequest(string dn = default(string), int rotationPeriod = default(int), string username = default(string))
        {
            this.Dn = dn;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LdapStaticRoleRequest {\n");
        ...
        {
            return this.Equals(input as LdapStaticRoleRequest);
        }

        /// <summary>
        /// Returns true if LdapStaticRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LdapStaticRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LdapStaticRoleRequest input)
        {
            if (input == null)
            {
                return false;
