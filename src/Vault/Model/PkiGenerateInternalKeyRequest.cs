...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiGenerateInternalKeyRequest")]
    public partial class PkiGenerateInternalKeyRequest : IEquatable<PkiGenerateInternalKeyRequest>, IValidatableObject
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiGenerateInternalKeyRequest" /> class.
        /// </summary>
        ...
        public PkiGenerateInternalKeyRequest(int KeyBits = 0, string KeyName = default(string), KeyTypeEnum? KeyType = KeyTypeEnum.Rsa, string ManagedKeyId = default(string), string ManagedKeyName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiGenerateInternalKeyRequest {\n");
        ...
        {
            return this.Equals(input as PkiGenerateInternalKeyRequest);
        }

        /// <summary>
        /// Returns true if PkiGenerateInternalKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiGenerateInternalKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiGenerateInternalKeyRequest input)
        {
            if (input == null)
            {
                return false;
