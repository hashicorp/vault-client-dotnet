...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "OktaConfigureRequest")]
    public partial class OktaConfigureRequest : IEquatable<OktaConfigureRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="OktaConfigureRequest" /> class.
        /// </summary>
        ...
        public OktaConfigureRequest(string ApiToken = default(string), string BaseUrl = default(string), bool BypassOktaMfa = default(bool), string MaxTtl = default(string), string OrgName = default(string), string Organization = default(string), bool Production = default(bool), string Token = default(string), List<string> TokenBoundCidrs = default(List<string>), string TokenExplicitMaxTtl = default(string), string TokenMaxTtl = default(string), bool TokenNoDefaultPolicy = default(bool), int TokenNumUses = default(int), string TokenPeriod = default(string), List<string> TokenPolicies = default(List<string>), string TokenTtl = default(string), string TokenType = "default-service", string Ttl = default(string))
        {
        ...
        [Obsolete] public string Organization { get; set; }
        ...
        [Obsolete] public bool Production { get; set; }
        ...
        [Obsolete] public string Token { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class OktaConfigureRequest {\n");
        ...
        {
            return this.Equals(input as OktaConfigureRequest);
        }

        /// <summary>
        /// Returns true if OktaConfigureRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of OktaConfigureRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(OktaConfigureRequest input)
        {
            if (input == null)
            {
                return false;
