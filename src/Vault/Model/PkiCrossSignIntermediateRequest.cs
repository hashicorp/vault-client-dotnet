...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiCrossSignIntermediateRequest")]
    public partial class PkiCrossSignIntermediateRequest : IEquatable<PkiCrossSignIntermediateRequest>, IValidatableObject
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiCrossSignIntermediateRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiCrossSignIntermediateRequest {\n");
        ...
        {
            return this.Equals(input as PkiCrossSignIntermediateRequest);
        }

        /// <summary>
        /// Returns true if PkiCrossSignIntermediateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiCrossSignIntermediateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiCrossSignIntermediateRequest input)
        {
            if (input == null)
            {
                return false;
