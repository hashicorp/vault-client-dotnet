...
{
    /// <summary>
    /// ApproleRolePoliciesResponse
    /// </summary>
    [DataContract(Name = "ApproleRolePoliciesResponse")]
    public partial class ApproleRolePoliciesResponse : IEquatable<ApproleRolePoliciesResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApproleRolePoliciesResponse" /> class.
        /// </summary>
        ...
        public ApproleRolePoliciesResponse(List<string> policies = default(List<string>), List<string> tokenPolicies = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApproleRolePoliciesResponse {\n");
        ...
        {
            return this.Equals(input as ApproleRolePoliciesResponse);
        }

        /// <summary>
        /// Returns true if ApproleRolePoliciesResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of ApproleRolePoliciesResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApproleRolePoliciesResponse input)
        {
            if (input == null)
            {
                return false;
