...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadIssuerDerResponse")]
    public partial class PkiReadIssuerDerResponse : IEquatable<PkiReadIssuerDerResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadIssuerDerResponse" /> class.
        /// </summary>
        ...
        public PkiReadIssuerDerResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string IssuerName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadIssuerDerResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadIssuerDerResponse);
        }

        /// <summary>
        /// Returns true if PkiReadIssuerDerResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadIssuerDerResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadIssuerDerResponse input)
        {
            if (input == null)
            {
                return false;
