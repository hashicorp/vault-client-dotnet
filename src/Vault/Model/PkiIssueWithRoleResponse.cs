...
namespace Vault.Model
{
    ...
    public partial class PkiIssueWithRoleResponse : IEquatable<PkiIssueWithRoleResponse>, IValidatableObject
    {
        ...
        public PkiIssueWithRoleResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), long Expiration = default(long), string IssuingCa = default(string), string PrivateKey = default(string), string PrivateKeyType = default(string), string SerialNumber = default(string))
        {
