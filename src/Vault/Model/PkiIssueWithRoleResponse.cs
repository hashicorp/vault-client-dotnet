...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiIssueWithRoleResponse")]
    public partial class PkiIssueWithRoleResponse : IEquatable<PkiIssueWithRoleResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiIssueWithRoleResponse" /> class.
        /// </summary>
        ...
        public PkiIssueWithRoleResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string Expiration = default(string), string IssuingCa = default(string), string PrivateKey = default(string), string PrivateKeyType = default(string), string SerialNumber = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiIssueWithRoleResponse {\n");
        ...
        {
            return this.Equals(input as PkiIssueWithRoleResponse);
        }

        /// <summary>
        /// Returns true if PkiIssueWithRoleResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiIssueWithRoleResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiIssueWithRoleResponse input)
        {
            if (input == null)
            {
                return false;
