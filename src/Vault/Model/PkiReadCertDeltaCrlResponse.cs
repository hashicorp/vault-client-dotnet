...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiReadCertDeltaCrlResponse")]
    public partial class PkiReadCertDeltaCrlResponse : IEquatable<PkiReadCertDeltaCrlResponse>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="PkiReadCertDeltaCrlResponse" /> class.
        /// </summary>
        ...
        public PkiReadCertDeltaCrlResponse(List<string> CaChain = default(List<string>), string Certificate = default(string), string IssuerId = default(string), string RevocationTime = default(string), string RevocationTimeRfc3339 = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiReadCertDeltaCrlResponse {\n");
        ...
        {
            return this.Equals(input as PkiReadCertDeltaCrlResponse);
        }

        /// <summary>
        /// Returns true if PkiReadCertDeltaCrlResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiReadCertDeltaCrlResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiReadCertDeltaCrlResponse input)
        {
            if (input == null)
            {
                return false;
