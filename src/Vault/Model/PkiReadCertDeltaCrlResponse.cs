...
namespace Vault.Model
{
    ...
    public partial class PkiReadCertDeltaCrlResponse : IEquatable<PkiReadCertDeltaCrlResponse>, IValidatableObject
    {
        ...
        public PkiReadCertDeltaCrlResponse(string CaChain = default(string), string Certificate = default(string), string IssuerId = default(string), long RevocationTime = default(long), string RevocationTimeRfc3339 = default(string))
        {
