...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiIssuerIssueWithRoleRequest")]
    public partial class PkiIssuerIssueWithRoleRequest : IEquatable<PkiIssuerIssueWithRoleRequest>, IValidatableObject
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiIssuerIssueWithRoleRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiIssuerIssueWithRoleRequest {\n");
        ...
        {
            return this.Equals(input as PkiIssuerIssueWithRoleRequest);
        }

        /// <summary>
        /// Returns true if PkiIssuerIssueWithRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiIssuerIssueWithRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiIssuerIssueWithRoleRequest input)
        {
            if (input == null)
            {
                return false;
