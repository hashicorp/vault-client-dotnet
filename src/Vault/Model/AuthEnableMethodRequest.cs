...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuthEnableMethodRequest")]
    public partial class AuthEnableMethodRequest : IEquatable<AuthEnableMethodRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AuthEnableMethodRequest" /> class.
        /// </summary>
        ...
        public AuthEnableMethodRequest(Object Config = default(Object), string Description = default(string), bool ExternalEntropyAccess = false, bool Local = false, Object Options = default(Object), string PluginName = default(string), string PluginVersion = default(string), bool SealWrap = false, string Type = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuthEnableMethodRequest {\n");
        ...
        {
            return this.Equals(input as AuthEnableMethodRequest);
        }

        /// <summary>
        /// Returns true if AuthEnableMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AuthEnableMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AuthEnableMethodRequest input)
        {
            if (input == null)
            {
                return false;
