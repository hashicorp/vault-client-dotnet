...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "SystemPluginsReloadBackendRequest")]
    public partial class SystemPluginsReloadBackendRequest : IEquatable<SystemPluginsReloadBackendRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemPluginsReloadBackendRequest" /> class.
        /// </summary>
        ...
        public SystemPluginsReloadBackendRequest(List<string> mounts = default(List<string>), string plugin = default(string), string scope = default(string))
        {
            this.Mounts = mounts;
            this.Plugin = plugin;
            this.Scope = scope;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemPluginsReloadBackendRequest {\n");
        ...
        {
            return this.Equals(input as SystemPluginsReloadBackendRequest);
        }

        /// <summary>
        /// Returns true if SystemPluginsReloadBackendRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemPluginsReloadBackendRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemPluginsReloadBackendRequest input)
        {
            if (input == null)
            {
                return false;
