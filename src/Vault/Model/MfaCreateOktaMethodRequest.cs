...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "MfaCreateOktaMethodRequest")]
    public partial class MfaCreateOktaMethodRequest : IEquatable<MfaCreateOktaMethodRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="MfaCreateOktaMethodRequest" /> class.
        /// </summary>
        ...
        public MfaCreateOktaMethodRequest(string ApiToken = default(string), string BaseUrl = default(string), string MethodName = default(string), string OrgName = default(string), bool PrimaryEmail = default(bool), bool Production = default(bool), string UsernameFormat = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MfaCreateOktaMethodRequest {\n");
        ...
        {
            return this.Equals(input as MfaCreateOktaMethodRequest);
        }

        /// <summary>
        /// Returns true if MfaCreateOktaMethodRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of MfaCreateOktaMethodRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MfaCreateOktaMethodRequest input)
        {
            if (input == null)
            {
                return false;
