...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PkiGenerateIntermediateRequest")]
    public partial class PkiGenerateIntermediateRequest : IEquatable<PkiGenerateIntermediateRequest>, IValidatableObject
    {        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PkiGenerateIntermediateRequest" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PkiGenerateIntermediateRequest {\n");
        ...
        {
            return this.Equals(input as PkiGenerateIntermediateRequest);
        }

        /// <summary>
        /// Returns true if PkiGenerateIntermediateRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of PkiGenerateIntermediateRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PkiGenerateIntermediateRequest input)
        {
            if (input == null)
            {
                return false;
