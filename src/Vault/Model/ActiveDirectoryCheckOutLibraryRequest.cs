...
namespace Vault.Model
{
    ...
    public partial class ActiveDirectoryCheckOutLibraryRequest : IEquatable<ActiveDirectoryCheckOutLibraryRequest>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ActiveDirectoryCheckOutLibraryRequest {\n");
        ...
        {
            return this.Equals(input as ActiveDirectoryCheckOutLibraryRequest);
        }

        /// <summary>
        /// Returns true if ActiveDirectoryCheckOutLibraryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ActiveDirectoryCheckOutLibraryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ActiveDirectoryCheckOutLibraryRequest input)
        {
            if (input == null)
            {
                return false;
