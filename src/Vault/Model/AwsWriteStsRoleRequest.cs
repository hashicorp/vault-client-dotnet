...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AwsWriteStsRoleRequest")]
    public partial class AwsWriteStsRoleRequest : IEquatable<AwsWriteStsRoleRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="AwsWriteStsRoleRequest" /> class.
        /// </summary>
        ...
        public AwsWriteStsRoleRequest(string StsRole = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AwsWriteStsRoleRequest {\n");
        ...
        {
            return this.Equals(input as AwsWriteStsRoleRequest);
        }

        /// <summary>
        /// Returns true if AwsWriteStsRoleRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of AwsWriteStsRoleRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AwsWriteStsRoleRequest input)
        {
            if (input == null)
            {
                return false;
