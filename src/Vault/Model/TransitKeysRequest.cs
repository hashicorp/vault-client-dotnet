...
namespace Vault.Model
{
    ...
    /// TransitKeysRequest
    /// </summary>
    [DataContract(Name = "TransitKeysRequest")]
    public partial class TransitKeysRequest : IEquatable<TransitKeysRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransitKeysRequest" /> class.
        /// </summary>
        ...
        public TransitKeysRequest(bool allowPlaintextBackup = default(bool), int autoRotatePeriod = 0, string context = default(string), bool convergentEncryption = default(bool), bool derived = default(bool), bool exportable = default(bool), int keySize = 0, string type = "aes256-gcm96")
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransitKeysRequest {\n");
        ...
        {
            return this.Equals(input as TransitKeysRequest);
        }

        /// <summary>
        /// Returns true if TransitKeysRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TransitKeysRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransitKeysRequest input)
        {
            if (input == null)
            {
                return false;
