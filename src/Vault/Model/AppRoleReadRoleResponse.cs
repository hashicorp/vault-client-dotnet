...
namespace Vault.Model
{
    ...
    public partial class AppRoleReadRoleResponse : IEquatable<AppRoleReadRoleResponse>, IValidatableObject
    {
        ...
        public AppRoleReadRoleResponse(bool BindSecretId = default(bool), bool LocalSecretIds = default(bool), string Period = default(string), List<string> Policies = default(List<string>), List<string> SecretIdBoundCidrs = default(List<string>), int SecretIdNumUses = default(int), string SecretIdTtl = default(string), List<string> TokenBoundCidrs = default(List<string>), string TokenExplicitMaxTtl = default(string), string TokenMaxTtl = default(string), bool TokenNoDefaultPolicy = default(bool), int TokenNumUses = default(int), string TokenPeriod = default(string), List<string> TokenPolicies = default(List<string>), string TokenTtl = default(string), string TokenType = "default-service")
        {
