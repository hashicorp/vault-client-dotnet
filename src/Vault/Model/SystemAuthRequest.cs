...
namespace Vault.Model
{
    ...
    /// SystemAuthRequest
    /// </summary>
    [DataContract(Name = "SystemAuthRequest")]
    public partial class SystemAuthRequest : IEquatable<SystemAuthRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SystemAuthRequest" /> class.
        /// </summary>
        ...
        public SystemAuthRequest(Object config = default(Object), string description = default(string), bool externalEntropyAccess = false, bool local = false, Object options = default(Object), string pluginName = default(string), string pluginVersion = default(string), bool sealWrap = false, string type = default(string))
        {
            this.Config = config;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SystemAuthRequest {\n");
        ...
        {
            return this.Equals(input as SystemAuthRequest);
        }

        /// <summary>
        /// Returns true if SystemAuthRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SystemAuthRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SystemAuthRequest input)
        {
            if (input == null)
            {
                return false;
