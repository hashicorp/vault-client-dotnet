...
namespace Vault.Model
{
    ...
    /// </summary>
    [DataContract(Name = "GroupUpdateByNameRequest")]
    public partial class GroupUpdateByNameRequest : IEquatable<GroupUpdateByNameRequest>, IValidatableObject
    {


        /// <summary>
        /// Initializes a new instance of the <see cref="GroupUpdateByNameRequest" /> class.
        /// </summary>
        ...
        public GroupUpdateByNameRequest(string Id = default(string), List<string> MemberEntityIds = default(List<string>), List<string> MemberGroupIds = default(List<string>), Object Metadata = default(Object), List<string> Policies = default(List<string>), string Type = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GroupUpdateByNameRequest {\n");
        ...
        {
            return this.Equals(input as GroupUpdateByNameRequest);
        }

        /// <summary>
        /// Returns true if GroupUpdateByNameRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GroupUpdateByNameRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupUpdateByNameRequest input)
        {
            if (input == null)
            {
                return false;
