...
------------ | ------------- | ------------- | -------------
*Auth* | [**AuthUpdateAwsConfigRotateRoot**](docs/Auth.md#authupdateawsconfigrotateroot) | **POST** /auth/{mount_path}/config/rotate-root | 
...
*Auth* | [**DeleteKubernetesRoleName**](docs/Auth.md#deletekubernetesrolename) | **DELETE** /auth/{mount_path}/role/{name} | Register an role with the backend.
*Auth* | [**DeleteOktaUsersName**](docs/Auth.md#deleteoktausersname) | **DELETE** /auth/{mount_path}/users/{name} | Manage additional groups for users allowed to authenticate.
...
*Auth* | [**ListKubernetesRole**](docs/Auth.md#listkubernetesrole) | **GET** /auth/{mount_path}/role | Lists all the roles registered with the backend.
*Auth* | [**ListOktaUsers**](docs/Auth.md#listoktausers) | **GET** /auth/{mount_path}/users | Manage additional groups for users allowed to authenticate.
...
*Auth* | [**ReadKubernetesConfig**](docs/Auth.md#readkubernetesconfig) | **GET** /auth/{mount_path}/config | Configures the JWT Public Key and Kubernetes API information.
*Auth* | [**ReadKubernetesRoleName**](docs/Auth.md#readkubernetesrolename) | **GET** /auth/{mount_path}/role/{name} | Register an role with the backend.
...
*Auth* | [**ReadOktaUsersName**](docs/Auth.md#readoktausersname) | **GET** /auth/{mount_path}/users/{name} | Manage additional groups for users allowed to authenticate.
...
*Auth* | [**UpdateKubernetesConfig**](docs/Auth.md#updatekubernetesconfig) | **POST** /auth/{mount_path}/config | Configures the JWT Public Key and Kubernetes API information.
*Auth* | [**UpdateKubernetesLogin**](docs/Auth.md#updatekuberneteslogin) | **POST** /auth/{mount_path}/login | Authenticates Kubernetes service accounts with Vault.
*Auth* | [**UpdateKubernetesRoleName**](docs/Auth.md#updatekubernetesrolename) | **POST** /auth/{mount_path}/role/{name} | Register an role with the backend.
...
*Auth* | [**UpdateOktaLoginUsername**](docs/Auth.md#updateoktaloginusername) | **POST** /auth/{mount_path}/login/{username} | Log in with a username and password.
*Auth* | [**UpdateOktaUsersName**](docs/Auth.md#updateoktausersname) | **POST** /auth/{mount_path}/users/{name} | Manage additional groups for users allowed to authenticate.
...
*Secrets* | [**DeleteConsulRolesName**](docs/Secrets.md#deleteconsulrolesname) | **DELETE** /{mount_path}/roles/{name} | 
...
*Secrets* | [**DeleteLdapConfig**](docs/Secrets.md#deleteldapconfig) | **DELETE** /{mount_path}/config | 
...
*Secrets* | [**DeleteNomadConfigLease**](docs/Secrets.md#deletenomadconfiglease) | **DELETE** /{mount_path}/config/lease | Configure the lease parameters for generated tokens
...
*Secrets* | [**DeleteSecretPath**](docs/Secrets.md#deletesecretpath) | **DELETE** /{mount_path}/{path} | Pass-through secret storage to the storage backend, allowing you to read/write arbitrary data into secret storage.
*Secrets* | [**DeleteSshConfigCa**](docs/Secrets.md#deletesshconfigca) | **DELETE** /{mount_path}/config/ca | Set the SSH private key used for signing certificates.
...
*Secrets* | [**ListPkiCertsRevoked**](docs/Secrets.md#listpkicertsrevoked) | **GET** /{mount_path}/certs/revoked | 
*Secrets* | [**ListPkiIssuers**](docs/Secrets.md#listpkiissuers) | **GET** /{mount_path}/issuers | 
*Secrets* | [**ListSshRoles**](docs/Secrets.md#listsshroles) | **GET** /{mount_path}/roles | Manage the 'roles' that can be created with this backend.
...
*Secrets* | [**ReadConsulRolesName**](docs/Secrets.md#readconsulrolesname) | **GET** /{mount_path}/roles/{name} | 
...
*Secrets* | [**ReadLdapConfig**](docs/Secrets.md#readldapconfig) | **GET** /{mount_path}/config | 
...
*Secrets* | [**ReadNomadConfigLease**](docs/Secrets.md#readnomadconfiglease) | **GET** /{mount_path}/config/lease | Configure the lease parameters for generated tokens
...
*Secrets* | [**ReadSecretPath**](docs/Secrets.md#readsecretpath) | **GET** /{mount_path}/{path} | Pass-through secret storage to the storage backend, allowing you to read/write arbitrary data into secret storage.
...
*Secrets* | [**ReadSshConfigCa**](docs/Secrets.md#readsshconfigca) | **GET** /{mount_path}/config/ca | Set the SSH private key used for signing certificates.
...
*Secrets* | [**UpdateAwsConfigRotateRoot**](docs/Secrets.md#updateawsconfigrotateroot) | **POST** /{mount_path}/config/rotate-root | 
...
*Secrets* | [**UpdateConsulRolesName**](docs/Secrets.md#updateconsulrolesname) | **POST** /{mount_path}/roles/{name} | 
...
*Secrets* | [**UpdateLdapConfig**](docs/Secrets.md#updateldapconfig) | **POST** /{mount_path}/config | 
...
*Secrets* | [**UpdateNomadConfigLease**](docs/Secrets.md#updatenomadconfiglease) | **POST** /{mount_path}/config/lease | Configure the lease parameters for generated tokens
...
*Secrets* | [**UpdatePkiInternalExported**](docs/Secrets.md#updatepkiinternalexported) | **POST** /{mount_path}/internal|exported | 
...
*Secrets* | [**UpdatePkiIssuerRefDerPem**](docs/Secrets.md#updatepkiissuerrefderpem) | **POST** /{mount_path}/{issuer_ref}/der|/pem | 
...
*Secrets* | [**UpdateSecretPath**](docs/Secrets.md#updatesecretpath) | **POST** /{mount_path}/{path} | Pass-through secret storage to the storage backend, allowing you to read/write arbitrary data into secret storage.
...
*Secrets* | [**UpdateSshConfigCa**](docs/Secrets.md#updatesshconfigca) | **POST** /{mount_path}/config/ca | Set the SSH private key used for signing certificates.
...
*Secrets* | [**UpdateSshCredsRole**](docs/Secrets.md#updatesshcredsrole) | **POST** /{mount_path}/creds/{role} | Creates a credential for establishing SSH connection with the remote host.
*Secrets* | [**UpdateSshIssueRole**](docs/Secrets.md#updatesshissuerole) | **POST** /{mount_path}/issue/{role} | 
...
*Secrets* | [**UpdateSshSignRole**](docs/Secrets.md#updatesshsignrole) | **POST** /{mount_path}/sign/{role} | Request signing an SSH key using a certain role with the provided details.
...
*System* | [**ReadSystemInternalInspectRouterTag**](docs/System.md#readsysteminternalinspectroutertag) | **GET** /sys/internal/inspect/router/{tag} | Expose the route entry and mount entry tables present in the router
